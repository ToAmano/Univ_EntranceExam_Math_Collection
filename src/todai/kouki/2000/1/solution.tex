...
\begin{multicols}{2}
    ...
    \begin{align*}
         & P_{l+1}(x) - P_{l+1}(x-1)                                                                                                  \\
         & = \frac{1}{l+1} \left[ (x+1)^{l+1} - x^{l+1} - \sum_{t=0}^{l-1} {}_{l+1}C_{t} \left(P_{t+1}(x)-P_{t+1}(x-1)\right) \right] \\
         & = \frac{1}{l+1} \left[ (x+1)^{l+1} - x^{l+1} - \sum_{t=0}^{l-1} {}_{l+1}C_{t} x^{t} \right]                                \\
         & = \frac{1}{l+1} \left[ \sum_{t=0}^{l+1} {}_{l+1}C_{t} x^{t} - x^{l+1} - \sum_{t=0}^{l-1} {}_{l+1}C_{t} x^{t} \right]       \\
         & = \frac{1}{l+1} \left[ {}_{l+1}C_{l} x^{t} \right]                                                                         \\
         & = \frac{1}{l+1} \left[ (l+1) x^{t} \right]                                                                                 \\
         & = x^l
    \end{align*}
    ...
    \begin{align*}
        P_{l+1}(0)
         & = \frac{-1}{l+1} \sum_{t=0}^{l-1} {}_{l+1} C_{t} P_{t+1}(0) \\
         & = \frac{-1}{l+1} \sum_{t=0}^{l-1} {}_{l+1} C_{t} 0          \\

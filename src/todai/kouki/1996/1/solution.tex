...
\begin{multicols}{2}
    ...
    \begin{align*}
         & 1 + 9m + 6\gamma = \frac{1}{2}(n+2)(n+1)                           \\
        \therefore
         & \gamma = \frac{1}{6} \left[ \frac{1}{2}(n+2)(n+1) - 1 - 9m \right]
    \end{align*}
    なので, もとめる場合の数は\cref{1996-1:eq:3,1996-1:eq:4}と合わせて，
    \begin{align*}
        \alpha+\beta+\gamma
         & = 1+3m+ \frac{1}{6}\left[\frac{1}{2}(n+2)(n+1) - 1 - 9m \right] \\
         & = \frac{1}{6} \left[ \frac{1}{2}(n+2)(n+1) + 9m + 5 \right]     \\
    \end{align*}
    である．ここで$n=6m$を代入して
    \begin{align*}
        \alpha+\beta+\gamma
         & = \frac{1}{6} \left[ \frac{1}{2}(n+2)(n+1) + \frac{3}{2}m + 5 \right] \\
         & = \frac{1}{12} \left(n^2+6n+12\right)
    \end{align*}
    通りである．$\cdots$(答)

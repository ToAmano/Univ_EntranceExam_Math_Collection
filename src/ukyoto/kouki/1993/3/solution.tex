...
\begin{oframed}
  \input{../../../problems/1993/3/problem.tex}
\end{oframed}
...
\begin{multicols}{2}
  ...
  \begin{align*}
    \vec{a}_1 & = \frac{1}{3} (\vec{b}' + \vec{c}' + \vec{d}') \\
    \vec{b}_1 & = \frac{1}{3} (\vec{a}' + \vec{c}' + \vec{d}') \\
    \vec{c}_1 & = \frac{1}{3} (\vec{a}' + \vec{b}' + \vec{d}') \\
    \vec{d}_1 & = \frac{1}{3} (\vec{a}' + \vec{b}' + \vec{c}')
  \end{align*}
  と表せる．
  新しく点$T$を
  \begin{align}
  ...
  で定めると，
  \begin{align*}
    \vec{TA_1} & = -\frac{1}{3}\vec{a} \\
    \vec{TB_1} & = -\frac{1}{3}\vec{b} \\
    \vec{TC_1} & = -\frac{1}{3}\vec{c} \\
    \vec{TD_1} & = -\frac{1}{3}\vec{d}
  \end{align*}
  ...
  \begin{align*}
    \vec{t}_n
     & = \vec{t}_1 = \vec{t}                                           \\
     & = \frac{1}{3}\left(\vec{a} + \vec{b} + \vec{c} + \vec{d}\right)
  \end{align*}
  である．
  ...
  \cref{1993-3:eq:1}より
  \begin{align*}
     & \vec{k}_{n+1}                        = -\frac{1}{3}\vec{k}_n + \vec{t}             \\
    \therefore
     & \vec{k}_{n+1} - \frac{3}{4}\vec{t} = -\frac{1}{3} (\vec{k}_n - \frac{3}{4}\vec{t})
  \end{align*}
  だから，等比数列の公式から
  \begin{align*}
  ...
  \begin{align*}
    \vec{P_n P_{n+1}}
     & = \frac{3}{4}\vec{t} \left[1 - \left(-\frac{1}{3}\right)^{n+1} - \left(1 - \left(-\frac{1}{3}\right)^n\right)\right] \\
     & = 3\frac{1}{3}\left(-\frac{1}{3}\right)^n \vec{t}                                                                    \\
     & = -\left(-\frac{1}{3}\right)^{n+1} (\vec{a} + \vec{b}+ \vec{c} + \vec{d})
  \end{align*}
  である．$\cdots$(答)
  ...
  \begin{align*}
    \vec{q}
     & = \lim_{n\to\infty}P_{n}                                         \\
     & =\frac{3}{4}\vec{t}                                              \\
     & = \frac{1}{4} \left(\vec{a} + \vec{b} + \vec{c} + \vec{d}\right)
  \end{align*}

...
\begin{multicols}{2}
    ...
    である．この元でさらに式を整理すると
    \begin{align}
        a^2_1(a_1x + b_1)^2 & = (a_2+a_3)(a_3-a_2)\left(x+\dfrac{a_2b_2+a_3b_3}{a_2+a_3}\right)\left(x+\dfrac{a_3b_3-a_2b_2}{a_3-a_2}\right)
    \end{align}
    である．これが恒等式であるから，$x$の各次数の係数が等しい．
    係数比較すると
    \begin{align}
        a^2_1 & = (a_2+a_3)(a_3-a_2)                               \label{2006-1:eq:1}              \\
        b_1   & = \dfrac{a_2b_2+a_3b_3}{a_2+a_3} = \dfrac{a_3b_3-a_2b_2}{a_3-a_2} \label{2006-1:eq:2}
    \end{align}
    \cref{2006-1:eq:2}から，
    \begin{align}
         & \begin{dcases}

...
\begin{multicols}{2}
  ...
  \begin{align}
    P(n)
     & = P(A)+P(B)+P(C)                                                             \\
     & = \left[n + n(n-1) + \frac{n(n-1)(n-2)}{6}\right] \left(\frac{1}{6}\right)^n \\
     & = \left(n^ + 3n^ + 2\right) n \left(\frac{1}{6}\right)^{n+1}                 \\
     & = n(n+1)(n+2) \left(\frac{1}{6}\right)^{n+1} \label{2006-3:eq:1}
  \end{align}
  である．

...
\begin{oframed}
  \input{../../../problems/2000/5/problem.tex}
\end{oframed}
...
\begin{multicols}{2}
  ...
  \begin{align}
    a_n
     & = r^n e^{n}(\theta) + \frac{1}{r^n} e^{-n}(\theta)                                                              \\
     & = r^n e(n\theta) + \frac{1}{r^n} e(-n\theta)                                                                    \\
     & = \left(r^n+\frac{1}{r^n}\right) \cos n\theta + i\left(r^n-\frac{1}{r^n}\right)\sin n\theta \label{2000-5:eq:3}
  \end{align}
  を得る．従って，
  \begin{align*}
    |a_n|^2
     & = \left(r^n+\frac{1}{r^n}\right)^2 \cos^2 n\theta + \left(r^n-\frac{1}{r^n}\right)^2 \sin^2 n\theta           \\
     & = \left(r^{2n}+\frac{1}{r^{2n}}+2\right)\cos^2 n\theta + \left(r^{2n}+\frac{1}{r^{2n}}-2\right)\sin^2 n\theta \\
     & = r^{2n}+\frac{1}{r^{2n}}+2(\cos^2 n\theta - \sin^2 n\theta)                                                  \\
     & = r^{2n}+\frac{1}{r^{2n}}+2\cos 2n\theta
  \end{align*}
  である．

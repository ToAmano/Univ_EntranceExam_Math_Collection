...
\begin{multicols}{2}
  ...
  \begin{align}
    E(X_1+Y_1)
     & = \dfrac{1}{{}_n C_2} \sum_{k=1}^n k(n-1) \\
     & = n+1
  \end{align}
  が求める期待値である．  $\cdots$(答)
  ...
  \begin{align}
    E(X_1) & = \sum_{k=2}^{n} \dfrac{k \cdot {}_{k-1} C_1}{{}_n C_2}                                                      \\
           & = \dfrac{1}{{}_n C_2} \sum_{k=2}^n k \cdot {}_k C_2 \quad (\because {}_n C_r = \dfrac{n}{r} {}_{n-1} C_{r-1}) \\
           & = \dfrac{4}{n(n-1)} {}_{n+1} C_3 \quad (\because \sum_{k=r}^{n} k{}_k C_r = {}_{n+1} C_{r+1})                \\
           & = \dfrac{4}{n(n-1)} \dfrac{(n+1)n(n-1)}{3 \cdot 2 \cdot 1}                                                    \\
           & = \dfrac{2(n+1)}{3}
  \end{align}
  と求まる．$\cdots$(答)
  ...
  \begin{align}
    E_k
     & = \sum_{k=m}^n \dfrac{k \cdot {}_{k-1}C_{m-1}}{{}_n C_m}                                                        \\
     & = \dfrac{1}{{}_n C_m} \sum_{k=m}^n m \cdot {}_{k}C_{m} \quad (\because {}_n C_r = \dfrac{n}{r} {}_{n-1} C_{r-1}) \\
     & = \dfrac{m}{{}_n C_m} {}_{n+1}C_{m+1} \quad (\because \sum_{k=r}^n k \cdot {}_k C_r = n {}_{n+1} C_{r+1})       \\
     & = \dfrac{m}{{}_n C_m} \dfrac{n!}{(m+1)!(n-m-1)!}                                                                 \\ &= \dfrac{m(n+1)}{m+1} \\
     & = \dfrac{m(n+1)}{m+1}
  \end{align}
  となる．

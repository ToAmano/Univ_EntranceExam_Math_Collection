...
\begin{multicols}{2}
  ...
  \begin{align}
    Q_{k+1}
     & = \dfrac{1}{a+b+c+k} Q_k + \dfrac{a+b+k-1}{a+b+c+k} Q_k \\
     & = Q_k                                                 \\
  \end{align}
  である．
  この漸化式をくり返し用いて，任意の自然数$n$に対して
  \begin{align}
    Q_n = Q_1 = \dfrac{a}{a+b+c}
  \end{align}
  を得る．従って，ここに$(a,b,c)=(3,2,1)$を代入して
  \begin{align}
    Q_n=\dfrac{1}{2} \label{1997-5:eq:1}
  \end{align}
  を得る．
  ...
  \begin{align}
    ...
    \end{dcases}
  \end{align}
  \cref{1997-5:eq:1}より，$X_k$の期待値$E(X_k)$は
  \begin{align}
    E(X_k) = Q_k = \dfrac{1}{2}
  \end{align}
  である．

...
\begin{multicols}{2}
  ...
  \begin{align}
    \max f(\alpha,\beta)
     & = f\left(\frac{\pi-\beta}{2}\right)   \\
     & = -\frac{1}{2}\sin\beta(-1-\cos\beta) \\
     & = \frac{1}{2}\sin\beta(1+\cos\beta)   \\
     & \equiv g(\beta)
  \end{align}
  である．
  ...
  \begin{align*}
    g'(\beta)
     & = \frac{1}{2}\left[\cos\beta(1+\cos\beta)-\sin^2\beta\right] \\
     & = \frac{1}{2}\left[2\cos^2\beta + \cos \beta -1\right]       \\
     & = \frac{1}{2}(2\cos\beta-1)(\cos\beta+1)
  \end{align*}
  ...
  \begin{align*}
    \frac{\sin\alpha+\sin\beta+\sin\gamma}{3}
     & \le \sin\left(\frac{1}{3}\alpha+\frac{1}{3}\beta+\frac{1}{3}\gamma\right) \\
     & = \sin\frac{\pi}{3}                                                       \\
     & = \frac{\sqrt{3}}{2}
  \end{align*}
  と上側から評価できる．等号成立は

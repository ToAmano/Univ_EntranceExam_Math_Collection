...
だから
$$ T(t) = \dfrac{1}{2} \cdot \dfrac{\sqrt{3}}{2} (\sqrt{2}t)^2 = \dfrac{\sqrt{3}}{4} 2t^2 = \dfrac{\sqrt{3}}{2} t^2 \cdots (1) $$
...
一辺$\sqrt{2}(t-1)$の " を
3つとりのぞいたもので、
$$ S(t) = \dfrac{\sqrt{3}}{2} t^2 - 3 \dfrac{\sqrt{3}}{2} (t-1)^2 = \dfrac{\sqrt{3}}{2} (-2t^2 + 6t - 3) $$
...
(ウ) $0 < t \le 1$ の時
明らかに $S(t) = T(t) = \dfrac{\sqrt{3}}{2} t^2$
...
\begin{tikzpicture}
  ...
  \draw[dashed] (1, 0) node[below] {$1$} -- (1, 0.866) -- (0, 0.866) node[left] {$\dfrac{\sqrt{3}}{2}$};
  \draw[dashed] (1.5, 0) node[below] {$\dfrac{3}{2}$} -- (1.5, 1.299) -- (0, 1.299) node[left] {$\dfrac{3\sqrt{3}}{4}$};
...
よって、$\max S(t) = S\left(\dfrac{3}{2}\right) = \dfrac{3\sqrt{3}}{4}$

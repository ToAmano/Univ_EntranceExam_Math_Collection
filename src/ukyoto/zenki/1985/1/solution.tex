...
\end{cases}
\]
②から $\beta = \dfrac{1}{2}(\alpha^2 - 2p - q^2)$ だから、③⑤に代入して、
\[
\begin{cases}
...
$\iff \left| \vec{a} - \dfrac{\vec{b} + \vec{c}}{2} \right|^2 = \left| \dfrac{\vec{b} - \vec{c}}{2} \right|^2 + p$\\
$= \dfrac{q^2}{4} + p$\\
より、$\dfrac{q^2}{4} + p > 0$ (逆にこの時、BC上にないAがとれる！！)

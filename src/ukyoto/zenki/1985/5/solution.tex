...
$P(X=k) = {}_2\mathrm{C}_k \cdot p^k (1-p)^{2-k}$ の時、②に代入して、
\[
  \begin{cases}
...
$P(X=k) = \dfrac{1}{3}$ の時、②に代入して
\[ \dfrac{1}{3} = 1 + \beta - \alpha = \alpha - 2\beta = \beta \]
よって、$(\alpha, \beta) = \left(1, \dfrac{1}{3}\right)$ だから、$a, b$ は $t$ の2次式 $t^2 - t + \dfrac{1}{3} = 0$ の2解だが、この判別式を $D$ として
\[ D = 1 - \dfrac{4}{3} = -\dfrac{1}{3} < 0 \]

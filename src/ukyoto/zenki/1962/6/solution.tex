...
&= \dfrac{1}{3} \left( (a^2-4)^\dfrac{3}{2} - (a-2)^3 \right) - 2(a-2)^2 \\
&= \dfrac{1}{3} (a^2-4)^\dfrac{3}{2} - \dfrac{1}{3} (a+4)(a-2)^2
\end{align}
...
&= \dfrac{1}{3} \left[ a(a^2+4) - 20(a^2-4) + (a^2-4)^\dfrac{3}{2} \right] - \dfrac{16}{3} \\
&= \dfrac{1}{3}(a^2-4)^\dfrac{3}{2} - \dfrac{1}{3}(a+4)(a-2)^2
\end{align}
\end{framed}

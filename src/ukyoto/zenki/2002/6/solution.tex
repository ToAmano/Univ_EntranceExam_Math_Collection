...
\begin{align}
\alpha_{n+1}&=\dfrac{1}{e(\theta)}\alpha_n+\dfrac{a}{e(\theta)}\\
\alpha_{n+1}-\dfrac{a}{e(\theta)-1}&=\dfrac{1}{e(\theta)}\left\{\alpha_n-\dfrac{a}{e(\theta)-1}\right\}\quad(\because①から e(\theta)\ne1)
\end{align}

$\alpha_0=0$とから，くり返し用いて，
\begin{align}
\alpha_n&=\left(\dfrac{1}{e(\theta)}\right)^n\left(0-\dfrac{a}{e(\theta)-1}\right)+\dfrac{a}{e(\theta)-1}\\
z_n&=\dfrac{a}{e(\theta)-1}\left\{e(n\theta)-1\right\}
\end{align}
...
\iff&\theta=\dfrac{m}{n}\cdot360\text{なる}n\in\mathbb N,\ m\in\mathbb Z\text{が存在する}\\
\iff&\theta\text{が有理数}
\end{align}

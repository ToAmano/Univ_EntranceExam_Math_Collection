...
\begin{tikzpicture}[scale=1.3, >=stealth]
  ...
  \foreach \p/\lab/\posn in {-2.8/{$\dfrac{3\alpha-\beta}{2}$}/below, -1.7/{$\alpha$}/below, 0/{$\dfrac{\alpha+\beta}{2}$}/below, 1.7/{$\beta$}/below, 2.8/{$\dfrac{3\beta-\alpha}{2}$}/below} {

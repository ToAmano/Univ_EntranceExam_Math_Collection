...
$2^\circ \ D=0$ の時\\
①は重解$p=-\dfrac{a+1}{2}$を持つから、これが②をみたさなければよい。代入して
\[ -\dfrac{a+1}{2}\left(-\dfrac{a+1}{2}+a-1\right)+\dfrac{1}{4}a^2-\dfrac{1}{2}a-\dfrac{3}{4}=0 \]
...
\begin{tikzpicture}[scale=0.8]
    ...
    \draw[domain=-3.5:4.5, smooth, variable=\x] plot ({\x}, {0.25*\x*\x - 0.5*\x - 0.75}) node[right] {$b=\dfrac{1}{4}a^2-\dfrac{1}{2}a-\dfrac{3}{4}$};

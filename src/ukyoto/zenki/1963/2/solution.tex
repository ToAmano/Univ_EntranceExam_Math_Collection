...
\[
AB = \dfrac{r}{\tan \alpha} + \dfrac{r}{\tan \beta}
\]
だから正弦定理から
\[
...
\[
0 < g(y) \le \dfrac{1}{2} \sin y (1 - \sin y) \quad \dots *
\]
...
\begin{tikzpicture}[scale=0.8, >=stealth]
  ...
  \node[below] at (1.0, 0) {$\dfrac{1}{2}$};
  \node[left] at (0, 0.9) {$\dfrac{1}{8}$};

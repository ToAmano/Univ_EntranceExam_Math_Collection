...
\]
\[
\gamma - \alpha = \dfrac{a+c}{2} - \alpha - \dfrac{(a-c)(p^2-q^2)+4bpq}{2(p^2+q^2)}
\]
この正負は、以下とひとしい
\begin{align}
...
\end{align}
\[
\dfrac{A}{2} = (c-\alpha)p^2 - 2bpq + (a-\alpha)q^2 \equiv f(p)
\]
...
\[
\beta - \gamma = \beta - \dfrac{a+c}{2} + \dfrac{(a-c)(p^2-q^2)+4bpq}{2(p^2+q^2)}
\]
この正負は、以下とひとしい
\begin{align}
...
\end{align}
\[
\dfrac{B}{2} = (\beta-c)p^2 + 2bpq + (\beta-a)q^2 \equiv g(p)
\]

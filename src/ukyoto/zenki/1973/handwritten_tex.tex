...
\[
  \vec{b} = b
  \begin{pmatrix} 1 \\ 0
  \end{pmatrix}, \quad \vec{a} = \frac{a}{2}
...
\[
  \vec{AB} =
  \begin{pmatrix} b - \frac{1}{2}a \\ -\frac{\sqrt{3}}{2}a
  \end{pmatrix}
\]
だから、$|MC| = \frac{\sqrt{3}}{2}|AB|$, $MC \perp AB$, $C$ が $O$ と反対側であることをあわせて、
\[
  \vec{MC} = \frac{\sqrt{3}}{2}
  \begin{pmatrix} \frac{\sqrt{3}}{2}a \\ b - \frac{1}{2}a
  \end{pmatrix}
\]
となり、
\begin{align*}
  ...
  &= a
  \begin{pmatrix} 1 \\ 0
  \end{pmatrix} + \frac{1}{2}b
  \begin{pmatrix} 1 \\ \sqrt{3}
  \end{pmatrix} \quad \dots \text{①}
\end{align*}
一方、
\[
  \frac{b}{a}\vec{a} + \frac{a}{b}\vec{b} = b \cdot \frac{1}{2}
  \begin{pmatrix} 1 \\ \sqrt{3}
  \end{pmatrix} + a
  \begin{pmatrix} 1 \\ 0
  \end{pmatrix} \quad \dots \text{②}

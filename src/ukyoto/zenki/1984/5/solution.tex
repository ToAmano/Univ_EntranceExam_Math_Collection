...
1回目に勝者が決まる確率は, $s=0$の時 $p_1 = 1$, $s \ge 1$の時, $r=1$なら $p_1 = \dfrac{r}{r+s}$, $r \ge 2$なら
$$ p_1 = \dfrac{s}{r+s} \cdot \dfrac{s-1}{r+s-1} \cdots \dfrac{s-(r-2)}{r+s-(r-2)} \cdot \dfrac{r}{r+s-(r-1)} $$
だから $r=1,2,3,\dots,s$の時, 一部を$A$として,
\begin{align}
p_r - p_{r+1} &= A \cdot \dfrac{r}{r+s-(r-1)} - A \cdot \dfrac{s-(r-1)}{r+s-(r-1)} \cdot \dfrac{r}{r+s-r} \\
&= A r \dfrac{r-1}{(r+s-r)(r+s-r+1)} \ge 0 \quad \cdots *1
\end{align}
$r=1$の時
$$ p_1 - p_2 = \dfrac{r}{r+s} - \dfrac{s}{r+s} \cdot \dfrac{r}{r+s-1} \ge 0 \ (\because s \ge 1) \cdots *2 $$
以上から, $p_r \ge p_{r+1}$ である. (終)

以上から $p_A \ge \dfrac{1}{2}$ であり, 等号が成立するのは
...
Aが勝者となるのは, $2k-1 \ (k \in \mathbb{N}, \ 1 \le 2k-1 \le s+1)$ 回目に
...
$$ P_A \ge P_B $$
これと$P_A + P_B = 1$から, $P_A \ge \dfrac{1}{2}$
...
$$ P_A \ge P_B \quad \therefore P_A \ge \dfrac{1}{2} \ (\because P_A + P_B = 1) $$

...
\[
\tan \theta = \dfrac{\sin\theta}{\cos\theta} = \dfrac{\overline{PQ} \cdot \overline{PR} \sin\theta}{\overline{PQ} \cdot \overline{PR} \cos\theta} = \dfrac{2 (\triangle PQR \text{の面積})}{\vec{PQ} \cdot \vec{PR}}
\]

...
\noindent
[\textbf{解}] $X = \dfrac{x}{a}, Y = \dfrac{y}{b}$ なる変換をほどこす.
...
$\dfrac{dS}{dt} = 1$ より
\[
\dfrac{dS}{dt} = \dfrac{1}{2} ab \dfrac{du}{dt} = 1
\]
\[
\therefore \dfrac{du}{dt} = \dfrac{1}{ab}
\]
\[
du = \dfrac{1}{ab} dt
\]
積分して
\[
u = \dfrac{1}{ab} t + C \quad (C \text{:定数})
\]
$t=0$ で $u=0$ より $C=0$ だから, \underline{$u = \dfrac{1}{ab} t$} である.

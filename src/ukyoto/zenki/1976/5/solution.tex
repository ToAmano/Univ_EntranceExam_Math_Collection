...
(i) $h(x) = \begin{cases} g(x) f\left(\dfrac{x}{a}\right) & (0 \le x) \\ g(x) f\left(-\dfrac{x}{a}\right) & (x \le 0) \end{cases}$ が (イ), (ニ) を満たすことを示す. まず (ロ) から $h(0) = 0$ となって (ハ) を満たす. 次に (ニ) について,
...
\[
h(x) = \begin{cases} g(x) f\left(\dfrac{x}{a}\right) & (0 \le x) \\ g(x) f\left(-\dfrac{x}{a}\right) & (x \le 0) \end{cases}
\]

...
\[
4l^2 = x^2 + y^2 - 2xy \cos\left(\pi - \dfrac{\alpha}{2}\right) \quad \dots \text{①}
\]
又, 正弦定理を用いて
\[
\dfrac{2l}{\sin\left(\pi - \dfrac{\alpha}{2}\right)} = \dfrac{y}{\sin\beta} = \dfrac{x}{\sin\delta} = 2r \quad \dots \text{②}
\]
① に $xy = 2r\left(r - \sqrt{r^2 - l^2}\right)$ を代入,
\begin{align}
(x+y)^2 &= 4l^2 - 2xy \cos\dfrac{\alpha}{2} + 2xy \\
&= 4l^2 + 4r\left(r - \sqrt{r^2 - l^2}\right)\left(1 - \cos\dfrac{\alpha}{2}\right) \quad \dots \text{③}
\end{align}
又 ② と $0 < \dfrac{\alpha}{2} \le \dfrac{\pi}{2}$ から $\cos\dfrac{\alpha}{2} = \sqrt{1 - \left(\dfrac{l}{r}\right)^2}$ だから ③ に代入
\begin{align}
...
\begin{align}
4l^2 &= x^2 + y^2 - 2xy \cos\dfrac{\alpha}{2} \quad \dots \text{①} \\
\dfrac{2l}{\sin\dfrac{\alpha}{2}} &= 2r \quad \dots \text{⑥}
\end{align}
⑥ と $0 < \dfrac{\alpha}{2} \le \dfrac{\pi}{2}$ から $\cos\dfrac{\alpha}{2} = \sqrt{1 - \left(\dfrac{l}{r}\right)^2}$. だから ① に代入
\begin{align}
(x+y)^2 &= 4l^2 + 2xy \cos\dfrac{\alpha}{2} + 2xy \\
&= 4l^2 + 4r\left(r - \sqrt{r^2 - l^2}\right)\left(1 + \sqrt{1 - \left(\dfrac{l}{r}\right)^2}\right) \\

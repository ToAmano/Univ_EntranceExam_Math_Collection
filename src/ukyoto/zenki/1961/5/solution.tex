...
\begin{proof}[解]
・ $n \le 1$ の時 $S = \sum_{k=1}^{100} (k-n) = \dfrac{1}{2} \cdot 100 \cdot 101 - 100 n$ から $S$ は $n$ について単調減少．

・ $n \ge 100$ の時 $S = \sum_{k=1}^{100} (n-k) = 100 n - \dfrac{1}{2} \cdot 100 \cdot 101$ から $S$ は $n$ について単調増加．

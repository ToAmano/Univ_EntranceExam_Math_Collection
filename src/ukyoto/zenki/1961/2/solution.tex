...
\[
  B(\alpha, \alpha \tan \theta) \quad \left(0 < \theta < \dfrac{\pi}{2}\right)
\]
\[
  C(\beta, -\beta \tan \theta)
\]
...
\begin{align}
  X &= \dfrac{1}{4}(\tau^2 + 1)(\alpha + \beta) \quad \dots \text{③} \quad (\tau = \tan \theta) \\
  Y &= \dfrac{1}{4\tau}(\tau^2 + 1)(\alpha - \beta) \quad \dots \text{④}
\end{align}
...
\[
  p = \dfrac{1}{2}, \quad q = \dfrac{\alpha + \beta}{\beta - \alpha} \dfrac{\tau}{2}
\]
...
\[
  AC = \dfrac{\alpha}{\gamma}\beta \quad \dots \text{①}
\]
又，$\alpha^2 = \gamma \cdot PC$ から
\[
  PC = \dfrac{\alpha^2}{\gamma} \quad \dots \text{②}
\]
従って
\[
  BD = BC \cdot \dfrac{AB}{AB+AC} = \left(\dfrac{\alpha^2}{\gamma} - \gamma\right) \dfrac{\beta}{\beta + \dfrac{\alpha}{\gamma}\beta} = \alpha - \gamma
\]

...
\eqref{eq2_5}から$b=\dfrac{1}{2}$, \eqref{eq2_4}から$a=\dfrac{1}{2}$である. 逆にこの時
\[
  \dfrac{1}{2}f(x) + \dfrac{1}{2}f(x-\pi) = 1
\]
は任意の$x$について成立し, 十分

以上を, $C$を一般角に直して
\[
  (a, b, C) = \left(\dfrac{1}{2}, \dfrac{1}{2}, \pi + 2n\pi\right) \ (n \in \mathbb{Z})
\]

...
\begin{align}
  ...
  &= \dfrac{2}{3}a\alpha + 2\left(\dfrac{1}{3}+b\right)\beta = 0
\end{align}
が任意の$\alpha, \beta$で成立するので, $a=0, b=-\dfrac{1}{3}$となり
\[
  p_2(x) = x^2 - \dfrac{1}{3}
\]
...
\begin{align}
  ...
  &= 2\left(\dfrac{1}{5}a+\dfrac{1}{3}c\right)\alpha + 2\left(\dfrac{1}{5}+\dfrac{1}{3}b\right)\beta + 2\left(\dfrac{1}{3}a+c\right)\gamma \\
  &= 0
\end{align}
これが全ての$\alpha, \beta, \gamma$で成立するので,
\[
  \begin{cases}
    \dfrac{1}{5}a + \dfrac{1}{3}c = 0 \\
    \dfrac{1}{5} + \dfrac{1}{3}b = 0 \\
    \dfrac{1}{3}a + c = 0
  \end{cases}
  \iff
  \begin{cases}

...
\begin{equation}
  \vec{g} = \dfrac{1}{3} (\vec{a}_D + \vec{a}_E + \vec{a}_F) \label{eq5_2}
\end{equation}
\eqref{eq5_1}, \eqref{eq5_2}から$G, H$を通る直線上の点$X$は, $t \in \mathbb{R}$として
\[
  \vec{x} = \dfrac{1}{3} (\vec{a}_D + \vec{a}_E + \vec{a}_F) + \dfrac{t}{3} (3\vec{a}_a + 3\vec{a}_b + 3\vec{a}_c - \vec{a}_D - \vec{a}_E - \vec{a}_F)
\]
と表せる. $t = \dfrac{1}{4}$として
\[
  \vec{x} = \dfrac{1}{4} (\vec{a}_a + \cdots + \vec{a}_F) = \dfrac{1}{4} \sum_{k=1}^6 \vec{a}_k
\]

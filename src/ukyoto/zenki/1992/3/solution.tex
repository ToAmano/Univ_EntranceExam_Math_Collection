...
\begin{align}
\vec{p} &= \dfrac{1}{2}(\vec{b} + \vec{c}) \\
\vec{q} &= \dfrac{1}{2}(\vec{a} + \vec{c}) \\
\vec{r} &= \dfrac{1}{2}(\vec{a} + \vec{b})
\end{align}
これを等式に代入して
\begin{align}
\dfrac{1}{2}(\vec{b} + \vec{c}) + \dfrac{2}{2}(\vec{a} + \vec{c}) + \dfrac{3}{2}(\vec{a} + \vec{b}) &= 0 \\
5\vec{a} + 4\vec{b} + 3\vec{c} &= 0 \quad \cdots \text{\textcircled{1}}
\end{align}
である。変形して
\begin{equation*}
\vec{AO} = \dfrac{4\vec{AB} + 3\vec{AC}}{12}
\end{equation*}
$AB=k, AC=m$, $\vec{AB}$と$\vec{AC}$のなす角$\theta\ (0 < k, m, 0 < \theta < \pi)$として
*から
\begin{equation*}
\begin{cases}
\vec{AB} \cdot \left(\vec{AO} - \dfrac{1}{2}\vec{AB}\right) = 0 \\
\vec{AC} \cdot \left(\vec{AO} - \dfrac{1}{2}\vec{AC}\right) = 0
\end{cases}
...
\end{cases}
\end{equation*}
\textcircled{2}から $k = \dfrac{3}{2}m \cos\theta$ だから、\textcircled{3}に代入して $\cos^2\theta = \dfrac{1}{2} \ (\because m \neq 0)$ \\
$k > 0, m > 0$ から $\cos\theta > 0$ で、$\cos\theta = \dfrac{\sqrt{2}}{2} \quad \therefore \angle BAC = \dfrac{\pi}{4}$ である。

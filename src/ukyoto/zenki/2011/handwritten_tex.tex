...
\end{align*}
だから，$\alpha$と$S$は共有点を持つ．さらに，共有点の中心$A\left(\dfrac43,\dfrac43,\dfrac43\right)$，半径$\dfrac{\sqrt6}3$の円で，この円上の点は，$\alpha$に平行な単位ベクトル$\dfrac1{\sqrt2}
\begin{pmatrix}0\\1\\-1
\end{pmatrix}$，$\dfrac1{\sqrt6}
\begin{pmatrix}2\\-1\\-1
\end{pmatrix}$を用いて，
\begin{align*}
  \overrightarrow{OX}=\frac43
  \begin{pmatrix}1\\1\\1
  \end{pmatrix}+\frac{\sqrt6}3\left[\frac1{\sqrt2}\cos\theta
    \begin{pmatrix}0\\1\\-1
    \end{pmatrix}+\frac1{\sqrt6}\sin\theta
    \begin{pmatrix}2\\-1\\-1
  \end{pmatrix}\right]\quad(0\le\theta<2\pi)
\end{align*}
とかけるから，$X(x,y,z)$として
\begin{align*}

...
\begin{enumerate}
    ...
    \]
    とおける. ただし $\alpha$ は $\cos \alpha = \dfrac{\pi v t}{A} (>0)$, $\sin \alpha = \dfrac{\pi a - v}{A} (>0)$ をみたす $0 < \alpha < \dfrac{\pi}{2}$ なる角であって, $n < t \le n+1$ の時,
    \[
    ...
    \]
    \[
    \cos \pi t_n = \dfrac{a \sin \pi t_n}{v t_n} \to 0 \quad (n \to \infty, \text{②から})
    \]
    ②からしたがって
    \[
    t_n \to n + \dfrac{1}{2} \quad (n \to \infty)
    \]
    だから $t_n - n \to \dfrac{1}{2} \quad (n \to \infty)$ である.
\end{enumerate}

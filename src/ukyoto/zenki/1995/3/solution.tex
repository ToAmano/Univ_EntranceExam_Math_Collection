...
\[
x^3 - f(x) = x^3 - \dfrac{3}{2}p x^2 + \dfrac{q}{2}
\]
係数比較して
\[
a = \dfrac{3}{2}p, \quad b = 0, \quad c = -\dfrac{q}{2} \cdots (1)
\]

(2) $p, q$ の条件は $x$ の3次方程式 $x^3 - \dfrac{3}{2}px^2 + \dfrac{q}{2} = 0 \cdots \text{\textcircled{4}}$ が3異実解を持つこと。\textcircled{4} の左辺 $g(x)$ とおく。$g'(x) = 3x^2 - 3px$ から、$p$ によって下のように分かれる
...
\begin{align}
& g(0) > 0 \land g(p) < 0 \\
\iff & \dfrac{q}{2} > 0 \land - \dfrac{p^3}{2} + \dfrac{q}{2} < 0 \\

...
だから
\[
  \begin{cases} a_n \cos\left(\left(\frac{1}{2}\right)^n \theta\right) = a_{n+1} \\ a_1 = 1
\end{cases} \]
となり、
...
したがって、
\[
  \begin{cases} a < b \text{ のとき } P(a) > P(b) \\ a > b \text{ のとき } P(b) > P(a)
\end{cases} \quad \text{//} \]
...
\[
  \begin{cases} 540 = \frac{\pi r^2}{100} \cdot 18 \\ t = \frac{\pi r^2}{100} \cdot 50
\end{cases} \]
辺々わって

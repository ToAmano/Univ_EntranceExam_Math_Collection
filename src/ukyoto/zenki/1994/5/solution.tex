...
だから
$$a_n =
\begin{cases} \dfrac{1}{3}\left[2\left(\dfrac{1}{3}\right)^{\dfrac{n}{2}} + 1\right] & (n \in \text{even}) \\ \dfrac{1}{3}\left[-\left(\dfrac{1}{3}\right)^{\dfrac{n-1}{2}} + 1\right] & (n \in \text{odd})
\end{cases}$$

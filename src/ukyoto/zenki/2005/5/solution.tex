...
\begin{align}
0\le\dfrac{1}{x^2+1}\le1\iff-1\le-1+\dfrac{2}{x^2+1}\le1\iff-1\le\dfrac{1-x^2}{1+x^2}\le1
\end{align}
...
で表せる．$f(\alpha_k)=0$から
\begin{align}
\cos\alpha_k=\dfrac{1-\alpha_k^2}{\alpha_k^2+1}，\qquad\sin\alpha_k=\sqrt{1-\dfrac{(1-\alpha_k^2)^2}{(\alpha_k^2+1)^2}}=\dfrac{2\alpha_k}{\alpha_k^2+1}\ (>0)
\end{align}
であり，
\begin{align}
g(0)=-\dfrac{2\alpha_k}{\alpha_k^2+1}(-\alpha_k)+\dfrac{1-\alpha_k^2}{\alpha_k^2+1}=\dfrac{\alpha_k^2+1}{\alpha_k^2+1}=1
\end{align}
から，$\ell_k$は$(0,1)$を通る．$\blacksquare$

\textbf{(2)} $h(x)=g(x)-\dfrac{1-x^2}{1+x^2}$とおく．
\begin{align}
h(x)&=-\dfrac{2\alpha_k}{\alpha_k^2+1}x+1-\dfrac{1-x^2}{1+x^2}\\
&=-\dfrac{2\alpha_k}{\alpha_k^2+1}x+2-\dfrac{2}{1+x^2}\\
&=\dfrac{-2x}{(\alpha_k^2+1)(x^2+1)}(x-\alpha_k)(\alpha_kx-1)
\end{align}
...
$t$ & $2k\pi$ & & $\left(2k+\dfrac{1}{2}\right)\pi$ & & $(2k+1)\pi$ \\
\hline
$Y'$ & & $+$ & $0$ & $-$ & \\
\hline
$Y$ & $1$ & $\nearrow$ & & $\searrow$ & $-1$ \\

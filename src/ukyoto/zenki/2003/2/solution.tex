...
ここで，
\begin{align}
\int_0^{\pi/2}x^2\sin^2x\,dx=\int_0^{\pi/2}\dfrac{1}{2}x^2(1-\cos2x)\,dx\quad\cdots②
\end{align}
であり，
\begin{align}
\int_0^{\pi/2}x^2\cos2x\,dx=\left[\dfrac{x^2}{2}\sin2x+\dfrac{2x}{4}\cos2x-\dfrac{2}{8}\sin2x\right]_0^{\pi/2}=-\dfrac{\pi}{4}
\end{align}

から，②に代入して
\begin{align}
\int_0^{\pi/2}x^2\sin^2x\,dx=\dfrac{1}{2}\left[\dfrac{1}{3}x^3\right]_0^{\pi/2}+\dfrac{\pi}{8}=\dfrac{1}{48}\pi^3+\dfrac{1}{8}\pi\quad\cdots③
\end{align}

又，
\begin{align}
\int_0^{\pi/2}(x-\pi)^2\,dx=\left[\dfrac{1}{3}x^3-\pi x^2+\pi^2x\right]_0^{\pi/2}=\dfrac{7}{24}\pi^3\quad\cdots④
\end{align}

③④を①に代入して
\begin{align}
V&=\pi\left\{\dfrac{7}{24}\pi^3-\dfrac{1}{48}\pi^3-\dfrac{1}{8}\pi\right\}\\
&=\pi\left(\dfrac{13}{48}\pi^3-\dfrac{1}{8}\pi\right)．
\end{align}

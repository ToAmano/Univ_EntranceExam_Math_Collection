...
\iff & \begin{cases} \dfrac{x^2}{t^2 + \dfrac{1}{2} c} + \dfrac{y^2}{\dfrac{1}{2} c} = 1 & (\because c > 0, t > 0) \\ c + t^2 \ge x^2 + y^2 \end{cases}
\end{align}
...
\draw (1.5,0) -- (1.5,0.2) node[above]{$\sqrt{t^2+\dfrac{1}{2}c}$};
\draw (-1.5,0) -- (-1.5,0.2) node[above]{$-\sqrt{t^2+\dfrac{1}{2}c}$};
\draw (0,1) node[right]{$\sqrt{\dfrac{1}{2}c}$};
\end{tikzpicture}
\end{center}

...
\[
  \begin{aligned}
    ...
    \end{pmatrix} =
    \begin{pmatrix} \frac{\alpha-\beta}{2} \\ \alpha(\alpha-\beta)
    \end{pmatrix} = (\beta-\alpha)
    \begin{pmatrix} -\frac{1}{2} \\ -\alpha
    \end{pmatrix} \quad \cdots (*) \\
    \vec{PR} &=
    \begin{pmatrix} \beta-a \\ \beta^2-b
    \end{pmatrix} =
    \begin{pmatrix} \frac{-\alpha+\beta}{2} \\ \beta(\beta-\alpha)
    \end{pmatrix} = (\beta-\alpha)
    \begin{pmatrix} \frac{1}{2} \\ \beta
    \end{pmatrix}
  \end{aligned}
\]

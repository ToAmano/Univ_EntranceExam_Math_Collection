...
$x$ & $\dots$ & $-\sqrt{-\dfrac{p}{3}}$ & $\dots$ & $\sqrt{-\dfrac{p}{3}}$ & $\dots$ \\ \hline
$f'(x)$ & $+$ & $0$ & $-$ & $0$ & $+$ \\ \hline
...
\caption{$g(x)$ の増減表}
\begin{tabular}{c|ccccc}
$x$ & $\dots$ & $-\dfrac{2a}{3}$ & $\dots$ & $0$ & $\dots$ \\ \hline
$g'(x)$ & $+$ & $0$ & $-$ & $0$ & $+$ \\ \hline
$g(x)$ & $\nearrow$ & 極大 & $\searrow$ & 極小 & $\nearrow$
\end{tabular}
\end{table}
...
\begin{align}
 \begin{cases}
  f\left(-\sqrt{-\dfrac{p}{3}}\right) = g\left(-\dfrac{2}{3}a\right) \\
  f\left(\sqrt{-\dfrac{p}{3}}\right)  = g\left(0\right) 
...
\begin{align}
 \begin{cases}
   g\left(-\dfrac{2}{3}a\right) = (-\dfrac{2}{3}a)^3 + a(-\dfrac{2}{3}a)^2 + b = \dfrac{4}{27}a^3 + b \\
   g(0) = b
...
\begin{align}
 \begin{cases}
    2q = \dfrac{4}{27}a^3 + 2b \\
    -2\sqrt{-\dfrac{p}{3}} (\dfrac{2}{3}p) = \dfrac{4a^3}{27}
 \end{cases} \\
\therefore
 \begin{cases} 
    q = \dfrac{2}{27}a^3 + b \\ 

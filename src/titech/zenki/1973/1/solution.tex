...
題意の不等式
\begin{align}
 0<\left| \frac{p}{q}-\frac{2}{3} \right|<\frac{1}{q^2} \label{eq:1} 
\end{align}
について考える．この不等式は$(p,q) \to (-p,-q)$についての対称性を持つから，以下$q>0$として考える．

まず左側の不等号から
\begin{align}
 \frac{p}{q} \neq \frac{2}{3} \label{eq:2}
\end{align}
である．\cref{eq:1}の絶対値を外して
\begin{align}
-\frac{1}{q^2} < \frac{p}{q} - \frac{2}{3} < \frac{1}{q^2} \label{eq:3}
\end{align}
である．

\label{eq:3}の両辺に $q$ をかけて成立すると今は$q>0$のケースを考えているので
\begin{align}
\frac{2}{3}q - \frac{1}{q} < p < \frac{2}{3}q + \frac{1}{q} \label{eq:4}
\end{align}
となる．
$q = 3m+i \ (m \in \mathbb{Z}_{\ge 0}, i=0,1,2)$と場合分けして考える．

\subparagraph{$q = 3m$の時}
 $|\frac{1}{q}| < 1$ から\cref{eq:4}は
\begin{align}
 2m - \frac{1}{3m} < p < 2m + \frac{1}{3m}
\end{align}
となり，これをみたす $(p,q)$ は $(2m, 3m)$ となるが, \cref{eq:2} からこれは不適である.

\subparagraph{$q = 3m+1$の時}
 $\frac{2}{3}q = 2m + \frac{2}{3}$ だから\cref{eq:4}は
\begin{align}
 2m + \frac{2}{3} - \frac{1}{q} < p < 2m + \frac{2}{3} + \frac{1}{q} \label{eq:5}
\end{align}
である．
...
\begin{tikzpicture}[scale=2, >=stealth]
  ...
  \node[below, font=\small, color=blue!80!black] at (L) {$\frac{2}{3} - \frac{1}{q}$};
  \node[below, font=\small, color=blue!80!black] at (R) {$\frac{2}{3} + \frac{1}{q}$};
...
$q \ge 1$より
\begin{align}
 \frac{2}{3} - \frac{1}{q} \ge \frac{-1}{3} > -1 \\
 \frac{2}{3} + \frac{1}{q} \le \frac{5}{3}  < 2
\end{align}
...
$\frac{2}{3}q = 2m + \frac{4}{3}$ だから\cref{eq:4}は
\begin{align}
 2m + \frac{4}{3} - \frac{1}{q} < p < 2m + \frac{4}{3} + \frac{1}{q} \label{eq:7}
\end{align}
である．
...
\begin{tikzpicture}[scale=2, >=stealth]
  ...
  \node[below, font=\small, color=blue!80!black] at (L) {$\frac{4}{3} - \frac{1}{q}$};
  \node[below, font=\small, color=blue!80!black] at (R) {$\frac{4}{3} + \frac{1}{q}$};
...
$q \ge 2$より
\begin{align}
 \frac{4}{3} - \frac{1}{q} \ge \frac{4}{3} - \frac{1}{2} = \frac{5}{6}  > 0\\
 1< \frac{4}{3} + \frac{1}{q} \le \frac{4}{3} + \frac{1}{2} = \frac{11}{6} < 2  
\end{align}

...
\textbf{A（半球）：} $V_A=\dfrac{4}{3}\pi a^3\cdot\dfrac{1}{2}=\dfrac{2}{3}\pi a^3$

\textbf{B（円錐台，⑩の直線を回転）：} 底円半径$a$，高さ$a/\sqrt{a^2-1}$の円錐から，底円半径$1/a$，高さ$\dfrac{1}{a\sqrt{a^2-1}}$の円錐を引いたもの：
\begin{align*}

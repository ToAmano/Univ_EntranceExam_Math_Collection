...
この左辺を$f(t)$とおく．
\begin{align*}
f'(t)=e^t-e^{t/2}\Bigl(1+\dfrac{t}{2}\Bigr)=e^{t/2}\Bigl\{e^{t/2}-\Bigl(\dfrac{t}{2}+1\Bigr)\Bigr\}>0\qquad(\because t>0,\ e^{t/2}>1+\dfrac{t}{2})
\end{align*}
だから，$f(t)$は単調増加で，$0<t$のとき$f(t)>f(0)=0$．よって①が成り立ち，(*)が示された．

\textbf{(2)} $g(t)=e^t-e^{t/a}t-1$とおく．$t>0$で$g(t)\ge0$であることを示せばよい．$x=t/a$とおくと
\begin{align*}
g'(t)=e^t-e^{t/a}\Bigl(1+\dfrac{t}{a}\Bigr)=e^{ax}-e^x(1+x)=e^x\bigl[e^{(a-1)x}-(x+1)\bigr].\tag{②}
\end{align*}

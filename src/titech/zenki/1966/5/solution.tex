...
となり, 
\begin{align}
 \{ \alpha_2, \alpha_3 \} = \left\{ e\left(\frac{2}{3}\pi\right), e\left(\frac{4}{3}\pi\right) \right\}
\end{align}
を得る．逆にこの時題意の条件は全て満たして十分である．すなわち
\begin{align}
 \left(\alpha_1,\alpha_2,\alpha_3\right) = \left(1, e\left(\frac{2}{3}\pi\right), e\left(\frac{4}{3}\pi\right) \right) \label{eq:3}
\end{align}
は解の一つである．

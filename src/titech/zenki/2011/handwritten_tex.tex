...
\begin{proof}[解]
  ...
  \begin{align*}
    f(x)=
    \begin{cases}\displaystyle\int_0^{\pi/2}g(t)\,dt & \Bigl(x\le\dfrac12\Bigr)\\[2mm]\displaystyle\int_0^\alpha g(t)\,dt-\int_\alpha^{\pi/2}g(t)\,dt & \Bigl(\dfrac12\le x\Bigr)
    \end{cases}\tag{①}
  \end{align*}
  ...
  \begin{align*}
    f(x)=
    \begin{cases}1-x & \Bigl(x\le\dfrac12\Bigr)\\[1mm]x+\dfrac1{2x}-1 & \Bigl(x\ge\dfrac12\Bigr)
    \end{cases}
  \end{align*}

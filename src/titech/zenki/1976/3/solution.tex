...
\begin{tikzpicture}[scale=1.8, >=stealth]
  ...
  \node[below] at (A) {$\dfrac{a}{2}$};
  \node[left] at (0,1.5) {$\dfrac{a}{2}$};
...
\iff r=\dfrac{a}{2}-r\cos\theta \\
\iff r=\dfrac{\dfrac{1}{2} a}{1+\cos\theta} \quad (0\le\theta\le\pi/4) \label{eq:1}
\end{align}
...
\begin{align}
S'
  & =\int_0^{\pi/4}\dfrac{1}{2}r^2d\theta \\
  &= \dfrac{a^2}{8}\int_0^{\pi/4}\dfrac{1}{(1+\cos\theta)^2}d\theta \\
  &= \dfrac{a^2}{8}\int_0^{\pi/4}\dfrac{1}{4\cos^4\dfrac{\theta}{2}}d\theta \\
\end{align}
である．以下簡単のため $c=\cos\dfrac{\theta}{2},\ t=\tan\dfrac{\theta}{2}$ とすると
\begin{align}
S'
  & =\dfrac{a^2}{32}\int_0^{\pi/4}(1+t^2)\dfrac{1}{C^2}d\theta \\
  & = \dfrac{2a^2}{32}\left[t+\dfrac{1}{3}t^3\right]_0^{\pi/4} \\
  &= \dfrac{a^2}{16}\left(\tan\dfrac{\pi}{8}+\dfrac{1}{3}\tan^3\dfrac{\pi}{8}\right) \label{eq:3}
\end{align}
...
\begin{align}
S'
 & =\dfrac{a^2}{16}(-1+\sqrt{2})\left(1+\dfrac{1}{3}(-1+\sqrt{2})^2\right) \\
 &= \dfrac{a^2}{16}(-1+\sqrt{2})\left(\dfrac{6-2\sqrt{2}}{3}\right) 
\end{align}
となって，\cref{eq:2}に代入して
\begin{align}
S
  &=\dfrac{a^2}{2}\cdot\dfrac{2}{3}(-1+\sqrt{2})(3-\sqrt{2}) \\
  &= \dfrac{a^2}{3}(-5+4\sqrt{2})
\end{align}
である．
...
\begin{align}
y^2
  &=-4\alpha\left(x-\dfrac{a}{4}\right)\\
  &=-a\left(x-\dfrac{a}{4}\right)
\end{align}
である．
...
\begin{tikzpicture}[scale=2, >=stealth]
  ...
  % 目盛りラベル
  \node[left, font=\small] at (0, {\yIntersect}) {$\dfrac{\sqrt{2}-1}{2}a$};
  \node[below right, font=\small] at (\aFour, 0) {$\dfrac{a}{4}$};
  \node[below, font=\small] at ({2*\aFour}, 0) {$\dfrac{a}{2}$};
...
\end{tikzpicture}
\end{center}
\caption{放物線 $y^2 = -a\left(x - \dfrac{a}{4}\right)$ と領域 $S'$}
\end{figure}

よって上図斜線部の面積 $S'$ は
\begin{align}
S'
 &=\int_0^{\dfrac{\sqrt{2}-1}{2}a}\left(-\dfrac{1}{a}y^2+\dfrac{a}{4}\right)dy-\dfrac{1}{2}\left(\dfrac{\sqrt{2}-1}{2}a\right)^2 \\
 &=-\dfrac{1}{3a}\left(\dfrac{\sqrt{2}-1}{2}a\right)^3+\dfrac{a}{4}\cdot\dfrac{\sqrt{2}-1}{2}a-\dfrac{1}{8}(3-2\sqrt{2})a^2
\end{align}
と計算され，[解1] と同じく $S=\dfrac{a^2}{3}(-5+4\sqrt{2})$ を得る．

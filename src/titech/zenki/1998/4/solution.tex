...
\begin{align*}
\ell:\ \dfrac{p}{a^2}x+qy=1,\qquad p=ac,\ q=s
\end{align*}
...
\begin{align*}
\vec\ell\times(0,1)=-as,\qquad \vec\ell\cdot(0,1)=c \quad\therefore\ \tan\beta=\dfrac{as}{|c|}
\end{align*}
...
\begin{align*}
\therefore\ \tan\alpha=\dfrac{a(1-c)}{s\{a^2(1-c)+c\}}
\end{align*}

条件$\alpha=\beta$（ともに鋭角）より$\tan\alpha=\tan\beta$：
\begin{align*}
\dfrac{a(1-c)}{s\{a^2(1-c)+c\}}=\dfrac{as}{|c|}
\end{align*}
\begin{align*}
...
\end{align*}
\begin{align*}
c=\dfrac{1\pm\sqrt{1+a^2(a^2-1)}}{a^2-1}
\end{align*}
$c<0$かつ$a>1$（$a^2-1>0$）より，$+$の解は常に正だから不適．よって
\begin{align*}
c=\dfrac{1-\sqrt{1+a^2(a^2-1)}}{a^2-1}
\end{align*}
（これは確かに負：$\sqrt{1+a^2(a^2-1)}>1$だから分子は負．）

\textbf{(1)} 求める$p$は
\begin{align*}
p=ac=\dfrac{a\left\{1-\sqrt{1+a^2(a^2-1)}\right\}}{a^2-1}
\end{align*}

\textbf{(2)} 分子を有理化すると
\begin{align*}
p=\dfrac{a\left\{1-\bigl(1+a^2(a^2-1)\bigr)\right\}}{(a^2-1)\left\{1+\sqrt{1+a^2(a^2-1)}\right\}}=\dfrac{-a^3(a^2-1)}{(a^2-1)\left\{1+\sqrt{1+a^2(a^2-1)}\right\}}=\dfrac{-a^3}{1+\sqrt{1+a^2(a^2-1)}}
\end{align*}
したがって
\begin{align*}
...
また，
\begin{align*}
\dfrac{p}{a}=\dfrac{1-\sqrt{1+a^2(a^2-1)}}{a^2-1}=\dfrac{\dfrac{1}{a^2}-\sqrt{\dfrac{1}{a^4}+1-\dfrac{1}{a^2}}}{1-\dfrac{1}{a^2}}
\end{align*}
$a\to\infty$の時，$1/a^2\to0,\ 1/a^4\to0$だから
\begin{align*}
\lim_{a\to\infty}\dfrac{p}{a}=\dfrac{0-\sqrt{1}}{1-0}=-1
\end{align*}

...
\begin{align}
  \begin{pmatrix}X\\Y
  \end{pmatrix}=\overrightarrow{OC}+\overrightarrow{CP}=3
  \begin{pmatrix}\cos\theta\\\sin\theta
  \end{pmatrix}+
  \begin{pmatrix}\cos(3\theta-\pi)\\\sin(3\theta-\pi)
  \end{pmatrix}=3
  \begin{pmatrix}\cos\theta\\sin\theta
  \end{pmatrix}-
...
\begin{align}
  ...
  \end{split}
\end{align}
だから増減表は下のようになる．ただし$\left.
\begin{pmatrix}X\\Y
\end{pmatrix}\right|_{\theta=t}$と$\left.
\begin{pmatrix}X\\Y
\end{pmatrix}\right|_{\theta=2\pi-t}$（$0\le t\le\pi$）が$x$軸に関して対称なので，$0\le\theta\le\pi$とした．

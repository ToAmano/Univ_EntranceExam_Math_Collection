...
\begin{enumerate}
  ...
  \subparagraph{$1^\circ$ $\alpha,\beta,\gamma\in\mathbb{R}$ の時}
  ...
  \subparagraph{$2^\circ$ $\alpha,\beta,\gamma$ のうち1つのみ実数の時}
  ...
  \begin{align}
  e(2\theta)=e(-\theta) \quad\therefore\ 2\theta=-\theta+2n\pi\ (n\in\mathbb{Z}) \quad\therefore\ \theta=\dfrac{2}{3}n\pi
  \end{align}
  $0\le\theta<2\pi$ から，$n=0,1,2$ として，
  \begin{align}
  \theta=0,\dfrac{2\pi}{3},\dfrac{4\pi}{3}
  \end{align}
...
\casesend$a,b,c\in\mathbb{R}$ から，以上で全ての場合がつくせる．よって①②③より，
  \begin{align}

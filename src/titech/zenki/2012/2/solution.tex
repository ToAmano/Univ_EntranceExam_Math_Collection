...
{\bf [解]}
\textbf{(1)} $A=\displaystyle\sum_{n=0}^{99}3^n=\dfrac{3^{100}-1}{3-1}=\dfrac{1}{2}(3^{100}-1)=\dfrac{3^{100}}{2}-\dfrac{1}{2}$とおく．$3^{100}/2$は整数ではないが，桁数を考える上で$A$は$B:=3^{100}/2$とほぼ同じ大きさであり，$3^{100}/2$が$10^\ell$（$\ell\in\mathbb Z$）の形になることはないから，$A$の桁数は$B$の桁数と一致する．$B$が$m$桁とすると$10^{m-1}\le B<10^m$．常用対数をとって
\begin{align}

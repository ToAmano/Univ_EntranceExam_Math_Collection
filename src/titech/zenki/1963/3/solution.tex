...
&= \frac{|EP|}{|EK|} \\
&= \frac{|EP|}{\text{円$E$の半径}} \\
&= \frac{X + \sqrt{2}r}{r(1-r)} \\
&= \frac{\sqrt{2}r \left[ \frac{r^2-2r-2}{4} + 1 \right]}{r(1-r)} \\
&= \frac{r^2-2r+2}{4(1-r)} \cdot \sqrt{2} \\
&= \frac{\sqrt{2}}{4} \left\{ (1-r) + \frac{1}{1-r} \right\} \label{eq:2}
\end{align*}
である．

...
& \frac{1}{x} + \frac{1}{y} \le 4(1+a) \label{eq:3}
\end{align}
...
\begin{align}
& 0 < 1 + a - x \label{eq:6} \\
& 0 < \frac{1}{4(1+a) - \frac{1}{x}} \\
& \frac{1}{4(1+a) - \frac{1}{x}} \le 1 + a - x \label{eq:7} 
\end{align}
である．
\cref{eq:7}を整理すると
\begin{align}

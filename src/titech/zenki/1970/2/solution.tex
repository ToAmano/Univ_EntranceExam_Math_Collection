...
\begin{align}
 ...
 \overline{FR} \cdot \overline{FS} &= r\left(\alpha+\dfrac{\pi}{2}\right) r\left(\alpha-\dfrac{\pi}{2}\right) = \dfrac{A^2}{1-e^2\sin^2\alpha}
\end{align}
だから求める値は
\begin{align}
 \dfrac{1}{\overline{PF}\cdot\overline{QF}} + \dfrac{1}{\overline{FR}\cdot\overline{FS}} = \dfrac{2-e^2}{A^2} = \dfrac{2-e^2}{a^2(1-e^2)^2}.
\end{align}
である．

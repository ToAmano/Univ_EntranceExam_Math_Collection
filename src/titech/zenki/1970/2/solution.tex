...
\begin{figure}[htb]
 ...
 \begin{tikzpicture}[scale=2, >=stealth]
  ...
  \node[below right] at (2.01246,0) {$\frac{a}{e}$};
...
(2)
線分$PQ$，$RS$が点$F$を通ってかつこれら二つが直交するので，$P, Q$ に対応する $\theta$ を $\alpha, \alpha+\pi \, (0 \leqq \alpha \leqq \pi)$, $R, S$ に対応する $\theta$ を $\alpha-\frac{\pi}{2}, \alpha+\frac{\pi}{2}$ とおける．

...
\textbf{(1)}
\begin{align}
\left|z+\dfrac{1}{2}\right|<\dfrac{1}{2} \iff \left|(rc+\tfrac12)+irs\right|<\dfrac{1}{2} \iff \left(rc+\dfrac{1}{2}\right)^2+(rs)^2<\dfrac{1}{4} \quad(\because\text{両辺}\ge0)
\end{align}
\begin{align}
...
\begin{align}
\left|1+z+\cdots+z^n\right|^2=\dfrac{|z^{n+1}-1|^2}{|z-1|^2}
\end{align}
...
よって
\begin{align}
|1+z+\cdots+z^n|^2=\dfrac{r^{2n+2}-2r^{n+1}\cos(n+1)\theta+1}{r^2-2r\cos\theta+1}
\end{align}

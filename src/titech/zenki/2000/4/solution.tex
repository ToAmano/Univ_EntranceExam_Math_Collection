...
\begin{align}
\begin{split}
S_n&=\int_0^{a_n}\left\{e^x-(e^{nx}-1)\right\}dx=\left[e^x-\dfrac{1}{n}e^{nx}+x\right]_0^{a_n}
=e^{a_n}-\dfrac{1}{n}e^{na_n}+a_n-1+\dfrac{1}{n} \\
&\therefore\ nS_n=n(e^{a_n}-1)+na_n+1-e^{na_n}=na_n\cdot\dfrac{e^{a_n}-1}{a_n}+na_n+1-e^{na_n}
\end{split}
\end{align}

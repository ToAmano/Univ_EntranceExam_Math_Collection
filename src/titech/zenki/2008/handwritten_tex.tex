...
\begin{proof}[解]
  ...
  \begin{align*}
    \overrightarrow{OP}=a
    \begin{pmatrix}C\\-S
    \end{pmatrix},\qquad\overrightarrow{OQ}=b
    \begin{pmatrix}C\\S
    \end{pmatrix}
  \end{align*}
  ...
  \begin{align*}
    \overrightarrow{MR}=\frac{\sqrt3}2
    \begin{pmatrix}(b+a)S\\-(b-a)C
    \end{pmatrix}.
  \end{align*}
  $M=\Bigl(\dfrac{a+b}2C,\ \dfrac{b-a}2S\Bigr)$なので，$I=a+b,\ H=b-a$とおくと
  \begin{align*}
    \overrightarrow{OR}=\overrightarrow{OM}+\overrightarrow{MR}=\frac12
    \begin{pmatrix}IC\\HS
    \end{pmatrix}+\frac{\sqrt3}2
    \begin{pmatrix}IS\\-HC
    \end{pmatrix}=\frac12
    \begin{pmatrix}I(C+\sqrt3S)\\H(S-\sqrt3C)
    \end{pmatrix}.
  \end{align*}
  よって$R=(X,Y)$とおくと
  \begin{align*}

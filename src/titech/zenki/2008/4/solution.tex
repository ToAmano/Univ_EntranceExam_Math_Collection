...
\begin{align}
  \overrightarrow{MR}=\dfrac{\sqrt{3}}{2}
  \begin{pmatrix}(b+a)\sin\alpha \\-(b-a)\cos\alpha
  \end{pmatrix}
\end{align}
となる．
...
\begin{align}
  ...
  &=\dfrac{1}{2}
  \begin{pmatrix}\dfrac{a+b}{2}\cos\alpha\\ \dfrac{b-a}{2}\sin\alpha
  \end{pmatrix}+\dfrac{\sqrt{3}}{2}
  \begin{pmatrix}(b+a)\sin\alpha\\ -(b-a)\cos\alpha
  \end{pmatrix} \\
  &=\dfrac{1}{2}
  \begin{pmatrix}(a+b)(\cos\alpha+\sqrt{3}\sin\alpha)\\H(\sin\alpha-\sqrt{3}\cos\alpha)
  \end{pmatrix}
\end{align}
である．
よって$R=(X,Y)$とおくと

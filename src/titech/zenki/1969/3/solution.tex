...
\alpha = u - 1, \beta = \dfrac{1}{2}(1 - v) \label{eq:3} 
\end{align}
である．
...
$a$が
\begin{align}
 \dfrac{1}{\sqrt{2}} \le a \le 1
\end{align}
の範囲を動く時，
\begin{align}
 \dfrac{1}{2} \le a^2 \le 1
\end{align}
だから，\cref{eq:4}の領域は
\begin{align}
\begin{cases}
-u^2 + 2u + \dfrac{1}{2} \le v \le -u^2 + 2u + 1 \\
v \ge \dfrac{1}{2}(-u^2 + 2u + 1)
...
\begin{tikzpicture}[scale=2]
  ...
  \draw[thick, domain=-0.6:2.6, samples=100] plot (\x, {-\x*\x + 2*\x + 0.5}) node[right] {\small $v = -u^2 + 2u + \dfrac{1}{2}$};
  \draw[thick, blue, domain=-0.6:2.6, samples=100] plot (\x, {-0.5*\x*\x + \x + 0.5}) node[below left] {\small $v = \dfrac{1}{2}(-u^2 + 2u + 1)$};

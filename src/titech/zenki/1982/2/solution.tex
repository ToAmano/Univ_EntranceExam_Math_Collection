...
\end{align}
  ...
  \begin{align}
  |\vec a-\vec b|\ge1 \iff 2-2\cos\theta\ge1 \iff \dfrac{\pi}{3}\le\theta\le\dfrac{\pi}{2} \quad \cdots \text{④}
  \end{align}
  だから$S=\dfrac{1}{2}\sin\theta$の$\min$は，$\theta=\dfrac{\pi}{3}$の時の$\dfrac{\sqrt{3}}{4}$である．

...
I 
 ...
 &= -\frac{1}{2} \left[ \frac{1}{\alpha+\beta}\sin(\alpha+\beta)x - \frac{1}{\alpha-\beta}\sin(\alpha-\beta)x \right]_0^1 \\
 &= -\frac{1}{2} \left( \frac{1}{\alpha+\beta}\sin(\alpha+\beta) - \frac{1}{\alpha-\beta}\sin(\alpha-\beta) \right) \label{eq:1}
\end{align}
である．
...
\begin{align}
 \cos x = \pm \frac{1}{\sqrt{1+\tan^2 x}} = \pm \frac{1}{\sqrt{1+4x^2}} \label{eq:2}
\end{align}
であり，よって$\cos^2 x+\sin^2 x=1$より
\begin{align}
 \sin x = \pm \frac{2x}{\sqrt{1+4x^2}} \label{eq:3}
\end{align}
である．
...
\begin{align}
 I 
   &= -\frac{1}{2} \frac{1}{\sqrt{(1+4\alpha^2)(1+4\beta^2)}} \left\{ \frac{A}{\alpha+\beta} - \frac{B}{\alpha-\beta} \right\} \\
   &= 0
\end{align}
となる．
...
\begin{align}
\lambda \cos\lambda - 2\sin\lambda = 0 \iff \tan\lambda = \frac{1}{2}\lambda  
\end{align}
...
\begin{align}
(\alpha^2 - \beta^2) y_1 y_2 = y_1'' y_2 - y_2'' y_1 = \frac{d}{dx} \left( y_1' y_2 - y_2' y_1 \right) 
\end{align}

...
&\ge\ell\log\dfrac{\ell}{p}+(k-\ell)\log(k-\ell)\equiv f(\ell) \quad(\because\text{仮定}) \quad\cdots\text{②}
\end{split}
\end{align}
次に$\ell$をうごかす．
\begin{align}
...
\begin{align}
\begin{split}
f(\ell)&\ge\dfrac{pk}{p+1}\log\dfrac{k}{p+1}+\dfrac{k}{p+1}\log\dfrac{k}{p+1} \\
&=k\log\dfrac{k}{p+1}=B_{p+1} \quad\cdots\text{③}
\end{split}
\end{align}
②，③から
\begin{align}

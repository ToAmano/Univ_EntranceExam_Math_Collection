...
\begin{align}
\dfrac{1}{2}(m+n)(m+n+1)+n&=\dfrac{1}{2}(m'+n')(m'+n'+1)+n' \label{eq:2}
\end{align}
だから，$t=m+n, t'=m'+n'$とおくと
\begin{align}
t(t+1)+2n&=t'(t'+1)+2n' \label{eq:3}
\end{align}
である．
...
$f(t,n)=g(t,n)$だから\cref{eq:2}が成立するには$t=t'$が必要である．
\cref{eq:3}よりこの時$n=n'$とすれば十分であり，$m=m'$も成立する．

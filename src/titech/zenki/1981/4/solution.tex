...
\begin{tikzpicture}[scale=4, >=stealth]
  ...
  \node[blue!80!black, font=\small, above right] at (0.4, 0.5) {$y = \dfrac{1}{2}\sin\pi t$};

  % 接線 y = (\pi/2)t （t=0 での接線）
  \draw[dashed, red!80!black, thick, domain=0:0.52] plot (\x, {1.5708*\x}) node[above, font=\small] {$y = \dfrac{\pi}{2}t$};
...
\begin{tikzpicture}[scale=3, >=stealth]
  ...
  \node[blue!80!black, font=\small, below] at (0.9, 0.5) {$y = 1 - \dfrac{1}{2}\sin\pi t$};
...
新しく
\begin{align}
 g(t)=\displaystyle\int_0^{\dfrac{\pi}{2}t}|\cos2x|dx
\end{align}

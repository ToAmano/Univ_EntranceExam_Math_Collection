...
\begin{align}
 (a,b) = (2^n,2^n) \label{eq:3}
\end{align}
と書ける．逆にこの時
\begin{align}
 A = 2\cdot 2^{3n} = 2^{3n+1}
\end{align}
とかけて題意を満たすから，\cref{eq:3}は解である．

\subparagraph{$(p,2\alpha-\beta)=(3,1)$の時}

この時$a,b$は
\begin{align}
  a+b=3^\alpha, \qquad a^2-ab+b^2=3^{2\alpha-1} \quad\cdots\text{③} \label{eq:4}
\end{align}
...
\begin{align}
  (a,b)=\left(3^n,2\cdot 3^n\right), \left(2\cdot3^n,3^n\right) \label{eq:5}
\end{align}
が解である．
\casesend


以上の場合わけで全ての場合が尽くされた．よって求める解は\cref{eq:3,eq:4}から
\begin{align}

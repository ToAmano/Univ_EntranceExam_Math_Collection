...
\begin{align}
  ...
  \end{pmatrix} \cdot
  \begin{pmatrix} \cos y \\ \sin y
  \end{pmatrix} \le 2
\end{align}
を満たす．左側の等号成立条件は
\begin{align}
  y = \dfrac{4\pi}{3} \label{eq:1}
\end{align}
であり，右側の等号成立条件は
\begin{align}
  y = \dfrac{\pi}{3} \label{eq:2}
\end{align}
である．
...
\begin{align}
  \max f(x,y) &=
  \begin{cases}
    2\sqrt{2}\sin\left(x+\dfrac{\pi}{4}\right) & \left(0 \le x < \dfrac{\pi}{2}, \; \dfrac{3\pi}{2} < x \le 2\pi, y=\dfrac{\pi}{3} \text{ のとき}\right) \\[8pt]
  ...
  \begin{cases}
    ...
    2\sqrt{2}\sin\left(x+\dfrac{\pi}{4}\right) & \left(\dfrac{\pi}{2} \le x \le \dfrac{3\pi}{2}, y=\dfrac{\pi}{3} \text{ のとき}\right)
  \end{cases}
\end{align}
  ...
  \begin{center}
    \begin{tikzpicture}[x=1.5cm, y=1.2cm, >=stealth]
      ...
      \foreach \x/\lbl in {
        ...
        \draw (\x,0) -- (\x,-0.08) node[below, font=\small] {\lbl};
      }
...
\begin{align}
  \begin{cases}
    \max f = 2\sqrt{2} & \left( (x,y) = \left(\dfrac{\pi}{4}, \dfrac{\pi}{3}\right), \left(\dfrac{3}{4}\pi, \dfrac{4}{3}\pi\right) \right) \\[1ex]
    \min f = -2\sqrt{2} & \left( (x,y) = \left(\dfrac{5}{4}\pi, \dfrac{\pi}{3}\right), \left(\dfrac{7}{4}\pi, \dfrac{4}{3}\pi\right) \right)
  \end{cases}
\end{align}
\newpage

...
\begin{tikzpicture}[scale=0.8, >=stealth]
  ...
  \begin{scope}[shift={(0,0)}]
    ...
    \node at (0, -1.4) {2時(成す角$\dfrac{\pi}{3}$)};
  \end{scope}
  % 2時半
  \begin{scope}[shift={(5,0)}]
    ...
    \node at (0, -1.4) {2時半(成す角$\dfrac{7}{12}\pi$)};
  \end{scope}
  % 4時
  \begin{scope}[shift={(10,0)}]
    ...
    \node at (0, -1.4) {4時(成す角$\dfrac{2}{3}\pi$)};
  \end{scope}
\end{tikzpicture}
\end{center}
\caption{題意の時計の様子}
...
\begin{align}
\begin{cases}
4^2 = R^2 + r^2 - 2Rr \cos \dfrac{\pi}{3} = R^2 + r^2 - Rr  \\
6^2 = R^2 + r^2 - 2Rr \cos \dfrac{7\pi}{12}
\end{cases} \label{eq:1}
\end{align}
である．

ここで$\cos \dfrac{7}{12}\pi < 0$ だから半角公式より
\begin{align}
\cos \dfrac{7}{12}\pi 
  &= -\sqrt{\dfrac{1 + \cos \dfrac{7\pi}{6}}{2}} \\
...
\begin{align}
36 
  &= R^2 + r^2 + 2Rr \dfrac{\sqrt{3}-1}{2\sqrt{2}} \\
  &= R^2 + r^2 + \dfrac{\sqrt{3}-1}{\sqrt{2}} Rr \label{eq:2}
\end{align}
となる．\cref{eq:1,eq:2}を辺々引くと
\begin{align}
   & 20 = \left( \dfrac{\sqrt{6}-\sqrt{2}}{2} + 1 \right) Rr \\
\therefore 
   & Rr = \dfrac{40}{\sqrt{6}-\sqrt{2}+2} \label{eq:3}
\end{align}
である．
...
\begin{align}
l^2 = R^2 + r^2 - 2Rr \cos \dfrac{2\pi}{3} = R^2 + r^2 + Rr 
\end{align}
だから，\cref{eq:3,eq:4}を代入して
\begin{align}
l^2 &= (16 + Rr) + Rr \quad (\because \text{\cref{eq:4}}) \\
&= 16 + 2Rr \\
&= 16 + \dfrac{80}{\sqrt{6}-\sqrt{2}+2} \quad (\because \text{\cref{eq:3}}) \\

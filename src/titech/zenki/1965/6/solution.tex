...
f(t)
  ...
  &= 6^3 \cdot \left(\dfrac{1}{5}\right)^{\frac{5}{2}} \quad (\because \text{AM-GM})
\end{align}
なる評価を得る．等号成立は $p = \left(\dfrac{1}{5}\right)^{\frac{1}{6}}$ つまり $t = \sqrt{1/5}$ の時である．

従って\cref{eq:3}に代入して求める最小値は
\begin{align}
\min \dfrac{S(t)}{\sqrt{t}} 
 &= \dfrac{2}{3} \sqrt{ 6^3 \left(\dfrac{1}{5}\right)^{\frac{5}{2}} } \\

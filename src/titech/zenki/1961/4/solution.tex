...
\begin{tikzpicture}[scale=3, >=stealth]
  ...
  \node[below] at (-0.3,0) {$\dfrac{-1+t}{2}$};
  \node[below left] at (0,0) {$0$};
  \node[below left] at (0.4,0) {$t$};
  \node[below] at (0.7,0) {$\dfrac{1+t}{2}$};
...
\begin{align}
   & c \dfrac{1+t}{2} + \dfrac{1-t}{2} = c \dfrac{-1+t}{2} + \dfrac{1+t}{2} \\
  \therefore 
   & c = t \label{eq:2}
\end{align}
...
であって，点$P, Q$の座標は
\begin{align}
  P\left(\dfrac{1-t}{2} \cdot t + \dfrac{1+t}{2}, \dfrac{1+t}{2}\sqrt{1-t^2}\right) \\
  Q\left(\dfrac{1+t}{2} \cdot t + \dfrac{1-t}{2}, \dfrac{1-t}{2}\sqrt{1-t^2}\right) 
\end{align}
と書ける．

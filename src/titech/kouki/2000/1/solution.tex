...
\begin{multicols}{2}
  ...
  この時の解は
  \begin{align}
    x = \dfrac{a-1 \pm \sqrt{(a-1)^2-4b}}{2}\label{2000-1:eq:2}
  \end{align}
  である．これが$-a$と等しいとき，
  \begin{align}
    -a      & = \dfrac{a-1 \pm \sqrt{(a-1)^2-4b}}{2} \\
  ...
  \begin{enumerate}
    \item $f(x)$が異なる三つの実数解を持つとき．\\
          ...
          \begin{align}
             & \begin{dcases}
                 -a \le 0 \\
                 \dfrac{a-1 + \sqrt{(a-1)^2-4b}}{2} \le 0
               \end{dcases} \\
            \therefore
             & \begin{dcases}
                 -a \le 0 \\
    ...
    \item $f(x)$が異なる二つの実数解を持つとき．\\
          ...
          \begin{align}
            D = (a-1)^2 -4b = 0
          \end{align}
          であり，この時の重解は $x = \dfrac{a-1}{2}$である．これが$-a$と一致しないことにより$a\neq 1/3$が必要．
          題意の条件は
          \begin{align}
             & -a \le 0 \\
            \therefore
  ...
  \begin{align}
    \begin{dcases}
      ...
      (a-1)^2 -4b > 0, b = - 2a^2+a, a\le \dfrac{1}{2} \\
      (a-1)^2 -4b = 0, a \ge 0                        \\
      (a-1)^2 -4b < 0 ,      a \ge 0                  \\
    \end{dcases}
  \end{align}

...
\setcounter{table}{0}
\begin{oframed}
  \input{../../../problems/2011/1/problem.tex}
\end{oframed}
...
\begin{multicols}{2}
  ...
  \begin{align}
    f(t) & = 8\pi \frac{r^3}{t}                                          \nonumber \\
         ...
         & = 8\pi \frac{t^2}{(1+2t+\sqrt{2t^2+1})^3} \label{2011-1:eq:4}
  \end{align}
  ...
  \begin{align*}
    S
     ...
     & = \frac{1}{2}|OA||OB|\sqrt{1-\cos^2\angle AOB}                         \\
     & = \frac{1}{2}\sqrt{|OA|^2|OB|^2-|OA|^2|OB|^2\cos^2\angle AOB}          \\

...
\begin{multicols}{2}
  ...
  \begin{align}
    X
     & = \frac{1}{2}(\alpha+\beta)                                 \\
     & =\frac{p}{2} \label{1997-1:eq:3}                            \\
    Y
     & = \frac{1}{2}\left(\alpha^2+\beta^2\right)                  \\
     & = \frac{1}{4}\left[(\alpha+\beta)^2+(\beta-\alpha)^2\right] \\
     & = \frac{1}{4}\left(p^2+q^2\right)\label{1997-1:eq:4}
  \end{align}
  ...
  \begin{align}
    \frac{1}{2}S_a
     ...
     & = \frac{1}{4}\int_{0}^{a} \frac{1}{1+4x^2} dx \label{1997-1:eq:5}
  \end{align}
  ...
  \begin{align}
    ...
    \nonumber                                                                                           \\
        & = \frac{1}{8}\int_{0}^{\alpha} d\theta \nonumber                                              \\
        & = \frac{\alpha}{8} \nonumber                                                                  \\
    \therefore
    S_a & = \frac{\alpha}{4} \label{1997-1:eq:6}
  \end{align}
  と面積が求まる．$a = \frac{1}{2}\tan \alpha$より，$a\to\infty$で$\alpha\to\pi/2$だから，\cref{1997-1:eq:6}の極限は
  \begin{align*}

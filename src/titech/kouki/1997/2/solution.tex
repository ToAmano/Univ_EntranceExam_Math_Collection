...
\begin{multicols}{2}
  ...
  \begin{align}
    p_{n+1}-\dfrac{1}{4} & = \dfrac{-1}{3}\left(p_n-\dfrac{1}{4}\right)
  \end{align}
  だから，これと$p_1=0$から
  \begin{align}
    p_n
     & = \left(-\dfrac{1}{3}\right)^{n-1}\left(0-\dfrac{1}{4}\right)+\dfrac{1}{4} \\
     & = \dfrac{1}{4}\left\{1-\left(-\dfrac{1}{3}\right)^{n-1}\right\}
  \end{align}
  となる．$\cdots$(答)
  ...
  実際今回の場合は
  \begin{align}
     & \lim_{n\to\infty} p_n = \dfrac{1}{4}  \\
     & \lim_{n\to\infty} q_n = \dfrac{3}{16}
  \end{align}

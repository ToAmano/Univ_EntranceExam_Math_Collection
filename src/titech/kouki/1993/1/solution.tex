...
\begin{multicols}{2}
  ...
  \vspace{5pt}
  \underline{\textbf{$\dfrac{1}{3} \le t \le \dfrac{2}{3}$ の場合}}
  ...
  \vspace{5pt}
  続いて，体積$V$の計算を行う．
  この立体は$t=\dfrac{1}{2}$（立方体の中心）に関して対称であるため，
  体積の半分$\dfrac{V}{2}$を$t=0$から$t=\dfrac{1}{2}$まで積分して求める．
  ...
  \begin{align}
    \dfrac{V}{2}
     ...
     & = \sqrt{3}\pi \left( \dfrac{2}{27} + \left\{ \dfrac{1}{4} - \dfrac{3}{4} + 1 \right\} - \left\{ \dfrac{2}{27} - \dfrac{1}{3} + \dfrac{2}{3} \right\} \right)  \\
     & = \sqrt{3}\pi \left( \dfrac{2}{27} + \dfrac{1}{2} - \dfrac{11}{27} \right)                                                                                 \\
     & = \sqrt{3}\pi \left( \dfrac{1}{2} - \dfrac{9}{27} \right) = \sqrt{3}\pi \left( \dfrac{1}{2} - \dfrac{1}{3} \right) = \sqrt{3}\pi \left( \dfrac{1}{6} \right) \\
     & = \dfrac{\sqrt{3}}{6}\pi
  \end{align}
  したがって，求める体積$V$は，
  \begin{align}
    V = 2 \times \dfrac{\sqrt{3}}{6}\pi = \dfrac{\sqrt{3}}{3}\pi
  \end{align}
  である．$\cdots$(答)

...
\begin{multicols}{2}
  ...
  \begin{align}
    t_n = \sum_{k=0}^{n-1} d_k = a \dfrac{1-(ap)^n}{1-ap}
  \end{align}
  となる．題意より$0<a<1$であり，またその定義から$|p|=1$であるから
  $\lim_{n \to \infty} (ap)^n = 0$となり，$t_n$の極限値は
  \begin{align}
    \lim_{n \to \infty} t_n & = \dfrac{a}{1-ap}
  \end{align}
  である．ここに$p=-1/2+i\sqrt{3}/2$を代入すると
  \begin{align}
    \lim_{n \to \infty} t_n
     & = \dfrac{a(1-a\bar{p})}{(1-ap)(1-a\bar{p})}  \\
     & = \dfrac{a(1-a\bar{p})}{1-2a\Re p + a^2}     \\
     & = \dfrac{2a-a^2(-1-i\sqrt{3})}{2(1+a + a^2)} \\
     & = \dfrac{a(2+a)+i\sqrt{3}a^2}{2(1+a + a^2)}  \\
  \end{align}
  したがって，求める座標は
  \begin{align}
    \left( \dfrac{a(2+a)}{2(a^2+a+1)}, \dfrac{\sqrt{3}a^2}{2(a^2+a+1)} \right)
  \end{align}
  である．$\cdots$(答)

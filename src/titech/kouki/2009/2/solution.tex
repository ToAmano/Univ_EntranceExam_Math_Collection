...
\setcounter{table}{0}
\begin{oframed}
  \input{../../../problems/2009/2/problem.tex}
\end{oframed}
...
\begin{multicols}{2}
  ...
  \begin{align}
    f
     ...
     & = \frac{1}{2} \left| \left(m-\frac{2ms}{m+s}\right)\left(-\frac{1}{s}+\frac{2}{m+s}\right) \right.  \nonumber                               \\
     & \quad \left. - \left(s-\frac{2ms}{m+s}\right)\left(-\frac{1}{m}+\frac{2}{m+s}\right) \right|\nonumber                                       \\
     ...
     & = \frac{1}{2} \left|\frac{(s-m)^3}{ms(m+s)}  \right| \label{2009-2:eq:3}
  \end{align}
  となる．
  ...
  \begin{align}
    f
     ...
     & =2\left|\frac{\beta^3}{\alpha(\alpha^2-\beta^2)}\right| \label{2009-2:eq:4}
  \end{align}
  ...
  \begin{align}
    t
     ...
     & =-1+\left(\frac{\beta}{\alpha}\right)^2 \label{2009-2:eq:5}
  \end{align}
  ...
  \begin{align}
    f
     ...
     & =2\frac{\sqrt{t+1}(t+1)}{t} \quad (\because t>0) \label{2009-2:eq:6}
  \end{align}
  ...
  \begin{align*}
    V
     & = \frac{1}{6}\left|\det \mqty(a_x                                                               & b_x & c_x \\ a_y & b_y & c_y \\ a_z & b_z & c_z) \right| \\
     & = \frac{1}{6}\left|a_xb_yc_z + a_yb_zc_x + a_zb_xc_y - a_zb_yc_x - a_xb_zc_y - a_yb_xc_z\right|
  \end{align*}
  が成り立つことが知られている．

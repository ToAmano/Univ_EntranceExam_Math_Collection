...
\begin{center}
  \shadowbox{%
    ...
    \begin{tabular}{|c|c|p{8cm}|}
      ...
      \hline
      \multirow{2}{*}{第1問} & (1)         & $\displaystyle a_n = \dfrac{1}{2}(a+b)t^{n-1} + \dfrac{1}{2}(a-b)\left(\dfrac{10}{t^2+1}\right)^{n-1}$                      \\
      \cline{2-3}
      ...
      \\
      \cline{2-3}
                           & (3)         & $\displaystyle S(\alpha)= 2 -\alpha (\log \alpha)^2 + 2\alpha \log \alpha - 2\alpha + \dfrac{1}{4}\alpha (\log \alpha)^3$ \\
      \hline
    \end{tabular}%

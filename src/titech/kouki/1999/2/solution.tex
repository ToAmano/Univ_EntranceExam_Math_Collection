...
\begin{multicols}{2}
  ...
  \begin{align}
    \sin \dfrac{\pi}{3n}
           ...
           & =\dfrac{r_n(1)}{1-r_n(1)} \nonumber                                      \\
    \therefore
    r_n(1) & = \dfrac{\sin \dfrac{\pi}{3n}}{1+\sin \dfrac{\pi}{3n}} \label{1999-2:eq:1}
  \end{align}
  と求まる．
  ...
  \begin{align}
    O_kT_k
     & = O_kR_k + R_kT_k                                           \\
     & = O_kO_{k+1}\sin\dfrac{\pi}{3n} + r_n(k+1)                   \\
     & = \left(r_n(k)+r_n(k+1)\right)\sin\dfrac{\pi}{3n} + r_n(k+1)
  \end{align}
  となる．したがって
  \begin{align}
    r_n(k)   & = \left(r_n(k)+r_n(k+1)\right)\sin\dfrac{\pi}{3n} + r_n(k+1) \\
    r_n(k+1) & = \dfrac{1-a_n}{1+a_n}r_n(k) \label{1999-2:eq:2}
  \end{align}
  なる漸化式を得る．
  \cref{1999-2:eq:1,1999-2:eq:2}から等比数列の公式より，一般項は
  \begin{align}
    r_n(k)
     & = \left(\dfrac{1-a_n}{1+a_n}\right)^{k-1} r_n(1)           \\
     & = \left(\dfrac{1-a_n}{1+a_n}\right)^{k-1}\dfrac{a_n}{1+a_n}
  \end{align}
  となる．$A = \left(\dfrac{1-a_n}{1+a_n}\right)$ として $|A|<1$ だから，円の面積の総和は
  \begin{align}
    S_n
     & = \lim_{k \to \infty} \sum_{p=1}^{k} r^2_n(p) \cdot \pi \cdot 3n \\
     & = \pi \left(\dfrac{a_n}{1+a_n}\right)^2 \dfrac{1}{1-A^2} \cdot 3n  \\
     & = \dfrac{3\pi}{4} n a_n  \label{1999-2:eq:3}
  \end{align}
  である．円周の総和は
  \begin{align}
    C_n
     & = \lim_{p=1}^{k} \sum_{p=1}^{k} 2\pi r_n(p) \cdot 3n \\
     & = 6n\pi \dfrac{a_n}{1+a_n} \dfrac{1}{1-A}              \\
  ...
  \begin{align}
    S_n & = \dfrac{3\pi}{4} n \sin \dfrac{\pi}{3n} \\
    C_n & = 3n\pi
  \end{align}$\cdots$(答)

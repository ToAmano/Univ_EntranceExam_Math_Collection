...
\begin{multicols}{2}
  ...
  \vspace{10pt}
  \paragraph{(1)}
  \cref{2006-2:eq:1}および$3,5$は素数であることから，$b,c$は各々$3,5$でわり切れる．
  したがって，$b'=\dfrac{1}{3}b$, $c'=\dfrac{1}{5}c ( \in \mathbb{N} )$として
  \cref{2006-2:eq:1}に代入して
  \begin{align}
    \begin{dcases}
      a & =9b'^3 \\
      a & =5c'^2
  ...
  すると(1)と同様に，\cref{2006-2:eq:1}から
  \begin{align}
    a & =p a'   \\
    b & =3p b'' \\
    c & =5p c''
  ...
  これを\cref{2006-2:eq:3}に代入して
  \begin{align}
    a''=9b''^3 = \dfrac{5 c''^2}{p}
  \end{align}
  ...
  \begin{align}
    c'' = p c'''
  \end{align}
  なる$c'''\in\mathbb{N}$がある．\cref{2006-2:eq:3}に代入すると，
  \begin{align}
    a''=9b''^3 = 5pc'''^2
  \end{align}
  ...
  \end{align}
  である．
  これをみたす$(k,l)$は\cref{2006-2:eq:4}の条件では
  $(k,l)=(2,3)$のみであり，この時
  \begin{align}
    a=3^2 \cdot 5^3 = 1125
  \end{align}
  ...
  以上\cref{2006-2:eq:7,2006-2:eq:8}および$2$と$3$が互いに素なので$p_3,p_5$以外について
  \begin{align}

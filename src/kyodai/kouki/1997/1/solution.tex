...
\begin{multicols}{2}
  ...
  \begin{align*}
     ...
     & (a-1)\left(x-p\right)\left(x-\frac{a+1}{a-1}p\right) = 0
  \end{align*}
  ...
  \begin{align*}
     & C_1: 2\frac{a+1}{a-1}p                     \\
     & C_{p,q}: 2a\left(\frac{a+1}{a-1}p-p\right)
  \end{align*}
  だから，これらが直交する条件より，
  \begin{align*}
     & 2a\left(\frac{a+1}{a-1}p-p\right) \cdot 2\frac{a+1}{a-1}p = -1 \\
     & 8a \frac{a+1}{(a-1)^2} p^2 = -1
  \end{align*}

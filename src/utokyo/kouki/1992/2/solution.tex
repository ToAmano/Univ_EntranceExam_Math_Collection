...
\begin{multicols}{2}
  ...
  \begin{align}
    \cos\alpha
     & = \dfrac{\overline{AB}^2+\overline{BC}^2-\overline{AC}^2}{2\overline{AB} \cdot \overline{BC}}                                                              \\
     & = \dfrac{\overline{AB}^2+\overline{BC}^2}{2\overline{AB} \cdot \overline{BC}} + \dfrac{2bq\cos\theta - q^2-b^2-(a-p)^2}{2\overline{AB} \cdot \overline{BC}}
  \end{align}
  と書ける．
  ...
  \begin{align}
    \cos\alpha
     & = (\text{定数})  + \dfrac{bq}{\overline{AB} \cdot \overline{BC}} \cos\theta
  \end{align}
  と書ける．

  従って，$0 \leqq \theta \leqq \pi$で$\cos\theta$は単調減少で，$\dfrac{bq}{AB \cdot BC} > 0$から

...
\begin{multicols}{2}
  ...
  \begin{align}
    \cos\alpha
     & = \dfrac{|AB|^2+|BC|^2-|AC|^2}{2|AB| \cdot |BC|}                                                              \\
     & = \dfrac{|AB|^2+|BC|^2}{2|AB| \cdot |BC|} + \dfrac{2bq\cos\theta - q^2-b^2-(a-p)^2}{2|AB| \cdot |BC|}
  \end{align}
  と書ける．

  $\theta$の変化によって$|AB|, |BC|$は変化しないから，
  \begin{align}
    \cos\alpha
     & = (\text{定数})  + \dfrac{bq}{|AB| \cdot |BC|} \cos\theta
  \end{align}
  と書ける．

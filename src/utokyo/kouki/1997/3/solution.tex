...
\begin{multicols}{2}
  ...
  \begin{align}
    P_{N}
     & = m \left( \frac{2}{N} \right)^2 + (N-2m) \left( \frac{1}{N} \right)^2 \\
     & = \frac{N+2m}{N^2} \label{1997-3:eq:2}
  \end{align}
  ...
  \begin{align}
    P_{10001} - P_{10000}
     & = \frac{(l+1)+2}{(l+1)^2} - \frac{1}{l}                  \\
     & = \frac{\ell-1}{(\ell+1)^2 \ell} > 0 \label{1997-3:eq:3}
  \end{align}
  だから，
  \begin{align*}
    P_{10001} > P_{10000}
  ...
  \begin{align*}
    P_{10001} - P_{10000}
     & = \frac{9999}{(10000+1)^2 \cdot 10^4} \\
     & = \frac{9999}{(10^4+1)^2 \cdot 10^4}  \\
  ...
  \begin{align}
    P_{20000}
     & = \frac{2}{20000}                                       \\
     & = \frac{1}{10^4} \quad (=P_{10000}) \label{1997-3:eq:4}
  \end{align}
  である．
  ...
  一階微分は
  \begin{align*}
    f'(x) & = \frac{3(10^4+x)^2 - (10^4+3x) \cdot 2(10^4+x)}{(10^4+x)^4} \\
          & = \frac{-3x+10^4}{(10^4+x)^3}
  \end{align*}
  ...
  \begin{align*}
    P_{19999} - P_{10000}                   \\
     & =\frac{4l-3}{(2l-1)^2} - \frac{1}{l} \\
     & = \frac{(4l-3)l-(2l-1)^2}{l(2l-1)^2} \\
     & = \frac{l-1}{l(2l-1)^2}
     & >0
  \end{align*}
  ...
  \begin{align}
    P_{N}
     & = m \left( \frac{a+1}{N} \right)^2 + \frac{N-(a+1)m}{a} \left( \frac{a}{N} \right)^2 \\
     & = \frac{m(a+1)^2+(N-(a+1)m)a}{N^2}                                                   \\
     & = \frac{ma + m + Na }{N^2}
  \end{align}
  となる．
  ...
  \begin{align*}
    P_{N}
     & = \frac{ma + m + (al+m)a }{(al+m)^2}       \\
     & = \frac{la^2 + 2ma + m }{(al+m)^2}         \\
     & = \frac{(al+m)^2/l + m - m^2/l}{(al+m)^2}  \\
     & = \frac{1}{l} + \frac{ m(1-m/l)}{(al+m)^2} \\
  \end{align*}
  を得る．

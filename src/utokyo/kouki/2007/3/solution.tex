...
\begin{oframed}
  \input{../../../problems/2007/3/problem.tex}
\end{oframed}
...
\begin{multicols}{2}
  ...
  \begin{align*}
    k_{m+1}
     & = \left( x_i \le \frac{p_{2m}+q_{2tm}}{2} \text{をみたす} x_i \text{の個数} \right)
  \end{align*}
  だが，仮定より
  \begin{align*}
    x_1 \le p_{2m} < \frac{p_{2m}+q_{2m}}{2} < q_{2m} \le x_N \\
    \therefore
  ...
  \begin{align*}
     & \frac{k_m x_1}{k_m} \le p_{m+1} \le \frac{k_m x_{k_m}}{k_m}
    \le \frac{N-k_m}{N-k_m}x_{k_{m+1}} \le q_{m+1} \le \frac{N-k_m}{N-k_m}x_N \\
    \therefore
  ...
  従って$k_n$の定義より，
  \begin{align*}
    k_n & = \left( x_i \le \frac{p_{n-1}+q_{n-1}}{2} \text{をみたす} x_i \text{の個数} \right) \\
        & = \left( x_i \le \frac{p_{n-3}+q_{n-3}}{2} \text{をみたす} x_i \text{の個数} \right) \\
        & = k_{n-1}
  \end{align*}

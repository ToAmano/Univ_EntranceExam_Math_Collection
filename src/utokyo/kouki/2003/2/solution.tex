...
\begin{multicols}{2}
  ...
  \begin{align}
    L=\dfrac{\left|X\sqrt{p}-Y\right|}{\sqrt{p+1}}\label{2003-2:eq:4}
  \end{align}
  である．
  ...
  \begin{align}
    L
     & =\dfrac{\left|A'_{l}\sqrt{p}-B'_{l}\right|}{\sqrt{p+1}}                             \\
     & =\dfrac{\left|(-1)^{l+1}A_{l}\sqrt{p}-(-1)^{l}B_{l}\right|}{\sqrt{p+1}}             \\
     & =\dfrac{\left|A_{l}\sqrt{p}+B_{l}\right|}{\sqrt{p+1}}                               \\
     & =\dfrac{\left|\left(\sqrt{p} - \left[\sqrt{p}\right]\right)^{l}\right|}{\sqrt{p+1}} \\
  \end{align}
  ...
  (2)より，十分大きな$l_1$を取れば
  \begin{align}
    |R_{l_1}Q_{l_1}| = |B'_{l_1}-\sqrt{p} p A'_{l_1}| \le \dfrac{1}{2M} \label{2003-2:eq:6}
  \end{align}
  ...
  \begin{align}
    |P_{l}R_{l}|
     ...
     & = |\dfrac{q}{\sqrt{p \left(A'_{l}\right)^{2}+q} + \sqrt{p} A'_{l}}|
  \end{align}
  について，(2)より$A'_{l}$が単調増加で発散するから，$|P_{l}R_{l}|$は単調に減少し$0$に収束する．
  従って十分大きい$l_2$を取れば
  \begin{align}
    |P_{l_2}R_{l_2}| \le \dfrac{1}{2M} \label{2003-2:eq:7}
  \end{align}
  とできる．

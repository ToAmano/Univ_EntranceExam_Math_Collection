...
この平面での$v$の面積$S(\theta)$として，
     \begin{align}
     S(\theta)=\dfrac{1}{2}(c-s)c-\dfrac{1}{2}\left(\dfrac{\pi}{4}-\theta\right)
     \end{align}
であるから，
     \begin{align}
     v&=\int_0^{\sqrt{2}/2}S(\theta)ds \\
     &=\int_0^{\pi/4}S(\theta)\dfrac{ds}{d\theta}d\theta \\
     &=\dfrac{1}{2}\int_0^{\pi/4}\left\{(c-s)c^2-c\left(\dfrac{\pi}{4}-\theta\right)\right\}d\theta
     \end{align}
各項計算して，
     \begin{align}
     ...
     &\int_0^{\pi/4}c\theta d\theta=[s\theta+c]_0^{\pi/4}=\dfrac{\sqrt{2}\pi}{8}+\dfrac{\sqrt{2}}{2}-1 
     \end{align}
であるから，代入して，
     \begin{align}
     v&=\dfrac{1}{2}\left[\dfrac{5\sqrt{2}}{12}-\dfrac{1}{3}\left(1-\dfrac{\sqrt{2}}{4}\right)-\dfrac{\sqrt{2}\pi}{8}+\dfrac{\sqrt{2}\pi}{8}+%
     \dfrac{\sqrt{2}}{2}-1 \right]    \\

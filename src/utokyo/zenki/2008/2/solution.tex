...
\begin{align}
  ...
  \begin{cases}
    0 & (n \text{ odd}) \\
    \dfrac{1}{4}\left(\dfrac{3}{4}\right)^{\frac{n}{2}-1} & (n \text{ even})
  \end{cases}
  \hfill \text{\#}
\end{align}
...
\begin{figure}[htb]
  ...
  \end{tikzpicture}
  \caption{$2k$回目の操作から$2k+2$回目の操作への遷移図}
\end{figure}
...
\begin{align}
  ...
  \begin{cases}
    0 & (n \in \text{even}, n=1) \\
    \dfrac{1}{18}\left(\dfrac{17}{18}\right)^{\frac{n-3}{2}} & (n \in \text{odd} \ge 3)
  \end{cases}
  \hfill \text{\#}
\end{align}
...
\begin{figure}[htb]
  ...
  \end{tikzpicture}
  \caption{$2k+1$回目の操作から$2k+3$回目の操作への遷移図}
\end{figure}

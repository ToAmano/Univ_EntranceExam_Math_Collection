...
である。右上図から、
\[
\overline{PJ}^2 = \left(\dfrac{1}{2}t\right)^2 + \left\{ \dfrac{\sqrt{3}}{2}(2-t) \right\}^2 = \dfrac{1}{12}(4t^2 - 4t + 4) = \dfrac{1}{3}(t^2 - t + 1)
\]
だから、①に代入して
\[
S(t) = \dfrac{\pi}{3}(t^2 - t + 1)
\]
である。$\overline{G_1 G_2} = \dfrac{\sqrt{6}}{3}$ だから求める体積 $V$ は
\begin{align}
...
\[
\overline{OG_1}^2 = \left(\dfrac{\sqrt{2}}{2}\right)^2 - \left(\dfrac{\sqrt{3}}{3}\right)^2 = \dfrac{1}{6}
\]
だから、
\[
\overline{G_1 G_2} = 2\sqrt{\dfrac{1}{6}} = \dfrac{\sqrt{6}}{3} \quad \cdots \text{①}
\]
である。[解1]と同様にして、切断面は右図。
余弦定理から、
\begin{align}
\overline{PH}^2 &= \left(\dfrac{\sqrt{3}}{3}\right)^2 + \left(\dfrac{\sqrt{3}}{3}t\right)^2 - 2 \cdot \dfrac{\sqrt{3}}{3} \cdot \dfrac{\sqrt{3}}{3}t \cos 60^\circ \\
&= \dfrac{1}{3}(t^2 - t + 1)
\end{align}
(以下略)

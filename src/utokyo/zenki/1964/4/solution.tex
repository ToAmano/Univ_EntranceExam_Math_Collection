...
である．これからまず
     \begin{align}
     &a_1=\dfrac{a_4}{2}=\dfrac{a_3+2}{4}=\dfrac{a_2+5}{8}=\dfrac{a_1+10}{16} \\\Longleftrightarrow 
     &a_1=\dfrac{2}{3}     
     \end{align}
となり，順に$(a_2,a_3,a_4)=(1/3,2/3,4/3)$である．次に同様に
     \begin{align}
     &b_1=\dfrac{b_4+2}{2}=\dfrac{b_3+6}{4}=\dfrac{b_2+12}{8}=\dfrac{b_1+24}{16}\\ \Longleftrightarrow
     &b_1=\dfrac{8}{5}
     \end{align}
であるから，$(b_2,b_3,b_4)=(4/5,2/5,6/5)$が従う．以上から
     \begin{align}
     P_1\left(\dfrac{2}{3},\dfrac{8}{5}\right) , P_2\left(\dfrac{1}{3},\dfrac{4}{5}\right) ,
     P_3\left(\dfrac{2}{3},\dfrac{2}{5}\right) , P_4\left(\dfrac{4}{3},\dfrac{6}{5}\right)
     \end{align}
 である．$\cdots$(答)
 
 従って四辺形$P_1P_2P_3P_4$の面積は
      \begin{align}
      S=\dfrac{8-2}{5}\dfrac{4-1}{3}\dfrac{1}{2}=\dfrac{3}{5}
      \end{align}
      である．
 $\cdots$(答)
\newpage

...
\noindent
{\bf [解]} $l$ が $x$ 軸に一致し，$P(0, \sqrt{3}+1)$ となるよう $xy$ 平面をおく．
...
\end{tikzpicture}
\caption{点 $P,Q,R,S$ の配置と与えられた辺の長さ}
\end{figure}
...
&= 16 \Bigl[ \theta + \dfrac{1}{2} \sin 2\theta \Bigr]_{\pi/6}^{\pi/3} \\
&= \dfrac{8}{3}\pi
\end{align}
...
\begin{tikzpicture}[scale=0.7, >=stealth]
  ...
  \end{scope}
\end{tikzpicture}
\caption{面積 $S_1$，$S_2$ を求めるための扇形の図}
\end{figure}

\begin{align}
S_2 &= (\text{扇形}) - (\text{三角形}) \\
&= \dfrac{1}{2} \cdot \dfrac{\pi}{2} \cdot (2\sqrt{2})^2 - \dfrac{1}{2} \cdot 2 \cdot 2 \cdot 2 \\
&= 2\pi - 4
\end{align}
(1)に代入して
\begin{align}

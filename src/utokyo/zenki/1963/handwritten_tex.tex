...
なので、(2)より
\[
  \begin{cases} 0 \le x \le 1 \text{ の時 } g_n(x) \ge 0 \\ 1 \le x \le 2 \text{ の時 } g_n(x) \le 0
  \end{cases}
\]
である。したがって、
\[
...
\[
  \begin{cases} n=3 \text{ の時、(左辺)} = \left(\frac{1}{4}-\frac{1}{6}\right) 2^4 = \frac{4}{3} \\ n=4 \text{ の時、(左辺)} = \left(\frac{1}{5}-\frac{1}{6}\right) 2^5 = \frac{16}{15}
  \end{cases}
\]

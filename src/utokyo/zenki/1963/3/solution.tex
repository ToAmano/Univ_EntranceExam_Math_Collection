...
&= \left( \dfrac{1}{a+bn} - \dfrac{1}{a+b(n+1)} \right) \dfrac{a^2 H}{2}
\end{align}
となり、
\[
\sum_{k=1}^n F_k = \dfrac{a^2 H}{2} \left( \dfrac{1}{a+b} - \dfrac{1}{a+b(n+1)} \right) \xrightarrow{n \to \infty} \dfrac{H a^2}{2(a+b)}
\]

...
$|AP|=x \ (0<x<a)$とおく．すると相似から
     \begin{align}
     |PP'|&=\dfrac{a-x}{a}|AH|=\dfrac{\sqrt{6}}{3}(a-x) \\
     |PQ|&=x
     \end{align}
...
体積$V(x)$は
     \begin{align}
     V(x)&=(\triangle PQR)|PP'| \\
     &=\dfrac{\sqrt{6}}{3}(a-x)S \\
     &=\dfrac{\sqrt{2}}{4}x^2(a-x)
     \end{align}
となる．$x,a-x>0$からAM-GMより
     \begin{align}
     V(x)&=\sqrt{2}\left(\dfrac{x}{2}\right)^2(a-x) \nonumber\\
     &\le\sqrt{2}\left(\dfrac{a}{3}\right)^3\label{2}
     \end{align}
...
だから，
     \begin{align}
     \dfrac{V_0}{V}=\dfrac{\dfrac{\sqrt{2}}{27}a^3}{\dfrac{\sqrt{2}}{12}a^3}=\dfrac{4}{9}
     \end{align}
である．$\cdots$(答)
\end{enumerate}
\newpage

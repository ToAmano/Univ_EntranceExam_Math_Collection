...
\]
\[
= 2p(p-1) + \left[ \dfrac{2}{1-r^2}p - \dfrac{1}{1-r^2} - 2p^2 \right] = \dfrac{2r^2}{1-r^2}p - \dfrac{1}{1-r^2} \quad \cdots \text{③}
\]
ここで, ②から
\[
p = \dfrac{1}{2(1-r^2)}\left[ 1 \pm \sqrt{1 - 2(1-r^2)\left\{(1-r^2)q^2+1\right\}} \right] = \dfrac{1}{2(1-r^2)}\left[ 1 \pm \sqrt{2r^2-1 - 2(1-r^2)^2 q^2} \right]
\]
...
\[
M(r) - m(r) = \dfrac{2r^2}{1-r^2}(a-b) = \dfrac{2r^2 \cdot 2}{2(1-r^2)^2} \sqrt{2r^2-1}
\]
だから
\[

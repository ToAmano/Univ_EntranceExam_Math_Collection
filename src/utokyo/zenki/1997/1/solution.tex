...
&= \dfrac{1}{2} \begin{pmatrix} a \\ b \end{pmatrix} \pm \dfrac{\sqrt{3}}{2} \begin{pmatrix} b \\ a \end{pmatrix} \\
&= \dfrac{1}{2} \begin{pmatrix} a \pm \sqrt{3}b \\ b \pm \sqrt{3}a \end{pmatrix} \quad (\text{複号同順})
\end{align}
...
\end{scope}
\end{tikzpicture}
\caption{三角形$ABC$の作図と条件を満たす$(a,b)$の存在領域}
\end{figure}

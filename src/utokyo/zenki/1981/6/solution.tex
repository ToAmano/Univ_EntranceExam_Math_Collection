...
\[
\begin{cases}
0 \le \dfrac{\alpha-1}{2} \le 1 \text{ の時}, D \le 0 \iff a^2(1-\alpha)^2 - 4a(1-a\alpha) \le 0 \iff a \left[ a(\alpha+1)^2 - 4 \right] \le 0 \dots \star_1 \\
...
\[
\begin{cases}
-1 \le \dfrac{\alpha+1}{2} \le 0 \text{ の時}, D' \le 0 \iff a^2(\alpha+1)^2 - 4a(a\alpha-1) \ge 0 \iff a \left[ a(\alpha-1)^2 + 4 \right] \ge 0 \dots \star_2 \\
...
\]
\[
= 2 \left[ \dfrac{4}{5} a^2 + \dfrac{1}{3}(2b-1)^2 \right] \equiv A \quad \dots \text{⑤}
\]
ここで, $(a, b)$ は領域をうごくから,
\[
\begin{cases}
...
\begin{tikzpicture}[scale=1.5]
  ...
  \draw[dashed] (-1.5,-0.5) -- (1.5,-0.5) node[right] {$b = -\dfrac{1}{2}$};
  \draw[dashed] (0.5,-0.5) -- (1.5,-1.5) node[right] {$b = -a - \dfrac{1}{2}$};
  ...
  % Key points
  \draw[dashed] (0.5,0) node[above] {$\dfrac{1}{2}$} -- (0.5,-0.5);
  \draw[dashed] (-0.5,0) node[above] {$-\dfrac{1}{2}$} -- (-0.5,-0.5);

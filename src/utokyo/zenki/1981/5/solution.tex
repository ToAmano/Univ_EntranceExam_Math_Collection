...
{\bf [解]}
\paragraph{(1)}
図のような展開図での頂点を $A_1, A_2, \dots, A_n$ とする．
...
さて，展開図が円に内接するとき
\begin{align}
A_1 O = -x + y = 1 \iff y = 1 - x \quad \Bigl(0 < x < \dfrac{1}{2}\Bigr)
\end{align}
である．立体の高さとして
\begin{align}
...
\begin{align}
V = V_n &= \dfrac{1}{3} n \tan\dfrac{\pi}{n} \cdot \Bigl(\dfrac{2}{5}\Bigr)^2 \sqrt{\dfrac{1}{5}} \\
&= \dfrac{4\sqrt{5}}{375} n \tan\dfrac{\pi}{n}
\end{align}

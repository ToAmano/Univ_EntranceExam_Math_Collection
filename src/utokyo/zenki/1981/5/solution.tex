...
$B_k B_{k+1} = 2x \tan \dfrac{\pi}{n}$

さて, 展開図が円に内接するとき
\[
A_1 O = -x + y = 1 \iff y = 1 - x \quad \left(0 < x < \dfrac{1}{2}\right)
\]
である。立体の高さとして
\[
...
又, 底面積 $S$ は
\[
S = n \times (\triangle O B_1 B_2) = n \times \dfrac{1}{2} \cdot x \cdot \left(2x \tan\dfrac{\pi}{n}\right) = n x^2 \tan\dfrac{\pi}{n}
\]
だから体積 $V$ は
\[
V = \dfrac{1}{3} S \cdot h = \dfrac{1}{3} n \tan\dfrac{\pi}{n} \, x^2 \sqrt{1 - 2x}
\]
...
\[
V = V_n = \dfrac{1}{3} n \tan\dfrac{\pi}{n} \cdot \left(\dfrac{2}{5}\right)^2 \sqrt{\dfrac{1}{5}} = \dfrac{4\sqrt{5}}{375} n \tan\dfrac{\pi}{n}
\]

(2) $t = \dfrac{\pi}{n}$ とおくと $n \to \infty$ で $t \to 0$ で
\[
V_n = \dfrac{4\sqrt{5}}{375} \pi \dfrac{\tan t}{t} \longrightarrow \dfrac{4\sqrt{5}}{375} \pi \quad (n \to \infty, t \to 0)
\]

...
{\bf [解]} 正六角形の一辺の長さは $1$ であり，三角形ができる時，その面積は
\begin{enumerate}
  \item[$1^\circ$] $A_1 A_2 A_6$ 形 $\dots \dfrac{\sqrt{3}}{4}$
  \item[$2^\circ$] $A_1 A_2 A_5$ 形 $\dots \dfrac{\sqrt{3}}{2}$
  \item[$3^\circ$] $A_1 A_3 A_5$ 形 $\dots \dfrac{3}{4}\sqrt{3}$
\end{enumerate}
...
\begin{align}
E &= \dfrac{6}{36} \cdot \dfrac{\sqrt{3}}{4} + \dfrac{12}{36} \cdot \dfrac{\sqrt{3}}{2} + \dfrac{2}{36} \cdot \dfrac{3}{4}\sqrt{3} \\
&= \dfrac{\sqrt{3}}{36} \Bigl( \dfrac{3}{2} + 6 + \dfrac{3}{2} \Bigr) \\
&= \dfrac{\sqrt{3}}{4}
\end{align}
...
\begin{tikzpicture}[scale=1.5]
  ...
  \node[left] at (A5) {$A_5$};
\end{tikzpicture}
\caption{正六角形 $A_1 \dots A_6$ と対角線}
\end{figure}

...
{\bf [解]} $f_k(x) = x^k - 1 - k(x-1)$ とおくと，任意の $n$ 次多項式 $g(x)$ は，
\begin{align}
...
\begin{align}
  \begin{cases} a_1 + a_0 = 0 \\ a_1 = 0
  \end{cases} \iff a_1 = a_0 = 0
\end{align}
より，この時，
\begin{align}
...
この時，
\begin{align}
  \begin{cases} a_1 = a_0 = 0 \\ \sum_{k=2}^n k(k-1) a_k = 0
  \end{cases}
\end{align}
だから，たしかに $g(x) = \sum_{k=2}^n a_k f_k(x)$ ($\sum_{k=2}^n \dfrac{k(k-1)}{2} a_k = 0$) を書けることが必要．逆に，このように書ける時，同様にして十分である．
以上から示された．

\bigskip\noindent{\bf [解2]} (1) 十分性について．
\begin{align}
...
\begin{align}
  \sum_{k=2}^n a_k f_k(x) = \sum_{k=2}^n a_k \Bigl[ \sum_{i=2}^k {}_k\mathrm{C}_i (x-1)^i \Bigr]
\end{align}

...
$V>0$から$x'\not=0$だから
     \begin{align}
     &x''(1+c^2)-x'^2cs=0 \\
     &x''=\dfrac{x'^2cs}{1+c^2}\atag\label{2}
     \end{align}
さらに，
     \begin{align}
...
だから，加速度ベクトルの大きさ$L$として
     ...
     &=\left(\dfrac{x'^2cs}{1+c^2}\right)^2(1+c^2)-2x'^2cs\dfrac{x'^2cs}{1+c^2}+x'^4s^2 \\
     &\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad%
     \quad\quad\quad\quad\quad(\because\eqref{2}) \\
     &=\dfrac{-x'^4c^2s^2}{1+c^2}+x'^4s^2 \\
     &=\left(\dfrac{x'^4s^2}{1+c^2}\right) \\
     &=\dfrac{s^2}{1+c^2}\dfrac{V^4}{(1+c^2)^2} \quad\quad(\because\eqref{1})\\
     &=\dfrac{1-c^2}{(1+c^2)^3}V^4
     \end{align}

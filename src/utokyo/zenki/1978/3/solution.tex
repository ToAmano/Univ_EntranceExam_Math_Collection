...
\eqref{1}の左辺$g(t)$とおく．$g'(t)=27t^2-6y$より，$y$の値によって以下のようになる．\\
     ...
     であるから，\eqref{2}に代入して
          \begin{align}
          \left(\dfrac{2\sqrt{2}}{3}y^{3/2}-x\right)\left(-\dfrac{2\sqrt{2}}{3}y^{3/2}-x\right)>0\label{3}
          \end{align}
     \end{indentation}
...
さて，$x>0$のとき
     ...
     \therefore \,&y=\dfrac{\sqrt[3]{9}}{2}x^{2/3}
     \end{align}
に注意して
     \begin{align}
     S_1&=\int_0^\b \left(f(x)-\dfrac{\sqrt[3]{9}}{2}x^{2/3}\right)\,dx \\
     &=\teisekibun{\dfrac{1}{2}x^3-\dfrac{1}{3}x}{0}{\b}-\dfrac{\sqrt[3]{9}}{2}\teisekibun{\dfrac{3}{5}x^{5/3}}{0}{\b} \\
     &=\dfrac{44\sqrt{2}}{135}
     \end{align}
であるから，\eqref{4}に代入して

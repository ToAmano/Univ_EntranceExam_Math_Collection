...
\[
A\left(\dfrac{t}{2}, 0\right), \quad B(0, -t^2)
\]
となる。したがって、
\[
\begin{cases}
g(t) = \dfrac{1}{2}\left(1 - \dfrac{t}{2}\right) t^2 = \dfrac{1}{4}(2-t)t^2 \\[1ex]
...
増減を調べる：
\[
g'(t) = \dfrac{1}{4}(4t - 3t^2) = \dfrac{1}{4}t(4-3t) > 0 \quad \left(0 < t < 1\right)
\]
\[
...
\begin{tikzpicture}[scale=3]
    ...
    \draw[dashed] ({ (3-sqrt(3))/3 }, 0) node[below] {$\dfrac{3-\sqrt{3}}{3}$} -- ({ (3-sqrt(3))/3 }, {sqrt(3)/9}) -- (0, {sqrt(3)/9}) node[left] {$\dfrac{\sqrt{3}}{9}$};
    \draw[dashed] (0.6667, 0) node[below] {$2/3$} -- (0.6667, 4/27) -- (0, 4/27) node[left] {$\dfrac{4}{27}$};
    \draw[dashed] (1, 0) node[below] {$1$} -- (1, 0.25) -- (0, 0.25) node[left] {$\dfrac{1}{4}$};
\end{tikzpicture}
\end{center}

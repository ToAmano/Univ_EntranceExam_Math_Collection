...
\[
1 = r + \dfrac{r}{\sin \dfrac{\pi}{3}} = \left( \dfrac{2}{\sqrt{3}} + 1 \right) r = \left( \dfrac{2}{3}\sqrt{3} + 1 \right) r
\]
\[
...
だから，代入して
\begin{align}
S &= \dfrac{\pi}{3} + \dfrac{1}{2}\pi r^2 - \dfrac{1}{3}(1-r)^2\pi - \left\{ \dfrac{\sqrt{3}}{2}(r-r^2) - \dfrac{1}{6}\pi r^2 \right\} \\
&= \pi \left\{ \dfrac{1}{3} + \dfrac{1}{2}r^2 - \dfrac{1}{3}(1-r)^2 + \dfrac{1}{6}r^2 \right\} - \dfrac{\sqrt{3}}{2}(r-r^2) \\
&= \dfrac{\pi}{6} \left[ 2r^2 + 4r \right] - \dfrac{\sqrt{3}}{2} r (1-r)
\end{align}

ここで，①より $r^2 = (-3+2\sqrt{3})^2 = 21 - 12\sqrt{3}$ だから
\begin{align}
S &= \dfrac{\pi}{3} \left\{ (21 - 12\sqrt{3}) + 2(-3 + 2\sqrt{3}) \right\} - \dfrac{\sqrt{3}}{2} \left\{ (-3 + 2\sqrt{3}) - (21 - 12\sqrt{3}) \right\} \\
&= \dfrac{\pi}{3} \left[ 15 - 8\sqrt{3} \right] - \dfrac{\sqrt{3}}{2} \left( -24 + 14\sqrt{3} \right) \\
&= (15 - 8\sqrt{3})\dfrac{\pi}{3} - 21 + 12\sqrt{3} \\
&= (5\pi - 21) + \left( 12 - \dfrac{8}{3}\pi \right)\sqrt{3}
\end{align}

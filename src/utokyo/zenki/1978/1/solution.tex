...
\end{tikzpicture}
\caption{六角形 $A_1 \dots A_6$ と円 $P$，および補助点 $C,Q$}
\end{figure}
...
\begin{align}
1 &= r + \dfrac{r}{\sin \dfrac{\pi}{3}} = \Bigl( \dfrac{2}{\sqrt{3}} + 1 \Bigr) r \\
&= \Bigl( \dfrac{2}{3}\sqrt{3} + 1 \Bigr) r
\end{align}
\begin{align}
...
\end{tikzpicture}
\caption{面積 $S$ を扇形・半円・平行四辺形の和差に分解した図}
\end{figure}

各部分の面積は：
\begin{itemize}
    \item 扇形 $OA_1A_3$: $\dfrac{1}{2} \cdot \dfrac{2}{3}\pi = \dfrac{\pi}{3}$
    \item 半円領域 $D$: $\dfrac{1}{2}\pi r^2$
    \item 扇形 $Q C A_3$: $\dfrac{1}{2} \cdot \dfrac{2}{3}\pi (1-r)^2 = \dfrac{1}{3}\pi (1-r)^2$
    \item 平行四辺形 $OPCQ$ から扇形を除いた部分:
    \begin{align}
    (1-r) \cdot r \cdot \sin \dfrac{\pi}{3} - \dfrac{1}{6}\pi r^2 = \dfrac{\sqrt{3}}{2}(r - r^2) - \dfrac{1}{6}\pi r^2
    \end{align}
\end{itemize}

だから，代入して
\begin{align}
S &= \dfrac{\pi}{3} + \dfrac{1}{2}\pi r^2 - \dfrac{1}{3}(1-r)^2\pi - \Bigl\{ \dfrac{\sqrt{3}}{2}(r-r^2) - \dfrac{1}{6}\pi r^2 \Bigr\} \\
&= \pi \Bigl\{ \dfrac{1}{3} + \dfrac{1}{2}r^2 - \dfrac{1}{3}(1-r)^2 + \dfrac{1}{6}r^2 \Bigr\} - \dfrac{\sqrt{3}}{2}(r-r^2) \\
&= \dfrac{\pi}{6} \Bigl[ 2r^2 + 4r \Bigr] - \dfrac{\sqrt{3}}{2} r (1-r)
\end{align}

ここで，①より $r^2 = (-3+2\sqrt{3})^2 = 21 - 12\sqrt{3}$ だから
\begin{align}
S &= \dfrac{\pi}{3} \Bigl\{ (21 - 12\sqrt{3}) + 2(-3 + 2\sqrt{3}) \Bigr\} - \dfrac{\sqrt{3}}{2} \Bigl\{ (-3 + 2\sqrt{3}) - (21 - 12\sqrt{3}) \Bigr\} \\
&= \dfrac{\pi}{3} \Bigl[ 15 - 8\sqrt{3} \Bigr] - \dfrac{\sqrt{3}}{2} \Bigl( -24 + 14\sqrt{3} \Bigr) \\
&= (15 - 8\sqrt{3})\dfrac{\pi}{3} - 21 + 12\sqrt{3} \\
&= (5\pi - 21) + \Bigl( 12 - \dfrac{8}{3}\pi \Bigr)\sqrt{3}
\end{align}

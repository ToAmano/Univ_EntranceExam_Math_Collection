...
であるから，(1)より，
\begin{align}
I&=\int_{-\sqrt{3}}^{\sqrt{3}}\sqrt{-t^2+3}\,(t^2-t+1)\,dt \\
&=2\int_0^{\sqrt{3}}\sqrt{-t^2+3}\,(t^2+1)\,dt\quad\cdots③
\end{align}
...
&=\dfrac{9}{4}\cdot\dfrac{1}{2}\left[\theta-\dfrac{1}{4}\sin4\theta\right]_0^{\pi/2} \\
&=\dfrac{9}{16}\pi
\end{align}

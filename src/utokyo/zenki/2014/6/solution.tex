...
\begin{align}
  f(-1)=\dfrac{\sqrt{3}}{3}(x+4),\qquad f(-2)=\dfrac{\sqrt{3}}{3}(-x+4), \\
  \qquad f\left(\dfrac{x-3}{2}\right)=\dfrac{2\sqrt{3}}{3}\cdot\dfrac{x^2+9}{4} \\
  \qquad =\dfrac{\sqrt{3}}{6}(x^2+9)
\end{align}
...
\begin{align}
  f(x-3)&=\dfrac{\sqrt{3}}{3}\left(-2(x-3)^2+(2x-6)(x-3)+3x\right) \\
  &=\dfrac{\sqrt{3}}{3}\left(-2(x-3)^2+2(x-3)^2+3x\right) \\
  &=\sqrt{3}x
\end{align}

...
[解] 空間座標を設定し, $T$ の4頂点を
\[
A(0,0,0), \quad B\left(0, \dfrac{1}{\sqrt{2}}, \dfrac{1}{\sqrt{2}}\right), \quad C\left(\dfrac{1}{\sqrt{2}}, 0, \dfrac{1}{\sqrt{2}}\right), \quad D\left(\dfrac{1}{\sqrt{2}}, \dfrac{1}{\sqrt{2}}, 0\right)
\]
...
\[
\cos\theta_1 = \dfrac{a_1-a_2-a_3}{\sqrt{3}}, \quad \cos\theta_2 = \dfrac{-a_1+a_2-a_3}{\sqrt{3}}, \quad \cos\theta_3 = \dfrac{-a_1-a_2+a_3}{\sqrt{3}}, \quad \cos\theta_4 = \dfrac{a_1+a_2+a_3}{\sqrt{3}}
\]
だから, 求める面積 $S$ として, $T$ の一面の面積 $S_0$ から,
\begin{align}
2S &= \dfrac{\sqrt{3}}{4} \sum_{k=1}^4 |\cos\theta_k| \\
&= \dfrac{1}{4} \left[ |a_1+a_2-a_3| + |a_1-a_2+a_3| + |-a_1+a_2+a_3| + |a_1+a_2+a_3| \right] \quad \dots \text{②}
\end{align}

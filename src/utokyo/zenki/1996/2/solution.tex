...
このもとで，\eqref{1}を変形して
     \begin{align}
     s>\dfrac{b}{1-a}t\label{3}
     \end{align}
また，$c>0$だから，\eqref{2}を変形して
     \begin{align}
     s<\dfrac{1-d}{c}t\label{4}
     \end{align}
である．ここで，$s>0$だから，
     \begin{align}
     1-d>0 \nonumber\\
...
以上から
      ...
      \Longleftrightarrow&\exists t_{>0}，\dfrac{b}{1-a}t<\dfrac{1-d}{c}t \land\eqref{5} \\
     \Longleftrightarrow& \dfrac{b}{1-a}<\dfrac{1-d}{c} \land\eqref{5} \\

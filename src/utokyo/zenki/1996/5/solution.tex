...
{\bf [解]} 題意より，容器の $0 \le z \le f(t)$ の部分の体積が，回転体の先端からの長さ $t + f(t)$ までの部分の体積に等しいので，
\begin{align}
...
\begin{align}
R^2 z &= (z+1) r(z)^2 \\
r(z) &= \pm R \sqrt{\dfrac{z}{z+1}}
\end{align}
このうち，$0 \le r(z) < R$ をみたす複号正を採用して
\begin{align}
r(z) &= R \sqrt{\dfrac{z}{z+1}} \quad (r(0)=0 \text{をみたす})
\end{align}

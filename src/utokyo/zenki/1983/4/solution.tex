...
\begin{tikzpicture}[scale=0.8]
    ...
    \draw[<->] (-0.8, 0.64) -- (-0.8, 2.24) node[midway, left] {$\dfrac{t}{2}$};
...
\begin{tikzpicture}[scale=0.8]
    ...
    \fill (0,1.44) circle (2pt) node[right] {$\dfrac{t}{\sqrt{2}}$};
    \node[below left] at (0,0) {$O$};
\end{tikzpicture}
\qquad
\begin{tikzpicture}[scale=0.8]
...
$1^\circ$ の時
\[
f_1(t) = \left(\dfrac{t}{2}\right)^2 + \dfrac{t}{2} = \dfrac{1}{4}t^2 + \dfrac{1}{2}t
\]

$2^\circ$ の時
\[
f_2(t) = \left(\dfrac{t}{\sqrt{2}}\right)^2
\]
であり、この時、一番下の頂点 $(0, f(t) - \dfrac{t}{\sqrt{2}})$ が原点より上にあることが必要で、
\[
f(t) - \dfrac{t}{\sqrt{2}} = \dfrac{t}{2}\cdot t - \dfrac{t}{\sqrt{2}} = \dfrac{t}{\sqrt{2}}\left(\dfrac{t}{\sqrt{2}} - 1\right) \geqq 0 \iff t \geqq \sqrt{2} \quad (\because t > 0)
\]
...
\[
\dfrac{t}{\sqrt{2}} \geqq \left(\dfrac{t}{\sqrt{2}}\right)^2 \iff 0 < t \leqq \sqrt{2}
\]

...
\end{tikzpicture}
\caption{放物線 $y=x^2$ に内接する正方形の3通りの配置}
\end{figure}

{\bf [解]} 中心が $y$ 軸上にないものは，中心が $y$ 軸上にくるよう平行移動することで，より $y$ 座標を小さくできるから，中心が $y$ 軸上にあるもののみ考える．この時，$y$ 座標が最小になるのは，以下のいずれか
...
$1^\circ$ の時
\begin{align}
f_1(t) = \Bigl(\dfrac{t}{2}\Bigr)^2 + \dfrac{t}{2} = \dfrac{1}{4}t^2 + \dfrac{1}{2}t
\end{align}

$2^\circ$ の時
\begin{align}
f_2(t) = \Bigl(\dfrac{t}{\sqrt{2}}\Bigr)^2
\end{align}
であり，この時，一番下の頂点 $(0, f(t) - \dfrac{t}{\sqrt{2}})$ が原点より上にあることが必要で，
\begin{align}
f(t) - \dfrac{t}{\sqrt{2}} &= \dfrac{t}{2}\cdot t - \dfrac{t}{\sqrt{2}} \\
&= \dfrac{t}{\sqrt{2}}\Bigl(\dfrac{t}{\sqrt{2}} - 1\Bigr) \geqq 0 \iff t \geqq \sqrt{2} \quad (\because t > 0)
\end{align}

$3^\circ$ の時，
\begin{align}
f_3(t) = \dfrac{t}{\sqrt{2}}
\end{align}
であり，この時，$3^\circ$ の図の $A$ が $y=x^2$ に含まれていることが必要で，
\begin{align}
\dfrac{t}{\sqrt{2}} \geqq \Bigl(\dfrac{t}{\sqrt{2}}\Bigr)^2 \iff 0 < t \leqq \sqrt{2}
\end{align}
...
\end{tikzpicture}
\caption{$f_1(t), f_2(t), f_3(t)$ の下側包絡線として定まる $f(t)$ のグラフ}
\end{figure}

よって求める関数は
\begin{align}
f(t) = \begin{cases}
\dfrac{t}{\sqrt{2}} & (2(\sqrt{2}-1) \leqq t \leqq \sqrt{2}) \\
\dfrac{1}{2} t^2 & (\sqrt{2} \leqq t \leqq 2) \\
\dfrac{1}{4} t^2 + \dfrac{1}{2} t & (0 < t \leqq 2(\sqrt{2}-1), \ 2 \leqq t)
\end{cases}
\quad \text{/\!\!/}
\end{align}
である

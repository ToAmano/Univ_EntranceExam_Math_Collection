...
\noindent
(2) $Y_n = \dfrac{X_n}{2^n}$ によって $\{Y_n\}$ を定める。\textcircled{1}の両辺を $2^{n+1}$ でわって
\[
...
\[
P(t_k = 1) = \dfrac{1}{2} + \dfrac{1}{2^k} \cdot \dfrac{1}{3} ( 2^{k-1} - (-1)^{k-1} ) = \dfrac{2}{3} + \dfrac{1}{3} \left(-\dfrac{1}{2}\right)^k
\]
...
\]
\[
= \dfrac{2}{3}n - \dfrac{1}{6} \cdot \dfrac{1 - (-1/2)^n}{1 + 1/2} = \dfrac{2}{3}n - \dfrac{1}{9}\left\{ 1 - \left(-\dfrac{1}{2}\right)^n \right\} \hfill \text{\slash\slash}
\]

...
\[
b_1 = 1-i, \quad b_2 = \dfrac{1+2i}{1+i} = \dfrac{3+i}{2}, \quad b_3 = \dfrac{2+3i}{1+2i} = \dfrac{8-i}{5}
\]
...
\begin{tikzpicture}[scale=1.5, >=stealth]
  ...
  \fill (0.5, 0) circle (1.5pt) node[below] {$\dfrac{1}{2}$};
\end{tikzpicture}
\end{center}
...
\[
b_{k+1} = \dfrac{a_{k+2}}{a_{k+1}} = 1 + \dfrac{a_k}{a_{k+1}} = 1 + \dfrac{1}{b_k} \quad (\because \textcircled{2})
\]
だから、$b_n \neq 1$ である。逆について
\[

...
次に，$ab=\dfrac{t^2-s^2}{4}$であるから，$a$，$b$は$x$の$2$次方程式$x^2-tx+\dfrac{t^2-s^2}{4}=0$の異$2$実解であるから，判別式$D$として
     \begin{align}
     &D>0\\
     \Longleftrightarrow&t^2-4\dfrac{t^2-s^2}{4}>0\\
...
であるから，\eqref{4}を用いて$t$を消去して
     \begin{align}
     Y&=\dfrac{t^2+s^2}{4} \\
     &=\dfrac{1}{4}\left(s^2+\dfrac{l^2}{s^2}-1\right)  \\
     &\ge \dfrac{1}{4}\left(2\sqrt{l^2}-1\right) \tag{$s,l>0$故AM-GM}\\
     &=\dfrac{1}{4}\left(2l-1\right) \tag{$l>0$}
     \end{align}
である．等号成立は
     \[s^2=\dfrac{l^2}{s^2}\Longleftrightarrow s=\sqrt{l},t=\pm\sqrt{l-1}\]

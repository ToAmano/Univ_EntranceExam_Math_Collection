...
である．以上から，
     \begin{align}
     f(x)-x=\dfrac{t^2}{t+1}(x+t)x\left(x-\dfrac{t}{t+1}\right)
     \end{align}
...
従って，
     ...
     &=\int_0^d\left(\dfrac{t^2}{t+1}(x+t)x\left(x-\dfrac{t}{t+1}\right)\right)\,dx \\
     &=\teisekibun{-\dfrac{t+1}{4t^2}x^4-\dfrac{1}{3}x^3+\dfrac{1}{2}x^2}{0}{d} \\
     &=\dfrac{-1}{4}\left(\dfrac{1}{t}+\dfrac{1}{t^2}\right)d^4-\dfrac{1}{3}d^3+\dfrac{1}{2}d^2 \\
     &\limit{t}{\infty}\dfrac{1}{2}-\dfrac{1}{3}=\dfrac{1}{6}
     \end{align}
となる．$\cdots$(答)

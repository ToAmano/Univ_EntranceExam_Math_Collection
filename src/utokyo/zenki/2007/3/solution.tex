...
\end{align}
\begin{align}
  b = \dfrac{1}{3} \Bigl[ 2\alpha^2 + (3a - 2\alpha)^2 \Bigr] = 2\alpha^2 - 4a\alpha + 3a^2 \equiv f(\alpha) \quad \cdots ②
\end{align}
...
\begin{figure}[htb]
  ...
  \end{tikzpicture}
  \caption{点$R(a,\alpha)$の存在範囲を定める$(a,\alpha)$平面上の斜線部}
\end{figure}
...
\begin{figure}[htb]
  ...
  \end{tikzpicture}
  \caption{点$R(a,b)$がとりうる範囲（$(a,b)$平面上の斜線部）}
\end{figure}

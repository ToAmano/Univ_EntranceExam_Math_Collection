...
ここで，
\begin{align}
\dfrac{24}{35} - \dfrac{68}{100} &= \dfrac{1}{5} \left( \dfrac{24}{7} - \dfrac{17}{5} \right) \\
&= \dfrac{1}{5} \cdot \dfrac{1}{35} > 0 \quad \therefore 0.68 < \dfrac{24}{35}
\end{align}
\begin{align}
\dfrac{71}{100} - \dfrac{17}{24} &= \dfrac{1}{600} (426 - 425) \\
&= \dfrac{1}{600} > 0 \quad \therefore 0.71 > \dfrac{17}{24}
\end{align}
だから，① とあわせて
\begin{align}

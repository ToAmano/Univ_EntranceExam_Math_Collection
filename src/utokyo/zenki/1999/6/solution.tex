...
{\bf [解]} 与式左辺を計算する．
\begin{align}
\int_0^\pi e^x \sin^2 x \, dx &= \int_0^\pi e^x \dfrac{1 - \cos 2x}{2} \, dx \\
&= \dfrac{1}{2} [ e^x ]_0^\pi - \dfrac{1}{2} \cdot \dfrac{1}{1+4} [ e^x (\cos 2x + 2\sin 2x) ]_0^\pi \\
&= \dfrac{1}{2} (e^\pi - 1) - \dfrac{1}{10} (e^\pi - 1) \\
&= \dfrac{4}{10} (e^\pi - 1)
\end{align}
だから，
\begin{align}
...
\end{tikzpicture}
\caption{$y=e^x$のグラフと$x=t$における接線}
\end{figure}

...
\[
\stackrel{\frown}{CD} = \dfrac{1}{3} \cdot \dfrac{2\sqrt{6}}{3} \pi = \dfrac{2\sqrt{6}}{9}\pi \quad \cdots \text{②}
\]
...
\begin{tikzpicture}[scale=1.3]
  ...
  \begin{scope}[shift={(5,0)}]
    ...
    \node[below] at (0,1.0) {$\dfrac{2}{3}\pi$};
  \end{scope}
\end{tikzpicture}
\end{center}
...
\[
\dfrac{1}{2}\pi + \dfrac{2\sqrt{6}}{9}\pi = \left(\dfrac{1}{2} + \dfrac{2\sqrt{6}}{9}\right)\pi
\]

...
\[
  \vec{PA} = a
  \begin{pmatrix} 1 \\ 0
  \end{pmatrix}, \quad \vec{PB} = -\frac{b}{2}
  \begin{pmatrix} 1 \\ \sqrt{3}
  \end{pmatrix}, \quad \vec{PC} = \frac{c}{2}
  \begin{pmatrix} -1 \\ \sqrt{3}
  \end{pmatrix}
\]
である。したがって、
\[
  \vec{AB} =
  \begin{pmatrix} -\frac{1}{2}b - a \\ -\frac{\sqrt{3}}{2}b
  \end{pmatrix}, \quad \vec{AC} =
  \begin{pmatrix} -\frac{1}{2}c - a \\ \frac{\sqrt{3}}{2}c
  \end{pmatrix}
\]
...
\begin{align*}
  S(t) &= \left( \frac{1}{6 \cdot 2(1+t)} + \frac{1}{6 \cdot 2(1-t)} \right) \left( 2 \sqrt{2(1-t^2)} \right)^3 \quad (\star_1, \star_2 \text{より}) \\

...
\[
\vec{PA} = a \begin{pmatrix} 1 \\ 0 \end{pmatrix}, \quad \vec{PB} = -\dfrac{b}{2} \begin{pmatrix} 1 \\ \sqrt{3} \end{pmatrix}, \quad \vec{PC} = \dfrac{c}{2} \begin{pmatrix} -1 \\ \sqrt{3} \end{pmatrix}
\]
である．したがって，
\[
\vec{AB} = \begin{pmatrix} -\dfrac{1}{2}b - a \\ -\dfrac{\sqrt{3}}{2}b \end{pmatrix}, \quad \vec{AC} = \begin{pmatrix} -\dfrac{1}{2}c - a \\ \dfrac{\sqrt{3}}{2}c \end{pmatrix}
\]
...
これをといて，
\[
a = \dfrac{\sqrt{7}}{7}, \quad b = \dfrac{2\sqrt{7}}{7}, \quad c = \dfrac{4\sqrt{7}}{7} \hfill \text{固}
\]

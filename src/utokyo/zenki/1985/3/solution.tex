...
\noindent
\textbf{[解]} 題意から, 2平面は $Z = \dfrac{1}{t} Y$, $Z = \dfrac{1}{t} X$ となるから, $Q(t, Y, Z)$ とおける。$RQ$ の傾き及び中点について
\[
\begin{cases}
...
\]
となる。対称性から $R(Y, t, Z)$ となる。この時, $QR$ の中点を $N$ とすると, 平面 $OPN$ に関して立体は対称で, $N\left(\dfrac{t+Y}{2}, \dfrac{t+Y}{2}, Z\right)$ となるから, もとめる体積 $V$ として
\begin{align}
V &= 2 \Delta R\text{-}OPN \\
...
と書ける。
\[
RN = \sqrt{\left(Y - \dfrac{t+Y}{2}\right)^2 + \left(t - \dfrac{t+Y}{2}\right)^2} = \dfrac{1}{\sqrt{2}} |Y - t| = \dfrac{1}{\sqrt{2}} \dfrac{2t}{1+t^2}
\]
\[
...
を②に代入して
\[
V = \dfrac{2}{3} \cdot \dfrac{1}{\sqrt{2}} \dfrac{2t}{1+t^2} \cdot \dfrac{1}{\sqrt{2}} \dfrac{2t^3}{1+t^2} = \dfrac{4}{3} \dfrac{t^4}{(1+t^2)^2}
\]
...
&= \dfrac{t}{3} |Y Z - t Z| \\
&= \dfrac{t}{3} \left| \dfrac{t(t^2-1)}{1+t^2} - t \right| \dfrac{2t^2}{1+t^2} \\

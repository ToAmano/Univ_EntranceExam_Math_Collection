...
$x = a + kbc$ などを (1) に代入して
\[
k = 0, \quad \dfrac{-4abc}{a^2b^2 + b^2c^2 + c^2a^2}
\]
となり，$D$ も求まる．
...
\[
V(l) = abc - 4 \cdot \dfrac{1}{6} abc = \dfrac{1}{3} abc \quad \dots \text{①}
\]
一方，$|AB| = 2l-1$, $|BC| = 2l$, $|CA| = 2l+1$ から，\\
ピタゴラスの定理より，
\[
\begin{cases}
(2l-1)^2 = a^2+b^2 \\
...
\begin{align}
\dfrac{V(l)}{\sqrt{l-2}} &= \dfrac{1}{\sqrt{l-2}} \cdot \dfrac{1}{3} \sqrt{2l^2+1} \sqrt{2l(l-2)} \sqrt{2l(l+2)} \\
&= \dfrac{2}{3} \sqrt{2l^2+1} \cdot \sqrt{l} \cdot \sqrt{l(l+2)} \xrightarrow{l \to 2} \dfrac{8}{3} \quad \text{\#\#}
\end{align}

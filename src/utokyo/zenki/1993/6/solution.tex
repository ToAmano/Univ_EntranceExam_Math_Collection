...
\begin{align}
& 2\cos t_2 + \cos 2t_2 = -2\cos \left(\dfrac{\pi}{2} - t_1\right) - \cos 2t_1 = 2\cos t_1 + \cos 2t_1 \\
...
\[
f\left(\dfrac{3}{4}\pi \pm \alpha\right) = -\sqrt{2}\cos\alpha \pm (1-\sqrt{2})\sin\alpha - 1
\]

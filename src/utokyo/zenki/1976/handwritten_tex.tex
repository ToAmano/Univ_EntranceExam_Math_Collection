...
\[
  \begin{cases} -2 + \alpha + (\alpha - X) \le Y \le 2 - \alpha - (\alpha - X) \\ 0 < \alpha - X < 2 - \alpha
  \end{cases}
  \iff
  \begin{cases} 2\alpha - 2 - X \le Y \le X + 2 - 2\alpha \quad (0 < \alpha < 2) \\ 2\alpha - 2 < X < \alpha
  \end{cases}
\]
最後に $\alpha$ を動かす. $f(\alpha) = 2\alpha - X - 2$, $g(\alpha) = -2\alpha + X + 2$ とおく.
$0 < \alpha < 2$, $X < \alpha \le \frac{1}{2}(X+2)$ に注意して,
\[
  \begin{cases} -2 \le X \le 0 \text{ の時 } f(0) \le Y \le g\left(\frac{1}{2}X + 1\right) \\ 0 \le X \le 2 \text{ の時 } f(X) \le Y \le g\left(\frac{1}{2}X + 1\right)
  \end{cases}
\]
...
\[
  \begin{cases} X = k - 2\beta \quad (0 \le \beta \le k) \\ -2 + k \le Y \le 2 - k
  \end{cases}
\]
...
\[
  \beta =
  \begin{cases} -t + \sqrt{t^2+1} & \left( \frac{1}{\sqrt{3}} \le t \le 1 \right) \quad \cdots \text{①} \\ t & \left( 0 < t \le \frac{1}{\sqrt{3}} \right) \quad \cdots \text{②}
  \end{cases}
\]
であり, ②の時
\[

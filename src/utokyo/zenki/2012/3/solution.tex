...
\noindent
{\bf [解]} $y \ge \dfrac{1}{2} x^2, \dfrac{x^2}{1/2} + \dfrac{y^2}{1/32} \le 1$ を図示すると下図斜線部．
...
対称性から
\begin{align}
\dfrac{1}{\pi} \dfrac{1}{2} V_1 &= \int_0^{\frac{1}{2}} \left[ \left( \dfrac{1}{32} - \dfrac{x^2}{16} \right) - \dfrac{1}{4} x^4 \right] dx \\
&= \left[ -\dfrac{1}{20} x^5 - \dfrac{1}{48} x^3 + \dfrac{1}{32} x \right]_0^{\frac{1}{2}} \\
&= \dfrac{11}{15} \left(\dfrac{1}{2}\right)^6
\end{align}

\begin{align}
\dfrac{1}{\pi} V_2 &= \int_0^{\frac{1}{8}} (2y) dy + \int_{\frac{1}{8}}^{\frac{1}{\sqrt{32}}} \left( \dfrac{1}{2} - 16y^2 \right) dy \\
&= \left[ y^2 \right]_0^{\frac{1}{8}} + \left[ \dfrac{1}{2} y - \dfrac{16}{3} y^3 \right]_{\frac{1}{8}}^{\frac{1}{\sqrt{32}}} \\
...
(1) から，
\begin{align}
\dfrac{V_2}{V_1} &= \dfrac{\dfrac{1}{3} \left(\dfrac{1}{2}\right)^6 (-7 + 8\sqrt{2})}{\dfrac{11}{15} \left(\dfrac{1}{2}\right)^5} \\
&= \dfrac{\dfrac{1}{6}(-7 + 8\sqrt{2})}{\dfrac{11}{15}} \\

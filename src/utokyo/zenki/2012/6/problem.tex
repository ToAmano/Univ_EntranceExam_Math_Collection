...
\begin{align*}
  A=\begin{pmatrix} a & 0 \\ 0 & b \end{pmatrix}, \hspace{1\zw}
B=\begin{pmatrix} b & 0 \\ 0 & a \end{pmatrix}, \hspace{1\zw}
C=\begin{pmatrix} a^c & 0 \\ 0 & b^c \end{pmatrix}, \hspace{1\zw}

...
次に$1$位の数を求める．合同式の法を$10$とする．
     ...
     &\equiv \sum_{k=1}^{21}{}_{21}C_k3^{k-1}(-3)^{21-k}-\dfrac{3^21}{t} \tag{$\because t\equiv 3$}\\
     &=\sum_{k=1}^{21}(-1)^{21-k}{}_{21}C_k3^{20}-\dfrac{3^21}{t} \\
     &=-3^{20}\sum_{k=1}^{21}(-1)^{k}{}_{21}C_k-\dfrac{3^21}{t}\tag{1}\label{1}
     \end{align}
...
だから，\eqref{1}に代入して
     \begin{align}
     A\equiv {}_{21}C_03^{20}-\dfrac{3^21}{t}\tag{2}\label{3}
     \end{align}     

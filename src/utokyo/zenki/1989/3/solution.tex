...
\[
H = \{ z = x + y i \mid x, y \in \mathbb{R}, y > 0 \}. \text{ 以下, } z \text{ を } H \text{ に属する複素数とする. } q \in \mathbb{R}_{>0} \text{ とし, } f(z) = \dfrac{z+1-q}{z+1} \text{ とおく.}
\]
\begin{enumerate}
  \item[(1)] $f(z) \in H$ を示せ.
...
\[
\operatorname{Im} f(z) = \dfrac{1}{2i} \{ f(z) - \overline{f(z)} \} > 0
\]

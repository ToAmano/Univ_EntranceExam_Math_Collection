...
{\bf[解]}$A$$B$の$P$からの距離をそれぞれ$A(t)$，$B(t)$とすると，
     ...
     B(t)=\int_0^tvdt+B(0)=\dfrac{1}{4}t^3-\dfrac{3}{2}t^2+25
     \end{align}
である.$B(t)\le25\Longleftrightarrow0\le t\le6$であるから，$A$が$B$に追いつくには，$y=A(t)$と$y=B(t)$が$0<t<6$で少なくとも一回
交わればよい．$y$を消去して
     \begin{align}
     &A(t)=B(t) \nonumber \\
     \Longleftrightarrow &u=\dfrac{1}{4}t^2-\dfrac{3}{2}t+\dfrac{25}{t}\equiv f(t)\label{1}
     \end{align}
である．
      \[f'(t)=\dfrac{1}{2}t-\dfrac{3}{2}-\dfrac{25}{t^2}=\dfrac{(t-5)(t^2+2t+10)}{2t^2}\] 
から，下表を得る．
     \begin{align}

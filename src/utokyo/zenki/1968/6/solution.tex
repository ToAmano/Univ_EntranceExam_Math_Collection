...
{\bf[解]} 
     ...
     \item $f(x)=(1+x)^\a-\left(1+\dfrac{\a}{2}x\right)$とおく．
          \[f'(x)=\a\left[\left(\dfrac{1}{1+x}\right)^{1-\a}-\dfrac{1}{2}\right]\]
     である．
          \begin{align}
          &0\le x\le1 &0<\a<1
          \end{align}
     から，$\cfrac{1}{2}\le\cfrac{1}{1+x}\le1$，$0<1-\a<1$であることより，
          \[\dfrac{1}{2}<\left(\dfrac{1}{2}\right)^{1-\a}\le\left(\dfrac{1}{1+x}\right)^{1-\a}\]
     ...
     また，(1)で$(x,\a)=(1,1/20)$とすることにより，(これらは条件を満たす．)
          \begin{align}
          &2^{1/20}\ge 1+\dfrac{1}{40}>1+\dfrac{24}{1000} \nonumber\\
     ...
     を得る．\eqref{1}，\eqref{2}より，
      ...
      \item \eqref{3}の各辺正より，常用対数を取る.以下$\log_{10}2=a$とする．
           \begin{align}
           &60<200a<60+a  \\
           \Longleftrightarrow &\dfrac{3}{10}<a<\dfrac{60}{199} \\

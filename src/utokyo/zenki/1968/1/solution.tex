...
である．各項計算すると，
     \begin{align}
     &\cdot S_1=-\int_0^5f(x)dx=\dfrac{5^3}{6}=\dfrac{125}{6} \\
     &\cdot S_2=\int_0^5g(x)dx=\int_0^\pi\left(\sin t-\dfrac{3}{\pi}\sin^2t\right)dt \\
     &=\left[-\cos t-\dfrac{3}{2\pi}(t-2\sin 2t)\right]_0^\pi=2-\dfrac{3}{2}=\dfrac{1}{2}
     \end{align}
である．故に\eqref{1}に代入して
     \begin{align}
     S=S_1+S_2=\dfrac{64}{3}\label{2}
     \end{align}
である．
...
とする．\eqref{2}に注意して，面積が等しい条件から
     \begin{align}
     &\dfrac{1}{2}S=\int_0^p(\a x-f(x))dx \\
     \Longleftrightarrow &\dfrac{32}{3}=\dfrac{1}{6}p^3\\

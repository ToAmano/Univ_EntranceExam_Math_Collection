...
\[
-1 \le S < -\dfrac{\sqrt{3}}{2}
\]
\[
\therefore \quad \dfrac{4}{3}\pi < \theta < \dfrac{5}{3}\pi
\]
したがって、一般角でまとめると、
\[
\dfrac{4}{3}\pi + 2n\pi < \theta < \dfrac{5}{3}\pi + 2n\pi \quad (n \in \mathbb{Z}) \hfill \text{\#}
\]
...
\begin{tikzpicture}[scale=1.5, >=stealth]
  ...
  \filldraw ({-sqrt(3)/2},0) circle (1.2pt) node[below left] {$-\dfrac{\sqrt{3}}{2}$};
  \filldraw ({2*sqrt(3)/3},0) circle (1.2pt) node[below right] {$\dfrac{2}{3}\sqrt{3}$};
  \draw[dashed] (1,0) node[above] {$1$} -- (1,-1) -- (0,-1);
  \filldraw (1,-1) circle (1.2pt);
\end{tikzpicture}
\end{center}

...
\end{align}
このもとで $\vec{PQ} = \begin{pmatrix} \beta - \alpha \\ \beta^2 - \alpha^2 \end{pmatrix} = (\beta - \alpha) \begin{pmatrix} 1 \\ \sqrt{2} \end{pmatrix}$ となり，PQ の中点を M として，$MR \perp PQ$，$MR = \dfrac{\sqrt{3}}{2} PQ$ だから，
\begin{align}
\vec{MR} = \pm \dfrac{\sqrt{3}}{2} (\beta - \alpha) \begin{pmatrix} -\sqrt{2} \\ 1 \end{pmatrix}
\end{align}
とおける．したがって
\begin{align}
\vec{OR} = \dfrac{1}{2} \begin{pmatrix} \alpha + \beta \\ \alpha^2 + \beta^2 \end{pmatrix} \pm \dfrac{\sqrt{3}}{2} (\beta - \alpha) \begin{pmatrix} -\sqrt{2} \\ 1 \end{pmatrix}
\end{align}
R も $y = x^2$ 上にあるから
\begin{align}

...
\begin{align}
T &= \int_{10\cos\dfrac{3}{5}\pi}^{10} y \, dx = \int_{\dfrac{3}{5}\pi}^0 y \dfrac{dx}{d\theta} \, d\theta \\
&= \int_{\dfrac{3}{5}\pi}^0 \left( 7\sin\theta - 3\sin\dfrac{7}{3}\theta \right) \left\{ -7\sin\theta - 7\sin\dfrac{7}{3}\theta \right\} d\theta \\
&= 7 \int_0^{\dfrac{3}{5}\pi} \left( 7\sin^2\theta - 3\sin^2\dfrac{7}{3}\theta + 4\sin\theta\sin\dfrac{7}{3}\theta \right) d\theta \quad \cdots ①
\end{align}

各項計算して
\[
\int_0^{\dfrac{3}{5}\pi} \sin^2\theta \, d\theta = \dfrac{1}{2} \left[ \theta - \dfrac{1}{2}\sin 2\theta \right]_0^{\dfrac{3}{5}\pi} = \dfrac{1}{2} \left( \dfrac{3}{5}\pi - \dfrac{1}{2}\sin\dfrac{6}{5}\pi \right)
\]
\[
\int_0^{\dfrac{3}{5}\pi} \sin^2\dfrac{7}{3}\theta \, d\theta = \dfrac{1}{2} \left[ \theta - \dfrac{3}{14}\sin\dfrac{14}{3}\theta \right]_0^{\dfrac{3}{5}\pi} = \dfrac{1}{2} \left( \dfrac{3}{5}\pi - \dfrac{3}{14}\sin\dfrac{14}{5}\pi \right)
\]
\begin{align}
\int_0^{\dfrac{3}{5}\pi} \sin\theta\sin\dfrac{7}{3}\theta \, d\theta &= \int_0^{\dfrac{3}{5}\pi} -\dfrac{1}{2} \left( \cos\dfrac{10}{3}\theta - \cos\dfrac{4}{3}\theta \right) d\theta \\
&= -\dfrac{1}{2} \left[ \dfrac{3}{10}\sin\dfrac{10}{3}\theta - \dfrac{3}{4}\sin\dfrac{4}{3}\theta \right]_0^{\dfrac{3}{5}\pi} = +\dfrac{3}{8}\sin\dfrac{4}{5}\pi
\end{align}

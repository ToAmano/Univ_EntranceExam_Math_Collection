...
\[
r(P) = \max\left\{ X, \dfrac{1}{2}(-\sqrt{3}X - Y + \sqrt{3}) \right\}
\]
...
\begin{enumerate}
  ...
  \end{align}
  だから、$r(P) = \max\left\{ X, Y, \dfrac{1}{2}(-\sqrt{3}X - Y + \sqrt{3}) \right\}$ である。まず、
  \[
  ...
  \[
  \begin{cases}
  0 \le Y \le \dfrac{1}{3}(-\sqrt{3}X + \sqrt{3}) \text{ の時 } r(P) = \max\left\{ X, \dfrac{1}{2}(-\sqrt{3}X - Y + \sqrt{3}) \right\} & \dots \text{1-①} \\

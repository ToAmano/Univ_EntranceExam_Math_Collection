...
{\bf [解]} $a_1, a_2, b_1, b_2 \in \mathbb{Q} \quad \dots *$

\begin{itemize}
  \item $a = \sqrt{a_1^2 + a_2^2}, \quad b = \sqrt{b_1^2 + b_2^2}, \quad c = |AB| = \sqrt{(a_1 - b_1)^2 + (a_2 - b_2)^2}$
  \item $\cos\theta = \dfrac{a^2 + b^2 - c^2}{2ab}, \quad \sin\theta = \dfrac{|a_1 b_2 - a_2 b_1|}{ab} \quad \dots \text{①}$
\end{itemize}

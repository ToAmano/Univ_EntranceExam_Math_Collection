...
\noindent
{\bf [解]} $C$の高さを $h = 1600 + x\ \text{[m]}$ とおくと，題意より，下図で
\begin{align}
\text{BC}' = \sqrt{3}(x+A), \quad \text{BA}' = \sqrt{3}A, \quad \text{AC}' = \dfrac{x}{2-\sqrt{3}}
\end{align}
...
\end{tikzpicture}
\caption{$\triangle A'BC'$ の辺の長さ}
\end{figure}

\noindent
セイリして
\begin{align}
(\sqrt{3}A)^2 &= \Bigl((2+\sqrt{3})x\Bigr)^2 + 3(x+A)^2 - 2\sqrt{3}(2+\sqrt{3})x(x+A)\dfrac{\sqrt{3}}{2} \\
3A^2 &= (7+4\sqrt{3})x^2 + 3(x^2 + 2Ax + A^2) - (6+3\sqrt{3})(x^2 + Ax) \\
0 &= \Bigl\{(7+4\sqrt{3}) + 3 - (6+3\sqrt{3})\Bigr\}x^2 + (6A - 6A - 3\sqrt{3}A)x \\
0 &= (4+\sqrt{3})x^2 - 3\sqrt{3}Ax
\end{align}
$x \neq 0$ より
\begin{align}
(4+\sqrt{3})x &= 3\sqrt{3}A \\
x &= \dfrac{3\sqrt{3}}{4+\sqrt{3}}A \\
&= \dfrac{-9+12\sqrt{3}}{13}A \\

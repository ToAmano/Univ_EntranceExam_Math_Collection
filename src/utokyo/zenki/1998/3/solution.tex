...
\begin{figure}[htb]
  ...
  \end{tikzpicture}
  \caption{隣接する円$C_n, C_{n+1}, C_{n+2}$の配置（$n$の偶奇による場合分け）}
\end{figure}
...
$q_n \in \mathbb{Z} \dots \spadesuit$ を帰納法で示す． $n=0, 1$ の時， $q_0 = q_1 = 1$ から $\spadesuit$ は成立するので， 以下 $n=k, k+1 \ (k \in \mathbb{Z}_{\ge 0})$ での成立を仮定する．
①で辺々足したものと②から
\begin{align}
  2\sqrt{r_k r_{k+2}} + 2\sqrt{r_{k+1} r_{k+2}} &= 2\sqrt{r_k r_{k+1}}
\end{align}
$q_n = \dfrac{1}{2\sqrt{r_n}}$ から
\begin{align}
  \dfrac{1}{q_k q_{k+2}} + \dfrac{1}{q_{k+1} q_{k+2}} &= \dfrac{1}{q_k q_{k+1}}
\end{align}
...
①の辺々わって， $p_n = \dfrac{x_n}{2\sqrt{r_n}}$ から
\begin{align}
  \begin{cases}
...
(2)から， $p_{n+1} = q_n \ (n \ge 0)$． $p_0 = 0$ であるので，
\begin{align}
  x_n &=
  \begin{cases} 0 & (n = 0) \\ \dfrac{q_{n-1}}{q_n} & (n \ge 1)
  \end{cases}
\end{align}
となる． ③の両辺 $q_k$ でわって，
\begin{align}
  \dfrac{1}{x_{n+2}} &= x_{n+1} + 1 \quad (n \ge 0)
\end{align}
これより， $x_{n+1} = \dfrac{1}{1 + x_n} \quad (n \ge 1)$．
両辺 $\alpha = \dfrac{1}{1 + \alpha}$ を引いて，
\begin{align}
  x_{n+1} - \alpha &= \dfrac{1}{1 + x_n} - \dfrac{1}{1 + \alpha} \\
  &= \dfrac{-1}{(1 + \alpha)(1 + x_n)} (x_n - \alpha)
\end{align}
両辺絶対値をとって，
\begin{align}
  |x_{n+1} - \alpha| &= \left| \dfrac{1}{(1 + \alpha)(1 + x_n)} \right| |x_n - \alpha|
\end{align}
ここで， $\alpha = \dfrac{-1 + \sqrt{5}}{2}$， $0 \le x_n \le 1$ から
\begin{align}
  |x_{n+1} - \alpha| &\le \left| \dfrac{\sqrt{5}-1}{2} \right| |x_n - \alpha| < \dfrac{2}{3} |x_n - \alpha|
\end{align}
なので， くり返し用いて，
\begin{align}
  |x_n - \alpha| &< \left(\dfrac{2}{3}\right)^{n-2} |x_2 - \alpha|
\end{align}

...
{\bf [解1]} $f(x) = \dfrac{x^2(2 \cdot 3^3 \cdot n - x)}{2^5 \cdot 3^2 \cdot n^2}$ において, $k \in \mathbb{Z}$ として,
\begin{align}
\begin{cases}
...
である.
\begin{align}
f(k+1) - f(k) &= \dfrac{1}{2^5 \cdot 3^2 \cdot n^2} \left[ (k+1)^2(2 \cdot 3^3 \cdot n - k - 1) - k^2(2 \cdot 3^3 \cdot n - k) \right] \\
&= \dfrac{1}{2^5 \cdot 3^2 \cdot n^2} \left[ (2k+1)(2 \cdot 3^3 \cdot n - k) - (k+1)^2 \right] \\
&= \dfrac{1}{2^5 \cdot 3^2 \cdot n^2} \left[ -3k^2 + (2 \cdot 3^3 \cdot n - 3)k + 2 \cdot 3^3 \cdot n - 1 \right] \quad \dots \text{①}
\end{align}
...
なので, $g(k) = 0$ の解は,
\begin{align}
k &= \dfrac{1}{6} \left[ 3(2^2 \cdot 3^2 \cdot n - 1) \pm \sqrt{9(2^2 \cdot 3^2 \cdot n - 1)^2 - 12\left(2^5 \cdot 3^2 \cdot n^2 + 1 - 2 \cdot 3^3 \cdot n\right)} \right] \\
&= \dfrac{1}{6} \left[ 3(2^2 \cdot 3^2 \cdot n - 1) \pm \sqrt{2^4 \cdot 3^4 \cdot n^2 - 3} \right] \quad \dots \text{②}
\end{align}
...
\bigskip\noindent{\bf [解2]} (以下) 平均値の定理から,
\begin{align}
f(k+1) - f(k) &= f'(a_k) \quad (k < a_k < k+1) \quad \dots \text{①'}
\end{align}
を満たす $a_k$ がある.
\begin{align}
f'(x) = \dfrac{x(2^2 \cdot 3^2 \cdot n - x)}{2^5 \cdot 3^2 \cdot n^2} \le 1 &\iff -x^2 + 2^2 \cdot 3^2 \cdot n \cdot x - 2^5 \cdot 3^2 \cdot n^2 \le 0 \\
&\iff x \le 12n, 24n \le x
\end{align}
だから, ①'とあわせて
\begin{align}
\begin{cases}

...
\filldraw (1.5,0) circle (1.5pt) node[below left] {$12n - \dfrac{1}{2}$};
\filldraw (3.8,0) circle (1.5pt) node[below right] {$24n - \dfrac{1}{2}$};
...
を満たす $a_k$ がある.
\[
f'(x) = \dfrac{x(2^2 \cdot 3^2 \cdot n - x)}{2^5 \cdot 3^2 \cdot n^2} \le 1 \iff -x^2 + 2^2 \cdot 3^2 \cdot n \cdot x - 2^5 \cdot 3^2 \cdot n^2 \le 0 \iff x \le 12n, 24n \le x
\]
だから, ①'とあわせて
\[
\begin{cases}

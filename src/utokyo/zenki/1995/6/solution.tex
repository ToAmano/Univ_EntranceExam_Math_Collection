...
{\bf[解]}
     ...
     \item $2$本の漸近線は$y=\pm\dfrac{b}{a}x$であり，$P(X,Y)$での双曲線の接線$l$は
          \[\dfrac{Xx}{a^2}-\dfrac{Yy}{b^2}=1 \]
     である．故にこれらの交点は
          \[A=\dfrac{X}{a}+\dfrac{Y}{b} , B=\dfrac{X}{a}-\dfrac{Y}{b} \]
     として
          \[ \left(\dfrac{a}{A},\dfrac{-b}{A}\right),\left(\dfrac{a}{B},\dfrac{b}{B}\right)\]
     である．したがってサラスの公式から
          \begin{align}
          S&=\dfrac{1}{2}\left|\dfrac{ab}{AB}+\dfrac{ab}{AB}\right|  \nonumber\\   
          &=\dfrac{ab}{AB}  \nonumber\\
          &=ab \ \ \ \left(\because AB=\dfrac{X^2}{a^2}-\dfrac{Y^2}{b^2}=1\right)  \label{1}
          \end{align}
     ...
     したがって\eqref{2}とあわせて
          \begin{align}
          \min S&=5\left(\dfrac{1}{5}\right)^{4/3}+6\left(\dfrac{1}{5}\right)^{1/3}+5^{2/3} \\

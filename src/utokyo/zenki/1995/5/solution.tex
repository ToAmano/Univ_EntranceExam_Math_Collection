...
{\bf[解]}
     ...
     $\left(\dfrac{1}{2}\right)^l$である．ここで$l+1$回目から$n$回目まで全て$l$回目と逆向きに動い
     たとしても，その合計の移動量は
          \begin{align}
     ...
     $y$軸上にあるのは常にサイコロが$1,3,5,6$のときである．したがって
          \begin{align}
           P(X)=P(Y)=\left(\dfrac{2}{3}\right)^n  \label{2}    
          \end{align}
     また，原点にあるのは，(1)と同様に考えれば常にサイコロが$5,6$であるときだから，
          \begin{align}
          P(X\cap Y)=\left(\dfrac{1}{3}\right)^n \label{3}
          \end{align}
     である．
     ...
     \eqref{2}，\eqref{3}を\eqref{1}に代入すれば
          \begin{align}
          a_n=\dfrac{1}{4}\left(1-2\left(\dfrac{2}{3}\right)^n+\left(\dfrac{1}{3}\right)^n\right)\cdots\text{(答)}
          \end{align}
     となる．     
     \end{enumerate}
\newpage

...
\[
\alpha = 4 \cdot {}_5C_2 \cdot {}_3C_1 \cdot {}_2C_1 \cdot \left(\dfrac{1}{4}\right)^5 = \dfrac{15}{4^3}
\]
だから、(1)より
\[
...
だから、
\[
P_3 = 3^3 \cdot 5^2 \cdot 7 \cdot \left(\dfrac{1}{4}\right)^8 (1+2) = 3^4 \cdot 5^2 \cdot 7 \left(\dfrac{1}{4}\right)^8
\]
(1)とあわせて、
\[
\dfrac{P_3}{P_1} = \dfrac{4^6 \cdot 3^4 \cdot 5^2 \cdot 7}{3^2 \cdot 5^2 \cdot 4^8} = \dfrac{3^2 \cdot 7}{4^2} = \dfrac{63}{16} \quad \text{\#\!}
\]

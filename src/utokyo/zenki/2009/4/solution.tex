...
だから、対称性から
\begin{align}
\dfrac{1}{2} W(a) &= \int_{0}^{s} S(\theta) ds \\
...
&= \dfrac{1}{2}\pi \left[ \dfrac{3}{4}s + \dfrac{1}{12}\sin 3\theta \right]_{0}^{\pi/2} = \dfrac{1}{2}\left(\dfrac{3}{4} - \dfrac{1}{12}\right)\pi = \dfrac{1}{3}\pi
\end{align}
となって、
\[
W(a) = \dfrac{2}{3}\pi \quad \text{\#\!}
\]
...
$E$ のうち $x \le 0$ のものの $y=s$ における切断面の面積 $T(\theta)$ は、右上図から、
\begin{align}
...
\[
0 \le \int_{0}^{1} T(\theta) d\theta \le 2 \dfrac{1}{\sqrt{a^2+1} + a} A \quad \cdots (7)
\]
...
\[
V(a) \longrightarrow W(a) = \dfrac{2}{3}\pi \quad \text{\#\!}
\]

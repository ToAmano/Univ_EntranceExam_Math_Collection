...
\begin{multicols}{2}
  ...
  \begin{align*}
    ...
    \end{dcases}
  \end{align*}
  となる．ここで$\beta=f(\sqrt{8-2\sqrt{3}})$とおいた．$f(x)$のグラフの概形より$\sqrt{3}/2>\beta$だから，このときの$\max \theta$は\cref{1991-2:eq:3}より$\cos \angle \mathrm{APO} = \frac{\sqrt{3}}{2}$すなわち$\max \theta=\pi/6$である．
  ...
  \begin{align*}
    ...
    \end{dcases}
  \end{align*}
  となる．$\sqrt{3}/2>\sqrt{6}{3}$より，したがってこのときの$\max \theta$は\cref{1991-2:eq:4}より$cos \angle \mathrm{DPO} = \frac{\sqrt{3}}{2}$すなわち$\max \theta=\pi/6$である．

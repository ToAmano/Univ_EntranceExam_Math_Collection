...
question: "1"
type: "solution"
title: "SAMPLE_TITECH 1998 kouki Q1 (solution)"
---
...
\begin{align*}
x_n
     & = \frac{1}{n^{b}}\sum_{k=0}^{n-1}\frac{1}{(n+k)^a}\\& = \frac{1}{n^{b}}\sum_{k=n}^{2n-1}\frac{1}{k^a}\\& = \frac{1}{n^{a+b-1}}\frac{1}{n}\sum_{k=n}^{2n-1}\frac{1}{\left(\frac{k}{n}\right)^a}
\end{align*}
$$

...
question: "3"
type: "solution"
title: "UKYOTO 1961 zenki Q3 (solution)"
---
...
2.  $\tan \dfrac{\alpha}{2} = t$ とおくと $t = \dfrac{r}{a}$ だから
...
3.  $\vec{QA} = \begin{pmatrix} -r - a \sin\theta \\ -a \cos\theta \end{pmatrix}$, $\vec{QB} = \begin{pmatrix} r - a \sin\theta \\ -a \cos\theta \end{pmatrix}$ から
  

$$
\begin{align*}
\tan\beta&= \frac{|\vec{QA} \cdot \vec{QB} \cdot \sin\beta|}{\vec{QA} \cdot \vec{QB}}\\&= \frac{|(-r - a s)(-a c) - (r - a s)(-a c)|}{(r - a s)(-r - a s) + a^2 c^2}\quad(c = \cos\theta, s = \sin\theta) \\&= \frac{|2 r a c|}{a^2 - r^2} = \frac{2 r a c}{a^2 - r^2}\quad(\because 2 r a c > 0)
\end{align*}
$$

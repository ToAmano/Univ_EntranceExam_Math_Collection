...
question: "6"
type: "problem"
title: "KYODAI 1995 kouki Q6 (problem)"
---
...
1.  直線$\mathrm{RQ}$が接線$L_a$と第1象限の点$\mathrm{M}=(x_0,y_0)$，$x_0>0$，$y_0>0$で交わるための必要十分条件を求めよ．

設問(1)の条件が満たされている時，四角形$\mathrm{OAMQ}$の面積を$\mathrm{T}$，$\triangle\mathrm{ARM}$の面積を$S_1$，$\triangle\mathrm{BQM}$の面積を$S_2$とする．

1.  [2] $r=S_1+S_2$，$m=S_1S_2$とおく時，点$(r,m)$の存在する範囲を図示せよ．
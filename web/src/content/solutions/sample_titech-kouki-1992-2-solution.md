...
question: "2"
type: "solution"
title: "SAMPLE_TITECH 1992 kouki Q2 (solution)"
---
...
\begin{align*}
\lim_{n \to \infty} t_n
     & = \frac{a(1-a\bar{p})}{(1-ap)(1-a\bar{p})}\\& = \frac{a(1-a\bar{p})}{1-2a\Re p + a^2}\\& = \frac{2a-a^2(-1-i\sqrt{3})}{2(1+a + a^2)}\\& = \frac{a(2+a)+i\sqrt{3}a^2}{2(1+a + a^2)}\\
\end{align*}
$$
...
\begin{align*}
e(\alpha)e(\beta)
     & = \left(\cos\alpha+i\sin\beta\right)\left(\cos\beta+i\sin\beta\right)\\& = \left(cos\alpha\cos\beta - \sin\alpha\sin\beta\right) + i\left(\cos\alpha\sin\beta + \sin\alpha\cos\beta\right)\\& = e(\alpha+\beta)
\end{align*}
$$

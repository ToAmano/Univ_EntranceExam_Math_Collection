...
\end{align}$$ をみたす $x \in \mathbb{R}$ をもとめればよい．
$g(x) \in \mathbb{Z}$ から
$5x \in \mathbb{Z}$．つまり，$x = \frac{t}{5}$ ($t \in \mathbb{Z}$)
とかける．[\[1990-1:eq:1\]](#1990-1:eq:1){reference-type="ref+label"
reference="1990-1:eq:1"}に代入して$t$の条件式を求めると，
$$\begin{align}
...
のグラフの概形は[1](#1990-1:fig:1){reference-type="ref+label"
reference="1990-1:fig:1"}のようになっており， $$\begin{align*}
         & p(-3) = 198 & p(-1) = 62  \\
         & p(31) = 62  & p(33) = 198
\end{align*}$$
だから，[\[1990-1:eq:2\]](#1990-1:eq:2){reference-type="ref+label"
reference="1990-1:eq:2"}を満たすような$t \in \mathbb{Z}$は $t=-2, 32$
...
実際にこれを解いてみると $$\begin{align*}
        (x+1)(x-2)   & = 1 + 5x \\
        x^2 - 6x - 3 & = 0      \\
        x = 3 \pm 2\sqrt{3}
\end{align*}$$ であり，$x \approx 6.46$ と $x \approx -0.46$

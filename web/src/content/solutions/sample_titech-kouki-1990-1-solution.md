...
**\[解\]** 実数 $x$ に対して $f(x) = (x+1)(x-2)$, $g(x) = 1+5x$
とおく．題意から， $$\begin{align}
\label{1990-1:eq:1}
...
のグラフの概形は[図1](#1990-1:fig:1)のようになっており， $$\begin{align*}
& p(-3) = 198 & p(-1) = 62  \\
& p(31) = 62  & p(33) = 198
\end{align*}$$
...
<figure id="1990-1:fig:1"\> <img
src="/Univ_EntranceExam_Math_Collection/images/tikz/sample_titech/kouki/1990/1/fig_1.svg"
alt="図 1" /> <figcaption>図 1: 二次関数 $y = 2t^2 - 60t$
のグラフ</figcaption> </figure>

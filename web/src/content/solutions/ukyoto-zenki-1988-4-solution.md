...
question: "4"
type: "solution"
title: "UKYOTO 1988 zenki Q4 (solution)"
---
...
$$
\begin{align*}
V &= \int_0^{t\sqrt{2}} S(k) dz \\&= \int_0^t S(k) \frac{dz}{dk} dk \\&= \int_0^t 4k(1-k) \sqrt{2} dk \\&= 4\sqrt{2}\left[\frac{1}{2}k^2 - \frac{1}{3}k^3 \right]_0^t \\&= 4\sqrt{2}\left(\frac{1}{2}t^2 - \frac{1}{3}t^3 \right)\quad //
\end{align*}
$$

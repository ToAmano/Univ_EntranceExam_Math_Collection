...
question: "5"
type: "solution"
title: "UTOKYO 1993 zenki Q5 (solution)"
---
...
## 【解】
 ...
 左から $k$ 番目の数の、$S_n$ での値が $S$ と一致する確率を $t_k(n)$ とする。
...
$$
\begin{align*}
t_k(n+1) &= (1-q) t_k(n) + p(1 - t_k(n)) \\&= (1-p-q) t_k(n) + p \\
...
$$
\begin{align*}
t_k(n) &= (1-p-q)^n \left( 1 - \frac{p}{p+q}\right) + \frac{p}{p+q}\\&= \frac{1}{p+q}\{ p + q(1-p-q)^n \}\quad\dots\text{①}
\end{align*}
$$
...
$$
\begin{align*}
t_k(n+1) &= (1-p) t_k(n) + q(1 - t_k(n)) \\&= (1-p-q) t_k(n) + q \\

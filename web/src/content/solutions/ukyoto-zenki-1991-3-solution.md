...
question: "3"
type: "solution"
title: "UKYOTO 1991 zenki Q3 (solution)"
---
...
$$
\begin{align*}
\vec{a}\cdot(\vec{c} - \vec{b}) &= 0 \quad\cdots\text{②}\\\vec{b}\cdot(\vec{a} - \vec{c}) &= 0 \quad\cdots\text{③}\\\vec{c}\cdot(\vec{b} - \vec{a}) &= 0 \quad\cdots\text{④}
\end{align*}
$$
...
$$
\begin{align*}
\overrightarrow{GA'}&= \frac{1}{4}(\vec{a} - \vec{b} - \vec{c}) \\\overrightarrow{GB'}&= \frac{1}{4}(-\vec{a} + \vec{b} - \vec{c}) \\\overrightarrow{GC'}&= \frac{1}{4}(-\vec{a} - \vec{b} + \vec{c}) \\\overrightarrow{GP}&= \frac{1}{4}(\vec{a} + \vec{b} - \vec{c}) \\\overrightarrow{GQ}&= \frac{1}{4}(-\vec{a} + \vec{b} + \vec{c}) \\\overrightarrow{GR}&= \frac{1}{4}(\vec{a} - \vec{b} + \vec{c})
\end{align*}
$$

...
question: "3"
type: "problem"
title: "TODAI 2002 kouki Q3 (problem)"
---
...
1.  $f(b) = b$ を満たす，$0 \leq b \leq 1$ なる実数をすべて求めよ。

2.  $a_4$ が (1) で求めたものの値の 1 つに等しくなるような初期値 $a_1$ をすべて求めよ。
...
4.  初期値 $a_1$ が (3) の条件を満たさないとき、$a_n \ge \frac{3}{4}$ となるような $n \geq 1$ が存在することを示せ。

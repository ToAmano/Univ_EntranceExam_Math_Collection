...
question: "4"
type: "solution"
title: "UTOKYO 2011 zenki Q4 (solution)"
---
...
$$
\begin{align*}
(\beta - \frac{1}{2})^2 + (\beta^2 - \frac{1}{4})^2 &= (\alpha - \frac{1}{2})^2 + (\alpha^2 - \frac{1}{4})^2 \\\beta^2 - \beta + \beta^4 - \frac{1}{2}\beta^2 &= \alpha^2 - \alpha + \alpha^4 - \frac{1}{2}\alpha^2 \\\beta^4 + \frac{1}{2}\beta^2 - \beta&= \alpha^4 + \frac{1}{2}\alpha^2 - \alpha\\(\beta^2 + \alpha^2)(\beta^2 - \alpha^2) + \frac{1}{2}(\beta^2 - \alpha^2) - (\beta - \alpha) &= 0
\end{align*}
$$

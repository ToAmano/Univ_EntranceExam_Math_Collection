...
question: "3"
type: "solution"
title: "UTOKYO 1963 zenki Q3 (solution)"
---
...
[**解**] (1) $B=P_0, C=Q_0$ とする。$\triangle P_n Q_n D$, $\triangle AD Q_n$ に注目し、相似から
...
$$
\begin{align*}
F_n &= \frac{1}{2} h_n x_{n+1} = \frac{H}{2b}\cdot\frac{ab}{a+bn}\cdot\frac{ab}{a+b(n+1)}\\&= \left(\frac{1}{a+bn} - \frac{1}{a+b(n+1)}\right)\frac{a^2 H}{2}
\end{align*}
$$

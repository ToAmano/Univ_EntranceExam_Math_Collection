...
question: "3"
type: "solution"
title: "UTOKYO 1991 zenki Q3 (solution)"
---
...
## 【解】
 ...
 $g(x) = x^3 - 3x$ とおく. $g'(x) = 3(x+1)(x-1)$ から, 下表を得る.
...
f''(p) &= 2(\alpha' \cdot\alpha' + \alpha\cdot\alpha'') \\&= 2 \left\{(\alpha')^2 + \alpha\frac{-2\alpha(\alpha')^2}{\alpha^2 - 1}\right\}\quad(\because\text{⑥}) \\&= 2(\alpha')^2 \frac{-(\alpha^2 + 1)}{\alpha^2 - 1} < 0
\end{align*}
$$

...
question: "3"
type: "solution"
title: "KYODAI 1989 kouki Q3 (solution)"
---
...
<figure id="1989-3:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/kyodai/kouki/1989/3/fig_1.svg" alt="図 1" />
...
$$
    ...
    となり，$f(X)$の増減表は$\eqref{1989-3:table:1}$となる．
    \begin{table}[H]
        \centering
        \caption{$f(X)$の増減表}

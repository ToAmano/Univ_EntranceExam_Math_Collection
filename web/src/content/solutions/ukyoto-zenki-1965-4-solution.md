...
question: "4"
type: "solution"
title: "UKYOTO 1965 zenki Q4 (solution)"
---
...
[**解**] $OX$ を $x$ 軸、$O$ を原点とする右のような座標を考え、$OY$ の方向ベクトル $\begin{pmatrix} \cos\theta \\ \sin\theta \end{pmatrix}$ とおく ($0 < \theta < \pi$)。又点 $A(\alpha, \beta)$ とおく。\\
...
$$
\begin{align*}
\tan\angle OAP_1 &= \tan\angle OAQ_1 \\\tan\angle OAP_2 &= \tan\angle OAQ_2
\end{align*}
$$
...
$$
\begin{align}
\sin(\theta - 2\varphi) &= 0 \dots\text{③}\\\sin\varphi&= \sin(\theta - \varphi) \dots\text{④}
\end{align}
$$

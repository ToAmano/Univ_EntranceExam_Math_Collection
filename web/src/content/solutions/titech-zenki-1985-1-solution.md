...
question: "1"
type: "solution"
title: "TITECH 1985 zenki Q1 (solution)"
---
...
1.  $a^2-2b^2=\pm1\ \cdots *$

2.  $a+\sqrt2\,b>0$

$p=1+\sqrt2$とおく．$1^2-2\cdot1^2=-1$から，$p\in G$である．

**(1)** $1<g<p$をみたす$G$の要素$g$があると仮定すると，
...
**(2)** 証明は帰納法による．$n=0$の時は$f(n)=gu^n$とおくと$f(0)=g\in G$だから成立するので，以下$n=k\ (\in\mathbb{Z})$での$f(k)\in G$を仮定し，$n=k\pm1$での成立を示す．$f(k)=\alpha+\sqrt2\beta$とおく．
...
**[補題]** $(1+\sqrt2)^n=A_n+\sqrt2B_n,\ (1-\sqrt2)^n=A_n-\sqrt2B_n\ (A_n,B_n\in\mathbb{Z})$と表せることを示す．

**（証明）** $n=0$の時は明らか．まず$n\in\mathbb{N}$の時，2項展開から

...
question: "6"
type: "solution"
title: "UTOKYO 1983 zenki Q6 (solution)"
---
...
$$
\begin{align}
k&\le\left\{\dfrac{3}{4}-k^2\right\}-z^2 \nonumber\\\therefore -\alpha&\le z\le\alpha\label{b}
\end{align}
$$
...
$$
\begin{align*}
S(k)&=\int_{-\alpha}^\alpha\left\{ f(z)-k\right\}dz \\&=\frac{1}{6}(\alpha+\alpha)^3 \\&=\frac{4}{3}\left(\frac{3}{4}-k-k^2\right)^{3/2}\\&=\frac{4}{3}\left\{1-\left(k+\frac{1}{2}\right)^2\right\}^{3/2}
\end{align*}
$$

である．[b](#b)から$z$の存在条件は実数$\alpha$の存在条件に等しく，[a](#a)から
     

$$
\begin{align*}
&\frac{3}{4}-k-k^2\ge0 \\\therefore&\frac{-3}{2}\le k \le\frac{1}{2}
\end{align*}
$$
...
$$
\begin{align*}
V&=\int_{-3/2}^{1/2}S(k)dk \\&=\frac{4}{3}\int_{-3/2}^{1/2}\left\{1-\left(k+\frac{1}{2}\right)^2\right\}^{3/2}dk \\&=\frac{4}{3}\int_{-1}^{1}\left(1-t^2\right)^{3/2}dt \ \ \ \ \ \ \ \ \ \ \ \ \ (t=k+\frac{1}{2}) \\&=\frac{8}{3}\int_0^{\pi/2}\left(1-s^2\right)^{3/2}\frac{ds}{d\theta}d\theta\ \ \ \ \ \ \ \ \ (t=s=\sin\theta
     ,c=\cos\theta) \\&=\frac{8}{3}\int_0^{\pi/2}c^2(1-s^2)d\theta\\&=\frac{\pi}{2}\cdots\text{(答)}
\end{align*}
$$
...
$$
\begin{align*}
\exists x\exists y\exists z\, ,\,&x\le y\le\frac{3}{4}-(x^2+z^2)，y=x+k \\\exists x \exists z \, ,\,&x\le x+k\le\frac{3}{4}-(x^2+z^2) \\\exists x \exists z \, ,\,&0\le k\land\left(x+\frac{1}{2}\right)^2+z^2\le 1-k \\&0\le k\le 1
\end{align*}
$$

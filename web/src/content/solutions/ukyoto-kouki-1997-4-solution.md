...
question: "4"
type: "solution"
title: "UKYOTO 1997 kouki Q4 (solution)"
---
...
$$
  ...
  背理法により題意を示す．
  $|a|>1$と仮定すると，[(式1)](#1997-4:eq:1)より$b>1,c>1,a>1$となる．
  従ってこの時，$a^2>a$などの不等式が成り立つ．
  [(式1)](#1997-4:eq:1)の全ての式を足し上げると
...
$$
  ...
  この時[(式1)](#1997-4:eq:1)から$|b|\le 1, |c|\le 1$が従う．
  よって題意は示された．
  $\cdots$(答)
...
## 【解説】
  ...
  まず，$|a|>1$を仮定すると[(式1)](#1997-4:eq:1)から$a,b,c>1$が従うことに気を付ける．
...
<figure id="1997-4:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/ukyoto/kouki/1997/4/fig_1.svg" alt="図 1" />

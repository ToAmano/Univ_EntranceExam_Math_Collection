...
question: "2"
type: "solution"
title: "UKYOTO 1963 zenki Q2 (solution)"
---
...
[**解**] 内接円の半径 $r$, 外接円の半径 $R$ とおく。まず $\triangle ABC$ において内心 $O$ とし、図のように角度をおく ($\alpha+\beta+\gamma = \pi/2$) と
...
$$
\begin{align*}
f(x, y) &= \sin x \sin y \sin(\pi/2 - x - y) \\&= \sin x \sin y \cos(x+y) \quad(0 < x, y, \ x+y < \pi/2)
\end{align*}
$$

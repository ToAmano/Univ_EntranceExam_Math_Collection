...
question: "1"
type: "solution"
title: "UKYOTO 1998 zenki Q1 (solution)"
---
...
\begin{minipage}[t]{0.5\textwidth}[解] $\angle \text{BAC} = \angle \text{R}$ となるよう、3頂点 $\text{A}, \text{B}, \text{C}$ を定める。\\
...
\draw (O) circle (0.8);
\node[right] at (O) {O};
\coordinate (H1) at (-0.3, 1.4); 
\coordinate (H2) at (0.3, 0); 
\coordinate (H3) at (1, 1.3); 

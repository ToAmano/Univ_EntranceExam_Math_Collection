...
$$
  ...
  (1)
  [(式1)](#2006-2:eq:1)および$3,5$は素数であることから，$b,c$は各々$3,5$でわり切れる．
  したがって，$b'=\frac{1}{3}b$, $c'=\frac{1}{5}c ( \in \mathbb{N} )$として
  [(式1)](#2006-2:eq:1)に代入して
...
$$
  ...
  なる$c'''\in\mathbb{N}$がある．[(式3)](#2006-2:eq:3)に代入すると，
...
$$
  ...
  である．
  これをみたす$(k,l)$は[(式4)](#2006-2:eq:4)の条件では
  $(k,l)=(2,3)$のみであり，この時
...
## 【解説】
  ...
  (1)も(2)も肝となるのは，$a$がある数$p$を因数に持った場合，
...
$$
  ...
  以上[(式8)](#2006-2:eq:7,2006-2:eq:8)および$2$と$3$が互いに素なので$p_3,p_5$以外について

...
\(2\)
(1)から，$y=f_{a_0}(x)$は常に$y=x$の下側にあって，グラフの概形は[1](#1992-1:fig:1){reference-type="ref+label"
reference="1992-1:fig:1"}のようになる．

<figure id="1992-1:fig:1" data-latex-placement="H">
<img
src="/Math-Solutions/images/tikz/sample_todai-zenki-1992-1_tikz_1.svg" />
<figcaption><span
...
\end{align}$$ である．
[\[1992-1:eq:2,1992-1:eq:3\]](#1992-1:eq:2,1992-1:eq:3){reference-type="ref+label"
reference="1992-1:eq:2,1992-1:eq:3"}を[\[1992-1:eq:1\]](#1992-1:eq:1){reference-type="ref+label"
reference="1992-1:eq:1"}に代入して，求める体積は $$\begin{align*}
        V(\theta)

...
```
を満たすような最大の実数$`a`$を求める． $`x-a/x>0`$のもとで両辺二乗して
``` math
...
$2$
$1$から，$`y=f_{a_0}$x$`$は常に$`y=x`$の下側にあって，グラフの概形は<a href="#1992-1:fig:1" data-reference-type="ref+label"
data-reference="1992-1:fig:1">1</a>のようになる．
...
```
である．
<a href="#$式2, 式3, 式2, 式3, 式2, 式3, 式1, 式1, 式1$

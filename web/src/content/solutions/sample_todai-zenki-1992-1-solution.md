...
<figure id="1992-1:fig:1"\> <img
src="/Univ_EntranceExam_Math_Collection/images/tikz/sample_todai/zenki/1992/1/fig_1.svg"
alt="図 1" /> <figcaption>図 1:
$y=f_a(x)$のグラフの概形と，題意の領域．</figcaption> </figure>
...
\end{align}$$ である．
$\eqref{1992-1:eq:2,1992-1:eq:3}$を$\eqref{1992-1:eq:1}$に代入して，求める体積は $$\begin{align*}
V(\theta)

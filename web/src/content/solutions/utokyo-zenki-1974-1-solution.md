...
1.  $n$が自然数の全体を動く時，$f_2(n)$のとる値を全部求めよ．

2.  あらゆる自然数$n$に対して，$f_5(n)=f_1(n)$が成り立つことを証明せよ．

3.  $n$が自然数の全体を動く時，$f_{100}(n)$のとる値を全部求めよ．
...
1.  $(10-k)^2\equiv k^2$ ゆえ，$f_2(k)=f_2(10-k)$である．故に$k=0,1,2,3,4,5$についてのみ調べ
     ればよい．
          \begin{align*}
          &f_2(0)=0 &f_2(1)=1 \\
          &f_2(2)=4 &f_2(3)=9  \\
...
2.  $n^5-n=n(n-1)(n+1)(n^2+1)$は$2$連続整数の積を因数に含むから$2$の倍数である．

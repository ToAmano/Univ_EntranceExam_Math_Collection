...
question: "1"
type: "solution"
title: "UTOKYO 1974 zenki Q1 (solution)"
---
...
2.  $n$が自然数の全体を動く時，$f_2(n)$のとる値を全部求めよ．

3.  あらゆる自然数$n$に対して，$f_5(n)=f_1(n)$が成り立つことを証明せよ．

4.  $n$が自然数の全体を動く時，$f_{100}(n)$のとる値を全部求めよ．
...
2.  $(10-k)^2\equiv k^2$ ゆえ，$f_2(k)=f_2(10-k)$である．故に$k=0,1,2,3,4,5$についてのみ調べ
     ればよい．
          

$$
\begin{align*}
&f_2(0)=0 &f_2(1)=1 \\&f_2(2)=4 &f_2(3)=9  \\&f_2(4)=6 & f_2(5)=5
\end{align*}
$$
...
3.  $n^5-n=n(n-1)(n+1)(n^2+1)$は$2$連続整数の積を因数に含むから$2$の倍数である．
...
$$
\begin{align*}
&f_4(0)=0 &f_4(1)=1 \\&f_4(2)=6 &f_4(3)=1  \\&f_4(4)=6 & f_4(5)=5
\end{align*}
$$

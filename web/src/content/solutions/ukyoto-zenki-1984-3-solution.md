...
question: "3"
type: "solution"
title: "UKYOTO 1984 zenki Q3 (solution)"
---
...
$$
をみたすt \in \mathbb{R}が存在するので, 判別式DとしてD \ge 0.
$$
 x^2 - 4y \ge 0 
$$
これを図示して, 右図斜線部.
...
をみたす(x,y)をもとめる. x=Xと固定し, 右辺g(t)の値域をもとめる. (X-1 \le t \le X+1) 右図から
$$
...
\begin{align*}
S &= \frac{1}{2}\cdot 1 \cdot 1 + \int_0^2 \left(\frac{1}{4}x^2 - x + 1\right) dx \\&= \frac{1}{2} + \frac{1}{3}\cdot\frac{1}{4}\cdot 2^3 \\&= \frac{7}{6}\quad\text{\#}
\end{align*}
$$

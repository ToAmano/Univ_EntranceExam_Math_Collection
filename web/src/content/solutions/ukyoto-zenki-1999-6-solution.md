...
question: "6"
type: "solution"
title: "UKYOTO 1999 zenki Q6 (solution)"
---
...
S + \frac{1}{2}&= \int_4^1 \frac{(p-1)^3(4-p)}{p}\cdot\frac{4-p^2}{p^2} dp \\&= \int_4^1 \frac{p^5 - 6p^4 + 5p^3 + 20p^2 - 36p + 16}{p^3} dp \\&= \int_4^1 \left( p^2 - 6p + 5 + \frac{20}{p} - \frac{36}{p^2} + \frac{16}{p^3}\right) dp \\&= \left[\frac{1}{3}p^3 - 3p^2 + 5p + 20 \log p + \frac{36}{p} - \frac{8}{p^2}\right]_4^1 \\&= -\frac{63}{3} + 3 \cdot 15 - 15 - 40 \log 2 + 27 - \frac{15}{2}\\&= 36 - 40 \log 2 - \frac{15}{2}
\end{align*}

...
<figure id="1993-2:fig:1"\> <img
src="/Univ_EntranceExam_Math_Collection/images/tikz/sample_todai/zenki/1993/2/fig_1.svg"
alt="図 1" /> <figcaption>図 1: 三角形ABCの様子</figcaption>
</figure>
...
\end{align*}$$ である．
$\eqref{1993-2:eq:1}$および半角公式より $$\begin{align}
f(l)
...
$\eqref{1993-2:eq:2}$が３つの$\theta$で最小値をとる時，
...
一定で十分である。$\eqref{1993-2:eq:3}$に値を代入して $$\begin{align*}
\begin{dcases}
y_2^2 = x_2^2+x_2+1 \\
y_2(2x_2+1) = 0
\end{dcases}
\end{align*}$$ 第二式から $y_2=0$ または $x_2=-\frac{1}{2}$ である．
$y_2=0$の時$\eqref{1993-2:eq:1}$から$y_3=0$となり$\triangle ABC$
が三角形とならず不適である．

よって$x_2=-\frac{1}{2}$
である．この時第一式から$y_2=\pm\frac{\sqrt{3}}{2}$ である．
$\eqref{1993-2:eq:1}$から$x_3 =-\frac{1}{2}, y_3=\mp\frac{\sqrt{3}}{2}$である．

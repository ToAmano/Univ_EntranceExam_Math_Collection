...
2.  $S$の輪郭を表す$xy$平面上の曲線の方程式を求めよ．

3.  円板$C$と影$S$の間に挟まれ，光の届かない部分のつくる立体の体積を求めよ．
...
2.  点光源のある点を$P$とする．題意の曲線を$C'$とし，この上の点を$Q(X,Y,0)$とする．
     題意から，$C$の中心は
...
$$
\begin{align*}
&\frac{8X^2}{(Y+2\sqrt{2})^2}+2(\dfrac{2\sqrt{2}Y}{Y+2\sqrt{2}}-\frac{\sqrt{2}}{2})^2=1 \\\therefore&8X^2+2(\frac{3\sqrt{2}}{2}Y-2)^2=(Y+2\sqrt{2})^2 \\\therefore&X^2+(Y-\sqrt{2})^2=2\cdots\text{(答)}
\end{align*}
$$

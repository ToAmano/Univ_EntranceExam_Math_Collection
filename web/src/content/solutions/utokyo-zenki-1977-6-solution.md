...
question: "6"
type: "solution"
title: "UTOKYO 1977 zenki Q6 (solution)"
---
...
2.  $l$を含み$m$に平行な平面の方程式を$ax+by+cz+d=0$の形に表せ．

3.  点$(2,0,1)$を通り$l$，$m$の両方と交わる直線を$n$とする．$l$と$n$の交点及び$m$と
     $n$の交点を求めよ．
...
2.  題意の平面$\pi$は$(1,1,0)$を通り$\vec{l}$，$\vec{m}$と平行である．この$2$ベクトル
...
3.  題意から$k=1,2$に対し実数$t_k$，$s_k$があって

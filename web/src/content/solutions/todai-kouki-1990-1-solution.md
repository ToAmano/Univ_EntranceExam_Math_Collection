...
question: "1"
type: "solution"
title: "TODAI 1990 kouki Q1 (solution)"
---
...
<figure id="1990-1:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/todai/kouki/1990/1/fig_1.svg" alt="図 1" />
...
$$
    ...
    以下$a$を消去して計算を進める．
    $\eqref{1990-1:eq:2}$から$b=2/a$だから$l$の方程式は
...
$$
    ...
    であり，$\eqref{1990-1:eq:1}$より$b$のとりうる値は
...
<figure id="1990-1:fig:2">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/todai/kouki/1990/1/fig_2.svg" alt="図 2" />
  <figcaption>図 2: $x$の値による$b$の端点と$f(b)$の軸の関係．</figcaption>
</figure>

    $\eqref{1990-1:eq:3}$の$\eqref{1990-1:eq:4}$の元での最大最小を求めればよい．
    $x=0$の時は$f(0) = b$であり，$x\neq 0$の時は
...
<figure id="1990-1:fig:3">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/todai/kouki/1990/1/fig_3.svg" alt="図 3" />
...
<figure id="1990-1:fig:4">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/todai/kouki/1990/1/fig_4.svg" alt="図 4" />
...
$$
    ...
    以下$b$を消去して計算を進める．
    $\eqref{1990-1:eq:7}$を$\eqref{1990-1:eq:5,1990-1:eq:8}$に代入して
...
<figure id="1990-1:fig:5">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/todai/kouki/1990/1/fig_5.svg" alt="図 5" />
...
<figure id="1990-1:fig:6">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/todai/kouki/1990/1/fig_6.svg" alt="図 6" />
...
<figure id="1990-1:fig:7">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/todai/kouki/1990/1/fig_7.svg" alt="図 7" />

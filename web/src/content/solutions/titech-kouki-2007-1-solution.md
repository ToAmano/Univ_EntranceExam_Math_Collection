...
$$
  ...
  だから，$n_1>0$より$f(x)$の増減表は$\eqref{2007-1:table:1}$となる．
...
$$
  ...
  以下，$\eqref{2007-1:eq:1}$を満たす整数$(n_1,n_2,n_3)$を考える．
...
$$
  ...
  という大小関係にあるから，$n_1$ に対応して$\eqref{2007-1:eq:1}$を満たす$n_3$をリストアップすると$\eqref{2007-1:table:2}$のようになる．
  \begin{table}[H]
    \centering
    \caption{$\eqref{2007-1:eq:1}$を満たす$n_1,n_3$の一覧}
...
### (2)
 題意の自然数解を $k\in\mathbb{N}$ とおくと，$f(k)=0$ゆえ
...
$$
  ...
  であるから，この上限によって一定の制限があることに注意すると，一覧は$\eqref{2007-1:table:3}$となる．
  \begin{table}[H]
    \centering

...
question: "6"
type: "solution"
title: "UTOKYO 1991 zenki Q6 (solution)"
---
...
a_n(x)=a_0(x)-\sum_{k=0}^{n-1}2^{2-4n}x^{-5}\\
          a_n(x)=f(x)-4x^{-5}\frac{1-2^{-4n}}{1-2^4}\\\limit{n}{\infty}f(x)-\frac{64}{15}x^{-5}=a(x)
\end{align*}
$$
...
$$
\begin{align*}
\dint{x}{2x}a(t)dt&=S(x)+\left[\frac{16}{15}t^{-4}\right]_x^{2x}\\&=x^{-4}+\frac{16}{15}\left(\frac{1}{16}-1\right)x^{-4}\\&=0
\end{align*}
$$

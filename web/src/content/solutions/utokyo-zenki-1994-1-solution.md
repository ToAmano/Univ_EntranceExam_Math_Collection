...
question: "1"
type: "solution"
title: "UTOKYO 1994 zenki Q1 (solution)"
---
...
2.  任意の実数$x$に対し，$f(x)>0$である．

3.  方程式$g(x)=0$はただひとつの実数解$\alpha$をもち，$-1<\alpha<0$となる．
...
$$
\begin{align*}
f(t)&=(\frac{1}{4}x+\frac{1}{16})f'(t)+\frac{1}{32}(2t^2+2t+1)  \\&=\frac{1}{32}(2t^2+2t+1) \\&=\frac{1}{32}\left\{2\left(t+\frac{1}{2}\right)^2+\frac{1}{2}\right\} >0
\end{align*}
$$
...
$$
\begin{align*}
g'(x)&\ge g'(t) \\&=\left(\frac{1}{4}x+\frac{1}{20}\right)g''(t)+
           40\left\{6\left(t+\frac{1}{3}\right)^2+\frac{1}{3}\right\}\\&=40\left\{6\left(t+\frac{1}{3}\right)^2+\frac{1}{3}\right\}>0
\end{align*}
$$
...
$$
\begin{align*}
g'(x)&=5x^4+4x^3+\frac{3}{2}x^2+\frac{1}{3}x+\frac{1}{24}\\&=5(x^2+\frac{2}{5}x)^2+\frac{7}{10}(x+\frac{5}{21})^2+\frac{3}{1512}
\end{align*}
$$

...
question: "6"
type: "solution"
title: "KYODAI 1999 kouki Q6 (solution)"
---
...
<figure id="1999-6:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/kyodai/kouki/1999/6/fig_1.svg" alt="図 1" />
...
\begin{align}
\int_{0}^{1}\{g(y)\}^2 dy
         & = \int_{0}^{\pi/2} x^2 \frac{dy}{dx} dx                              \\& = \int_{0}^{\pi/2} x^2 f'(x) dx \quad(\because x=f(y))              \\& = \int_{0}^{\pi/2} x^2 \cos x dx \quad(\because$\eqref{1999-6:eq:2}$) \\& = \left[ x^2 \sin x + 2x \cos x - 2\sin x \right]_{0}^{\pi/2}\\& = \frac{\pi^2}{4} - 2
\end{align}
$$

    となるから，$\eqref{1999-6:eq:2}$に代入して
...
$$
    ...
    である．したがって，$\eqref{1999-6:eq:3,1999-6:eq:5}$より

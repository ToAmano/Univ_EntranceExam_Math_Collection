...
question: "3"
type: "solution"
title: "UTOKYO 2006 zenki Q3 (solution)"
---
...
$$
\begin{align*}
l: y &= -X\left(x - \frac{X}{2}\right) + \frac{1}{2}\\&= -Xx + \frac{1}{2}X^2 + \frac{1}{2}
\end{align*}
$$
...
$$
\begin{align*}
(\alpha^2 - p + 1)(1 + \alpha\tan\theta) &= p\alpha(\tan\theta - \alpha) \\(\alpha^2 + 1 - 2p)\cdot\alpha\cdot\tan\theta&= - p\alpha^2 - \alpha^2 + p - 1 \\\tan\theta&= \frac{-(p+1)\alpha^2 + p - 1}{\alpha(\alpha^2 + 1 - 2p)}
\end{align*}
$$

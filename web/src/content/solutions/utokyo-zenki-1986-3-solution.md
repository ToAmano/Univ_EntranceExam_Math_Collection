...
question: "3"
type: "solution"
title: "UTOKYO 1986 zenki Q3 (solution)"
---
...
\begin{itemize}
\item $xyz$空間において，$3$点$A(0,0,1/2)$,$B(0,1/2,1)$,$C(1,0,1)$を通る平面$S_0$に垂直で，長さが$1$のベクトル$\vec{n_0}$を全て求めよ．
\item $2$点$D(1,0,0)$,$E(0,1,0)$を通る直線$l$を軸として，平面$S_0$を回転して得られる全ての平面$S$を考える．このような平面$S$に垂直で長さ$1$のベクトル$\vec{n}=(x,y,z)$の$y$成分の絶対値$|y|$は$S$と共に変化するが，その最大値及び最小値を求めよ．
\end{itemize}

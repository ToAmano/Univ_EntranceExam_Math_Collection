...
question: "4"
type: "solution"
title: "UTOKYO 1998 zenki Q4 (solution)"
---
...
**[解1]** $f(x) = \dfrac{x^2(2 \cdot 3^3 \cdot n - x)}{2^5 \cdot 3^2 \cdot n^2}$ において, $k \in \mathbb{Z}$ として,
...
$$
\begin{align*}
f(k+1) - f(k) &= \frac{1}{2^5 \cdot 3^2 \cdot n^2}\left[(k+1)^2(2 \cdot 3^3 \cdot n - k - 1) - k^2(2 \cdot 3^3 \cdot n - k) \right]\\&= \frac{1}{2^5 \cdot 3^2 \cdot n^2}\left[(2k+1)(2 \cdot 3^3 \cdot n - k) - (k+1)^2 \right]\\&= \frac{1}{2^5 \cdot 3^2 \cdot n^2}\left[ -3k^2 + (2 \cdot 3^3 \cdot n - 3)k + 2 \cdot 3^3 \cdot n - 1 \right]\quad\dots\text{①}
\end{align*}
$$
...
$$
\begin{align*}
k &= \frac{1}{6}\left[ 3(2^2 \cdot 3^2 \cdot n - 1) \pm\sqrt{9(2^2 \cdot 3^2 \cdot n - 1)^2 - 12\left(2^5 \cdot 3^2 \cdot n^2 + 1 - 2 \cdot 3^3 \cdot n\right)}\right]\\&= \frac{1}{6}\left[ 3(2^2 \cdot 3^2 \cdot n - 1) \pm\sqrt{2^4 \cdot 3^4 \cdot n^2 - 3}\right]\quad\dots\text{②}
\end{align*}
$$

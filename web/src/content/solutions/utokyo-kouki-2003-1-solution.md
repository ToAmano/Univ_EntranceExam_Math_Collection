...
question: "1"
type: "solution"
title: "UTOKYO 2003 kouki Q1 (solution)"
---
...
<figure id="2003-1:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/utokyo/kouki/2003/1/fig_1.svg" alt="図 1" />
...
$$
    ...
    $n \to \infty$ で $b_n \to 0$ だから，[(式5)](#2003-1:eq:5) の左辺，右辺共に $0$ に収束するからはさみうちの定理より
...
$$
    ...
    [(式5)](#2003-1:eq:5) の左辺が発散するから，追い出しの定理より
...
$$
    ...
    $n \to \infty$ で $b_n \to 0$ だから [(式5)](#2003-1:eq:5) の両辺共に $\left(\frac{3}{4}\pi\right)^{\frac{1}{3}}$ に収束する．
    従って挟み撃ちの定理より

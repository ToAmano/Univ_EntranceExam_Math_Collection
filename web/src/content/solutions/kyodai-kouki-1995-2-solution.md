...
question: "2"
type: "solution"
title: "KYODAI 1995 kouki Q2 (solution)"
---
...
<figure id="1995-2:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/kyodai/kouki/1995/2/fig_1.svg" alt="図 1" />
...
### (1)
  ...
  $\eqref{1995-2:eq:2,1995-2:eq:1}$より
  
$$
\begin{align*}
4\alpha_{n+1}& = 2(\alpha_n + \beta_n)                                                               \\& = 2\alpha_n + (\beta_{n-1} + \gamma_{n-1}) \quad(\because\text{$\eqref{1995-2:eq:2}$}) \\& = 2\alpha_n + 2\pi - \alpha_{n-1}\quad(\because\text{$\eqref{1995-2:eq:1}$})          \\
\end{align*}
$$
...
### (2)
  ...
  $\eqref{1995-2:eq:2,1995-2:eq:1}$を繰り返し用いて

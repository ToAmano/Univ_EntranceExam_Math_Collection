...
question: "4"
type: "solution"
title: "UTOKYO 2009 zenki Q4 (solution)"
---
...
$$
\begin{align*}
\frac{1}{2} W(a) &= \int_{0}^{s} S(\theta) ds \\&= \int_{0}^{\pi/2}\frac{1}{2}\pi c^2 \frac{ds}{d\theta} d\theta\\&= \frac{1}{2}\pi\int_{0}^{\pi/2} c^3 d\theta\\&= \frac{1}{2}\pi\int_{0}^{\pi/2}\left(\frac{3}{4}c + \frac{1}{4}c \cos 3\theta\right) d\theta\\&= \frac{1}{2}\pi\left[\frac{3}{4}s + \frac{1}{12}\sin 3\theta\right]_{0}^{\pi/2} = \frac{1}{2}\left(\frac{3}{4} - \frac{1}{12}\right)\pi = \frac{1}{3}\pi
\end{align*}
$$
...
$$
\begin{align*}
T(\theta) &= 2 \int_{-c}^{0}\left[\sqrt{a^2+c^2-x^2} - a \right] dx \\&= 2 \int_{0}^{c}\sqrt{a^2+c^2-x^2} dx - 2ac \quad\cdots(1)
\end{align*}
$$

...
question: "1"
type: "solution"
title: "SAMPLE_TITECH 2003 kouki Q1 (solution)"
---
...
<figure id="fig_1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/sample_titech/kouki/2003/1/fig_1.svg" alt="図 1" />
...
### (1)
及び $S_1, S_2, S_3 \ge 0$ から, $S_1, S_2, S_3$ 空間で, 点$(S_1, S_2, S_3)$ は
...
<figure id="2003-1:fig:2">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/sample_titech/kouki/2003/1/fig_2.svg" alt="図 2" />
...
### (2)
はありがちな関数の最大最小問題で様々な解法が考えられるところだ．

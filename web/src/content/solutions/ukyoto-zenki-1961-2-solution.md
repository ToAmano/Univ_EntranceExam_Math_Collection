...
question: "2"
type: "solution"
title: "UKYOTO 1961 zenki Q2 (solution)"
---
...
$$
\begin{align*}
BC: &(\beta + \alpha)\tan\theta\cdot(x - \alpha) + (\beta - \alpha)(y - \alpha\tan\theta) = 0 \\&(\beta + \alpha)\tan\theta\cdot x + (\beta - \alpha)y - 2\alpha\beta\tan\theta = 0 \quad\dots\text{①}
\end{align*}
$$
...
$$
\begin{align*}
l: &Xx + Yy = 0 \\&(\alpha + \beta)\tau x + (\alpha - \beta)y = 0 \quad\dots\text{⑤}
\end{align*}
$$

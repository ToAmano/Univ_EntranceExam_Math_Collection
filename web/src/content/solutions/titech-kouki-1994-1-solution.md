...
$$
  ...
  がなりたつ．[(式1)](#1994-1:eq:1)の両辺を$x$で微分して，
...
$$
  ...
  [(式1)](#1994-1:eq:1)から$F(x)=x^2 + cx$となる．(ii)から$F(1)=0$すなわち$c=-1$である．
  したがって[(式2)](#1994-1:eq:2)から$f(x)=2x-1$だが，これは(iii)の$f(0)=1$に反して矛盾．

   
  (b) $b=0$ の時

  [(式2)](#1994-1:eq:1,1994-1:eq:2)から，$F(x)$および$f(x)$は

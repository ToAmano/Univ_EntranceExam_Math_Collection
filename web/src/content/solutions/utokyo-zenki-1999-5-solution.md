...
question: "5"
type: "solution"
title: "UTOKYO 1999 zenki Q5 (solution)"
---
...
## 【解】
 ...
 (1) $A_n = {}_m\mathrm{C}_n$ とする。$m = 2^k$ の時、
...
$$
\begin{align*}
_m\mathrm{C}_r &= \frac{m!}{r!(m-r)!} = \frac{m!}{(r-1)!(m-r+1)!}\cdot\frac{m-r+1}{r}\\&= \frac{2^k(t-1)}{2^k}\cdot{}_m\mathrm{C}_{r-1} = (t-1) \cdot{}_m\mathrm{C}_{r-1}\equiv 0 \pmod 2 \quad(\because t \in\text{odd}, {}_m\mathrm{C}_{r-1}\in\mathbb{Z})
\end{align*}
$$

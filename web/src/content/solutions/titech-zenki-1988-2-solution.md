...
question: "2"
type: "solution"
title: "TITECH 1988 zenki Q2 (solution)"
---
...
**(2)** ①$\wedge|2a+b|=4$から，下図を参照して，$(a,b)=(\pm2,0)$が必要，逆にこの時，$g(x)=\pm2x^2$の値域の幅は2であり十分で，$|f(x)|\le1$となるように平行移動して$c$を定めて，$(a,b,c)=(\pm2,0,\mp1)$（複号同順）だから，
...
<figure id="fig_1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/titech/zenki/1988/2/fig_1.svg" alt="図 1" />
  <figcaption>図 1: 条件①を満たす$(a,b)$の範囲</figcaption>
</figure>

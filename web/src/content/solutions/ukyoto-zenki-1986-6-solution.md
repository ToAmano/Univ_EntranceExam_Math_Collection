...
question: "6"
type: "solution"
title: "UKYOTO 1986 zenki Q6 (solution)"
---
...
$$
\begin{align*}
S(r) &= 2SC - \alpha C^2 - (\frac{\pi}{2} - \alpha) S^2 \\&= 2SC + \alpha(S^2 - C^2) - \frac{\pi}{2} S^2 \equiv T(\alpha)
\end{align*}
$$

$$
\begin{align*}
T'(\alpha) &= 2 \cos 2\alpha - \cos 2\alpha + 2\alpha\sin 2\alpha - \frac{\pi}{4}\cdot 2 \sin 2\alpha\\&= \cos 2\alpha + 2(\alpha - \frac{\pi}{4}) \sin 2\alpha
\end{align*}
$$

$$
\begin{align*}
T''(\alpha) &= -2 \sin 2\alpha + 2 \sin 2\alpha + 4(\alpha - \frac{\pi}{4}) \cos 2\alpha\\&= 4(\alpha - \frac{\pi}{4}) \cos 2\alpha\le 0
\end{align*}
$$
...
$$
\begin{align*}
\square&= \frac{1}{2}\cdot 2 \cdot\frac{\pi}{4}\cdot\left(\frac{1}{\sqrt{2}}\right)^2 - \left(\frac{1}{\sqrt{2}}\right)^2 = \frac{\pi}{4} - \frac{1}{2}\\\square&= \frac{1}{2}\\&\Rightarrow OK!!
\end{align*}
$$
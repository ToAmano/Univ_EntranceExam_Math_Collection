...
question: "2"
type: "solution"
title: "TODAI 2003 kouki Q2 (solution)"
---
...
$$
  ...
  ここで，$A_{k},B_{k}$について，$\eqref{2003-2:eq:2}$から$A_1>0, B_1<0$だから，
  漸化式$\eqref{2003-2:eq:3}$より$A_{l}$は$l$が奇数の時のみ正，$B_{l}$は$l$が偶数の時のみ正である．
  そこで新しく
...
$$
  ...
  次に，点と直線の距離$L$について，$\eqref{2003-2:eq:4}$より
...
$$
  ...
  である．ただし最終行で$\eqref{2003-2:eq:1}$を用いた．
  ここでこの分子について
...
$$
  ...
  以上から，$l=\max(l_1,l_2)$とすると，三角不等式および$\eqref{2003-2:eq:6,2003-2:eq:7}$より
...
### (4)
  ...
  $\left[\sqrt{5}\right]=2$だから，$\eqref{2003-2:eq:5,2003-2:eq:8}$から

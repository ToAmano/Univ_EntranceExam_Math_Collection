...
question: "1"
type: "solution"
title: "UTOKYO 1993 zenki Q1 (solution)"
---
...
$$
\begin{align*}
\frac{V(l)}{\sqrt{l-2}}&= \frac{1}{\sqrt{l-2}}\cdot\frac{1}{3}\sqrt{2l^2+1}\sqrt{2l(l-2)}\sqrt{2l(l+2)}\\&= \frac{2}{3}\sqrt{2l^2+1}\cdot\sqrt{l}\cdot\sqrt{l(l+2)}\xrightarrow{l \to 2}\frac{8}{3}\quad\text{\#\#}
\end{align*}
$$
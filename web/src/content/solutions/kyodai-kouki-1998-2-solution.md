...
question: "2"
type: "solution"
title: "KYODAI 1998 kouki Q2 (solution)"
---
...
$$
  ...
  以下具体的に$f_n(x)$を求める．補題1より$\eqref{1998-2:eq:0}$の表示および$\eqref{1998-2:eq:1}$の漸化式が全ての$n$について成り立つ，
  すなわち
...
$$
  ...
  と求まる．
  これを$\eqref{1998-2:eq:2}$に代入して$c_n = \frac{b_n}{2^n}$ とおくと，
...
$$
  ...
  と書ける．初期条件は$\eqref{1998-2:eq:3}$より
...
$$
  ...
  以上$\eqref{1998-2:eq:4,1998-2:eq:5}$を$\eqref{1998-2:eq:6}$に代入して，
  求める$f_n(x)$は

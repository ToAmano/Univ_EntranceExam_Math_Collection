...
question: "6"
type: "solution"
title: "KYODAI 1995 kouki Q6 (solution)"
---
...
<figure id="1995-6:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/kyodai/kouki/1995/6/fig_1.svg" alt="図 1" />
...
$$
    ...
    図および $\eqref{1995-6:eq:3,1995-6:eq:4}$から
...
$$
    ...
    従って求めるべき条件は$\eqref{1995-6:eq:6,1995-6:eq:7}$であり，
    図示して[図2](#1995-6:fig:2)となる．$\cdots$(答)

    

<figure id="1995-6:fig:2">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/kyodai/kouki/1995/6/fig_2.svg" alt="図 2" />

...
question: "6"
type: "solution"
title: "UKYOTO 1970 zenki Q6 (solution)"
---
...
[**解**] (イ) 帰納法で示す. $n=2$ の時 成立. $n=k$ での成立を仮定すると
...
$$
\begin{align*}
|x_{n+1} - 1| &= \frac{1}{3}(x_n^2 + 2) - 1 = \frac{1}{3}(x_n + 1)(x_n - 1) \\&< \frac{1}{3}(a + 1)(x_n - 1) \quad(\because(\text{イ}))
\end{align*}
$$

...
とおく．$f$x$$の三次の係数が正だから，$g$x$$の解の数によって関数$f$x$$の概形が\ref{1}の4パターンに変化する．
...
$$
 ...
 である．
$ab$平面にこの条件を図示すれば，\ref{2}の斜線部が求める答えである．
ただし，実線部および境界を含む．
...
結果的に\ref{1}のように5パターンの場合わけを処理すれば解答に辿り着ける．

簡単な検算としては，$f$0$=ab$で，これが条件より$0$以上なので$ab\ge 0$であり，
最後の\ref{2}はこの条件を満たしているのでぱっと見大丈夫そうなのが確認できる．

...
question: "2"
type: "solution"
title: "TITECH 2003 kouki Q2 (solution)"
---
...
<figure id="fig_1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/titech/kouki/2003/2/fig_1.svg" alt="図 1" />
...
$$
  ...
  (1)
  [(式4)](#2003-2:eq:4)を用いて$N(m+6)$を計算すると
...
$$
  ...
  とおくと，$f(m)$が[(式4)](#2003-2:eq:4)に等しいことを証明すれば良い．
  ...
  この時，$m=3k$とおいて$f(m)$と[(式4)](#2003-2:eq:4)をそれぞれ計算すると
...
$$
  ...
  この時，$m=3k+1$とおいて$f(m)$と[(式4)](#2003-2:eq:4)をそれぞれ計算すると
...
$$
  ...
  この時，$m=3k+2$とおいて$f(m)$と[(式4)](#2003-2:eq:4)をそれぞれ計算すると
...
## 【解説】
  ...
  ただ，この問題はそのような道具を導入せずとも，[(式1)](#2003-2:eq:1)さえ出ていれば
  $\mod 6$で場合分けすれば正解を導ける．
  場合わけの数は増えてしまうが，計算量はあまり増えないので有力だ．
  以下別解として示そう．

  (1)
  [(式1)](#2003-2:eq:1)に注意して $m$ を $6$ で割ったあまりで場合分けする.
  $t \in \mathbb{N}$ として，
...
$$
  ...
  である．
  [(式3)](#2003-2:eq:2,2003-2:eq:3)を比較することで，

...
question: "2"
type: "solution"
title: "TITECH 1985 zenki Q2 (solution)"
---
...
**(1)** $t$にまって，切断面は変化する直方体の頂点を通る．$\pi(t): x+\dfrac12y+\dfrac13z=t$とおく．$V$の体積は$T=6$である $\cdots$①
...
**(2)** $h(t)=t^3,\ P(t)=6-g(t)$とおく．以下$h\to0$と扱う．$f(t)$は各区間で連続である．

...
question: "1"
type: "solution"
title: "UKYOTO 2000 zenki Q1 (solution)"
---
...
$$
\begin{align*}
|\vec{p}|^2 &= (1-k)^2|\vec{a}|^2 + k^2(1-p)^2|\vec{b}|^2 + k^2p^2|\vec{c}|^2 + 2\Big[k(1-k)(1-p)\vec{a}\cdot\vec{b} + k^2p(1-p)\vec{b}\cdot\vec{c} + k(1-k)p\vec{a}\cdot\vec{c}\Big]\\&= \{p^2+(1-p)^2\}k^2 + k^2 - 2k + 1 - \left\{p(1-p)k^2 + k(1-k)p + (1-p)k(1-k)\right\}\\&= (p^2-2p+2)k^2 - 2k + 1 - \left\{(-p^2+p-1)k^2 + k\right\}\\&= 3(p^2-p+1)k^2 - 3k + 1 = 1
\end{align*}
$$
...
$$
\begin{align*}
\overrightarrow{AP}&= -\frac{1}{p^2-p+1}\vec{a} + \frac{1-p}{p^2-p+1}\vec{b} + \frac{p}{p^2-p+1}\vec{c}\\&= \frac{1-p}{p^2-p+1}\overrightarrow{AB} + \frac{p}{p^2-p+1}\overrightarrow{AC}
\end{align*}
$$

...
question: "3"
type: "solution"
title: "TODAI 2001 kouki Q3 (solution)"
---
...
<figure id="2001-3:fig:0">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/todai/kouki/2001/3/fig_1.svg" alt="図 1" />
...
<figure id="2001-3:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/todai/kouki/2001/3/fig_2.svg" alt="図 2" />
  <figcaption>図 2: 関数$y=f(x)$の平均変化率の定義</figcaption>
</figure>

  さて$\eqref{2001-3:eq:3}$より$f(k), f(k+1) \in \mathbb{Z}$ だから，$f(k) \le y \le f(k+1)$ の間には $f(k+1)-f(k)$ 個の
  整数で区切られた区間
...
<figure id="2001-3:fig:3">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/todai/kouki/2001/3/fig_3.svg" alt="図 3" />
...
$$
  ...
  が成り立つ．$\eqref{2001-3:eq:7}$を代入して$k$が十分大きい時$f'>0$に注意して
...
$$
  ...
  ここに$f'(x) = 2Ax+B$および$\eqref{2001-3:eq:6}$を代入して

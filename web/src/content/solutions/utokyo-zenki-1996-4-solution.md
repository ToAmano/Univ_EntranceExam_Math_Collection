...
question: "4"
type: "solution"
title: "UTOKYO 1996 zenki Q4 (solution)"
---
...
2.  $a_n$の期待値を$E(n)$とするとき，$\dlim{n}{\infty}E(n)$をもとめよ．

3.  $a_1,a_2,\dots ,a_n$のうち$2$に等しいものの個数の期待値を$N(n)$とするとき，
...
2.  $k$を$1$から$6$までの整数とする．$a_n=k$となる確率は$n=1$のとき$\dfrac{1}{6}$

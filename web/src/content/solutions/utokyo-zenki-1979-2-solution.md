...
question: "2"
type: "solution"
title: "UTOKYO 1979 zenki Q2 (solution)"
---
...
$$
\begin{align*}
V_D &= \frac{1}{3}\cdot\pi s^2 \cdot h - \pi\int_c^1 (1-x^2) \, dx \\&= \frac{1}{3}\pi s^2 \left(\frac{1}{c} - c\right) - \pi\left[\frac{2}{3} - c + \frac{1}{3} c^3 \right]\quad(\because\text{①}) \\&= \frac{1}{3}\pi\left[\frac{s^2(1-c^2)}{c} + 3c - c^3 - 2 \right] = \frac{1}{3}\pi\frac{c^2-2c+1}{c}\quad\dots\text{②}
\end{align*}
$$
...
$$
\begin{align*}
& V_D = \frac{2}{3}\pi\\\iff&\frac{c^2-2c+1}{c} = 2 \\\iff&c = 2 - \sqrt{3}\quad(\because 0 < c < 1) \quad\dots\text{③}
\end{align*}
$$

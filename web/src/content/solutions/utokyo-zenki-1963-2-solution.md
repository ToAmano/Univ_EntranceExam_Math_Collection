...
question: "2"
type: "solution"
title: "UTOKYO 1963 zenki Q2 (solution)"
---
...
[**解**] $l$ が $x$ 軸に一致し、$P(0, \sqrt{3}+1)$ となるよう $xy$ 平面をおく。
...
$$
\begin{align*}
S_1 &= 2 \int_{2}^{2\sqrt{3}}\sqrt{16-x^2}\, dx \\&= 2 \int_{\frac{\pi}{6}}^{\frac{\pi}{3}} 16 \cos^2 \theta\, d\theta\\&= 16 \left[\theta + \frac{1}{2}\sin 2\theta\right]_{\pi/6}^{\pi/3}\\&= \frac{8}{3}\pi
\end{align*}
$$
...
$$
\begin{align*}
S_2 &= (\text{扇形}) - (\text{三角形}) \\&= \frac{1}{2}\cdot\frac{\pi}{2}\cdot(2\sqrt{2})^2 - \frac{1}{2}\cdot 2 \cdot 2 \cdot 2 \\&= 2\pi - 4
\end{align*}
$$

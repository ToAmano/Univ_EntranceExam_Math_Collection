...
question: "1"
type: "solution"
title: "UTOKYO 2006 kouki Q1 (solution)"
---
...
1.  $x=0 \iff t=0, -2$ に対応する点は $(0,0)$, $(0,6)$．

2.  $y=0 \iff t=0, -\frac{1}{2}$ に対応する点は $(0,0)$, $(-\frac{3}{4},0)$．

3.  $\frac{dy}{dx}=0 \iff t = -\frac{1}{4}$ に対応する点は $(-\frac{7}{16}, -\frac{1}{8})$．
...
<figure id="2006-1:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/utokyo/kouki/2006/1/fig_1.svg" alt="図 1" />
...
<figure id="2006-1:fig:2">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/utokyo/kouki/2006/1/fig_2.svg" alt="図 2" />

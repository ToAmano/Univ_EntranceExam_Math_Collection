...
1.  $\overrightarrow{OP}\perp\overrightarrow{OA}$，$\overrightarrow{OP}\perp\overrightarrow{OB}$，
$\overrightarrow{OP}\cdot\overrightarrow{OC}=1$を満たす点$P$の座標を求めよ。

2.  点$P$から直線$AB$に垂線を下ろし，その垂線と直線$AB$の交点を$H$とする。
$\overrightarrow{OH}$を$\overrightarrow{OA}$と$\overrightarrow{OB}$を用いて表せ。

3.  点$Q$を$\displaystyle\overrightarrow{OQ}=\frac{3}{4}\overrightarrow{OA}+\overrightarrow{OP}$に

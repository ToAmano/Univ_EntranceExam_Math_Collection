...
question: "5"
type: "solution"
title: "UTOKYO 2006 zenki Q5 (solution)"
---
...
$$
\begin{align*}
\frac{1}{n}\sum_{k=1}^n a_k &< \frac{1}{n}\left(\frac{1}{2} + \sum_{k=2}^n \frac{1}{2k}\right) < \frac{1}{2n}\left( 1 + \int_1^n \frac{1}{x} dx \right)\\\therefore\ \frac{1}{n}\sum_{k=1}^n a_k &< \frac{1 + \log n}{2n}\to 0 \quad(n \to\infty)
\end{align*}
$$

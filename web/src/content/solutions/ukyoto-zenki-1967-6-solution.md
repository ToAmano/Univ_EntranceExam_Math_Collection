...
question: "6"
type: "solution"
title: "UKYOTO 1967 zenki Q6 (solution)"
---
...
[**解**] $y_1 = f(x) = \frac{\pi}{4}\frac{1}{x} - \frac{\pi}{4} + 1$, $y_2 = g(x) = \sqrt{2}\cos \frac{\pi}{4}x$ とおく。

1.  $y_1 - y_3 = \frac{\pi}{4}\frac{1}{x} - \frac{\pi}{4} + 1 - \frac{\pi}{4} + \frac{\pi}{4}x - 1 = \frac{\pi}{4}\left(x + \frac{1}{x} - 2\right)$ であり, $0 < x \le 1$ では
    AM-GMから
...
3.  $\int_0^{1/2} \left(1 + \frac{\pi}{4}\right) dx = \frac{1}{2}\left(1 + \frac{\pi}{4}\right)$

4.  $\int_{1/2}^1 f(x) dx = \left[ \frac{\pi}{4}\log x + \left(1-\frac{\pi}{4}\right)x \right]_{1/2}^1 = \frac{\pi}{4}\log 2 + \frac{1}{2}\left(1-\frac{\pi}{4}\right)$

5.  $\int_0^1 g(x) dx = \sqrt{2} \frac{4}{\pi} \left[ \sin\frac{\pi}{4}x \right]_0^1 = \frac{4}{\pi}$
    \end{itemize}
    を③に代入して

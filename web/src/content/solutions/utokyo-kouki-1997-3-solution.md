...
question: "3"
type: "solution"
title: "UTOKYO 1997 kouki Q3 (solution)"
---
...
$$
  ...
  となる．[(式1)](#1997-3:eq:1)から，$m=0$の時もこの表現で良い．
...
$$
  ...
  である．
  また，差[(式3)](#1997-3:eq:3)を有効数字$1$桁で計算すると
...
$$
  ...
  だから，$f(x)$の増減表は[表1](#1997-3:table:1)となる．
  

<figure id="1997-3:table:1" class="table-wrapper">
...
| $f$  |       | $\nearrow$ |                    | $\searrow$ |            |
  ...
  [(式4)](#1997-3:eq:4)も考慮すると，$f(x)$は$x=frac{10^4}{3} = 3333.3\cdots$で最大値をとる．
...
$$
  ...
  [(式4)](#1997-3:eq:4)より$N=10000$と$N=20000$の時は$P_N$は同じ値を取る．

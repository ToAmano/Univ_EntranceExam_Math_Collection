...
\(1\) [図1](#1995-1:fig:1)のように，立方体の頂点A, B, C, D, E, F, G,
...
<figure id="1995-1:fig:1"\> <img
src="/Univ_EntranceExam_Math_Collection/images/tikz/sample_titech/kouki/1995/1/fig_1.svg"
alt="図 1" /> <figcaption>図 1: 立方体と頂点の定義</figcaption>
</figure>

<figure id="1995-1:fig:2"\> <img
src="/Univ_EntranceExam_Math_Collection/images/tikz/sample_titech/kouki/1995/1/fig_2.svg"
alt="図 2" /> <figcaption>図 2: 断面AEGC</figcaption> </figure>

半径$r_n$に関する漸化式を導出することで$r_n$の一般項を求める．
円$S_n$と$S_{n+1}$に着目して[図3](#1995-1:fig:3)を考える．

<figure id="1995-1:fig:3"\> <img
src="/Univ_EntranceExam_Math_Collection/images/tikz/sample_titech/kouki/1995/1/fig_3.svg"
alt="図 3" /> <figcaption>図 3: $S_n$と$S_{n+1}$の関係</figcaption>
</figure>

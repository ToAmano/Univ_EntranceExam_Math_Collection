...
question: "5"
type: "solution"
title: "UKYOTO 1984 zenki Q5 (solution)"
---
...
$$
だから r=1,2,3,\dots,sの時, 一部をAとして,
$$

\begin{align*}
p_r - p_{r+1}&= A \cdot\frac{r}{r+s-(r-1)} - A \cdot\frac{s-(r-1)}{r+s-(r-1)}\cdot\frac{r}{r+s-r}\\&= A r \frac{r-1}{(r+s-r)(r+s-r+1)}\ge 0 \quad\cdots *1
\end{align*}
...
1^\circの時の, p_k \ge p_{k+1} \ (k=1,2 \dots 2s-1) とした式全てで
等号が成立する時である. この時まず*1での成立が必要で,
*2の等号が成立し, r \ge 1, s \ge 0から r=1が必要. この時 s=1なら坊.
s \ge 2の時, *2の等号もrによらず成立し, r=1である.
よって, もとめる条件は r=1, s \in \text{odd} \hfill \#

(2) Aが勝者となるのは, 2k-1 \ (k \in \mathbb{N}, \ 1 \le 2k-1 \le s+1) 回目に
はじめて赤玉を引く確率で, これをP_A, Bが勝者となる確率をP_Bとおくと
...
$$
 P_A \ge P_B 
$$
これとP_A + P_B = 1から, P_A \ge \frac{1}{2}
...
$$
であり, 同様に p_1 \ge p_2, \dots などとした式と p_{2s'+1} \ge 0から,
$$

...
question: "4"
type: "solution"
title: "UKYOTO 1998 kouki Q4 (solution)"
---
...
$$
  ...
  だから，[(式3)](#1998-4:eq:3)に注意して$n\to\infty$の極限を取ると
...
$$
  ...
  (2) (1)と同様に $n\alpha_n$ の極限を求めれば良い．
  [(式1)](#1998-4:eq:1)の両辺に $\alpha_n$ をかけて整理すると
...
$$
  ...
  である．
  (1)から $n\to\infty$ の時 $\alpha_n \to 0$ だから

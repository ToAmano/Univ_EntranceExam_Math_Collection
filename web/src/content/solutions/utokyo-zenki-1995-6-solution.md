...
question: "6"
type: "solution"
title: "UTOKYO 1995 zenki Q6 (solution)"
---
...
$$
\begin{align}
S&=\frac{1}{2}\left|\frac{ab}{AB}+\frac{ab}{AB}\right|\nonumber\\&=\frac{ab}{AB}\nonumber\\&=ab \ \ \ \left(\because AB=\frac{X^2}{a^2}-\frac{Y^2}{b^2}=1\right)\label{1}
\end{align}
$$
...
$$
\begin{align*}
\frac{dS}{dp}&=20p^3+6=\frac{2}{p^3}\\&=\frac{2}{p^3}(5p^3-1)(2p^3+1)
\end{align*}
$$
...
$$
\begin{align*}
\min S&=5\left(\frac{1}{5}\right)^{4/3}+6\left(\frac{1}{5}\right)^{1/3}+5^{2/3}\\&=7\left(\frac{1}{5}\right)^{1/3}+5^{2/3}\cdots\text{(答)}
\end{align*}
$$

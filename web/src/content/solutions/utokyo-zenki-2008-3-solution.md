...
question: "3"
type: "solution"
title: "UTOKYO 2008 zenki Q3 (solution)"
---
...
$$
\begin{align*}
V &= \int_0^1 \frac{\pi}{3}(t^2 - t + 1) \cdot\frac{\sqrt{6}}{3}\, dt \\&= \frac{\sqrt{6}\pi}{9}\left[\frac{1}{3}t^3 - \frac{1}{2}t^2 + t \right]_0^1 \\&= \frac{5\sqrt{6}}{54}\pi\hfill\text{\#}
\end{align*}
$$
...
**[解2]** (2) $G_1 G_2$ の中点を $O$ とし、$\triangle OAG_1$ に三平方の定理を用いて
...
$$
\begin{align*}
\overline{PH}^2 &= \left(\frac{\sqrt{3}}{3}\right)^2 + \left(\frac{\sqrt{3}}{3}t\right)^2 - 2 \cdot\frac{\sqrt{3}}{3}\cdot\frac{\sqrt{3}}{3}t \cos 60^\circ\\&= \frac{1}{3}(t^2 - t + 1)
\end{align*}
$$

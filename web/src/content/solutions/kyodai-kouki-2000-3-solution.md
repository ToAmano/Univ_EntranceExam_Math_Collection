...
### (2)
と同様に，$(\alpha, \beta)$を$L$上の格子点として，$\alpha,\beta>0$とする．
  このような点が存在することを示す．
...
$$
  ...
  以上$\eqref{2000-3:eq:2,2000-3:eq:3}$を$\eqref{2000-3:eq:1}$に代入して
...
$$
  ...
  また，$\eqref{2000-3:eq:3}$の$\alpha$の値域と，$k>a(a^2+1)$から
...
$$
  ...
  となり，確かに$\eqref{2000-3:eq:4}$を満たす $l \in \mathbb{Z}$ は存在する．
  よって示された．$\cdots$(答)
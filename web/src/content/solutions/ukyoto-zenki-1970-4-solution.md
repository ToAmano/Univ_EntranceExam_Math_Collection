...
question: "4"
type: "solution"
title: "UKYOTO 1970 zenki Q4 (solution)"
---
...
[**解**] $\angle AOB = \alpha, AP = x, BP = y$ とする ($r \ge l$). 又, $\angle PAB = \beta, \angle PBA = \delta$ とおく.
...
$$
\begin{align*}
(x+y)^2 &= 4l^2 - 2xy \cos\frac{\alpha}{2} + 2xy \\&= 4l^2 + 4r\left(r - \sqrt{r^2 - l^2}\right)\left(1 - \cos\frac{\alpha}{2}\right)\quad\dots\text{③}
\end{align*}
$$
...
$$
\begin{align*}
(x+y)^2 &= 4l^2 + 4\left(r - \sqrt{r^2 - l^2}\right)^2 \\&= 4\left[ l^2 + r^2 + r^2 - l^2 - 2r\sqrt{r^2 - l^2}\right]\\&= 8\left(r^2 - r\sqrt{r^2 - l^2}\right)
\end{align*}
$$
...
$$
\begin{align*}
4l^2 &= x^2 + y^2 - 2xy \cos\frac{\alpha}{2}\quad\dots\text{①}\\\frac{2l}{\sin\frac{\alpha}{2}}&= 2r \quad\dots\text{⑥}
\end{align*}
$$
...
$$
\begin{align*}
(x+y)^2 &= 4l^2 + 2xy \cos\frac{\alpha}{2} + 2xy \\&= 4l^2 + 4r\left(r - \sqrt{r^2 - l^2}\right)\left(1 + \sqrt{1 - \left(\frac{l}{r}\right)^2}\right)\\&= 4l^2 + 4\left(r^2 - (r^2 - l^2)\right)\\&= 8l^2
\end{align*}
$$

...
question: "3"
type: "solution"
title: "TODAI 1987 zenki Q3 (solution)"
---
...
$$
\begin{align*}
&a(x-a)+b(y-b)+(c-1)(z-c)=0 \\\therefore\ &ax+by+(c-1)z-c=0　\tag{$\because\eqref{1}$}
\end{align*}
$$
...
$$
\begin{align*}
S&=\frac{1}{2}\sqrt{|\vector{CA}|^2|\vector{CB}|^2-(\vector{CA}\cdot\vector{CB})^2}\\&=\frac{1}{2}\sqrt{(p^2+r^2)(q^2+r^2)-r^4}\\&=\frac{1}{2}\sqrt{(pqr)^2(\frac{1}{p^2}+\frac{1}{q^2}+\frac{1}{r^2})}\\&=\frac{1}{2}\frac{pqr}{c}\tag{$\because\eqref{1},\eqref{2}$}
\end{align*}
$$
...
$$
\begin{align}
S&=\frac{c^2}{ab(c-1)}\nonumber\\&\ge\frac{1}{2c-c^2}\frac{c^2}{c-1}\nonumber\\&=\frac{1}{3-(c+2/c)}\nonumber\\&\ge\frac{1}{3-2\sqrt{2}}\tag{$\because$AM-GM}\\&=3+2\sqrt{2}\label{3}
\end{align}
$$

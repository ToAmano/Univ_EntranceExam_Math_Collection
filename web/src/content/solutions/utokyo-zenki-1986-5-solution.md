...
question: "5"
type: "solution"
title: "UTOKYO 1986 zenki Q5 (solution)"
---
...
$$
\begin{align*}
q &= {}_n\text{C}_k \left(\frac{2}{3}\right)^k \left(\frac{1}{3}\right)^{n-k} - 2 \cdot{}_{n-1}\text{C}_{k-1}\left(\frac{1}{3}\right)^k \left(\frac{1}{3}\right)^{n-k-1}\cdot\left(\frac{1}{3}\right)\\&= {}_n\text{C}_k \left(\frac{1}{3}\right)^n \cdot 2^k - 2 \left(\frac{n-k}{n}\right){}_n\text{C}_k \left(\frac{1}{3}\right)^n \\&= 2 {}_n\text{C}_k \left(\frac{1}{3}\right)^n \left( 2^{k-1} - 1 + \frac{k}{n}\right)
\end{align*}
$$
...
$$
\begin{align*}
P(x, y) = \begin{cases}{}_n\text{C}_x {}_{n-x}\text{C}_y \left(\frac{1}{3}\right)^n & (x, y \le k-1) \\
...
$$
\begin{align*}
P &= \sum_{x, y \le 2} P(x, y) \\&= P(0,0) + P(1,0) + P(0,1) + P(2,0) + P(1,1) + P(0,2) + P(2,1) + P(1,2) + P(2,2) \\&= P(0,0) + 2 P(1,0) + 2 P(2,0) + P(1,1) + 2 P(2,1) + P(2,2) \\&= \left(\frac{1}{3}\right)^n \left[ 1 + 2n + n(n-1) + n(n-1) + n(n-1)(n-2) + \frac{1}{4}n(n-1)(n-2)(n-3) \right]\\&= \left(\frac{1}{3}\right)^n \frac{1}{4}\left[ n^4 - 2n^3 + 7n^2 + 2n + 4 \right]\quad\dots\text{④}
\end{align*}
$$

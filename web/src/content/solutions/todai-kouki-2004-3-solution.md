...
$$
  ...
  だから，$\eqref{2004-3:eq:1}$と連立して$y$を消去すると
...
$$
  ...
  である．
  ついで$\sin\theta = 0$の場合，$\eqref{2004-3:eq:3}$に代入して$x = 0,-2$であり，この時$\eqref{2004-3:eq:1,2004-3:eq:2}$から$y=\pm 1$である．
  よってこの場合も$\eqref{2004-3:eq:4}$の表現で良い．
...
$$
  ...
  $P$がB上の点になる時，$l$がBの中心$(1,0)$を通るから$\eqref{2004-3:eq:2}$に$(1,0)$を代入して
...
$$
  ...
  次に$P$が$y$軸上にある時つまり$X=0$の時，$\eqref{2004-3:eq:6}$より
  $\theta=\frac{\pi}{4}$である．
...
$$
  ...
  次に$\eqref{2004-3:eq:9}$の第二，第三項について
...
$$
  ...
  $\eqref{2004-3:eq:11,2004-3:eq:12}$を$\eqref{2004-3:eq:9}$に代入して
...
$$
  ...
  だから，$\eqref{2004-3:eq:5}$に代入して求める面積$V$は

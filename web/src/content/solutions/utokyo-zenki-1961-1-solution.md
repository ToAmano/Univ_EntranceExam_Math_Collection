...
question: "1"
type: "solution"
title: "UTOKYO 1961 zenki Q1 (solution)"
---
...
2.  $3$点$P$，$Q$，$R$が一直線上に来るまでの時間　\\
     および

3.  $\triangle PQR$の面積が$\triangle AOB$の面積に等しくなるまでの時間
...
$$
\begin{align*}
&P(t+1,0) \\&Q(\dfrac{3}{2}t,\dfrac{\sqrt{3}}{2}t) \\& R(t+\dfrac{1}{2},\sqrt{3}t+\dfrac{\sqrt{3}}{2})
\end{align*}
$$
...
2.  $\vector{PQ}\parallel\vector{PR}$となればよい．故に$k\in\mathbb{R}$として
          

$$
\begin{align*}
\vector{PQ}=&k\vector{PR}\\\vtwo{\dfrac{1}{2}t-1}{\frac{\sqrt{3}}{2}t}=&k\vtwo{-\frac{1}{2}}{\sqrt{3}t+\frac{\sqrt{3}}{2}}
\end{align*}
$$
...
3.  $\triangle AOB$の面積は$\dfrac{\sqrt3}{4}\,\mathrm{cm^2}$であるから，時刻$t$での
...
$$
\begin{align*}
&\left|t^2-t-1\right|=1 \\&\therefore  t=1,2 \cdots\text{(答)}
\end{align*}
$$

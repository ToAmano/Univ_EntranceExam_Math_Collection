...
question: "2"
type: "solution"
title: "UTOKYO 1998 zenki Q2 (solution)"
---
...
$$
\begin{align*}
\sum_{k=1}^n (k+n)(k+1+n) &= \frac{1}{3}\sum_{k=1}^n \left\{(k+n)(k+1+n)(k+n+2) - (k+n-1)(k+n)(k+n+1) \right\}\\&= \frac{1}{3}\left\{(2n)(2n+1)(2n+2) - n(n+1)(n+2) \right\} = \frac{n(n+1)}{3}(7n + 2) \\\sum_{k=1}^n (k-n)(k-n-1) &= \frac{1}{3}\sum_{k=1}^n \left\{(k+1-n)(k-n)(k-1-n) - (k-n)(k-1-n)(k-2-n) \right\}\\&= \frac{1}{3}\left\{ -(-1)(-n)(-1-n) \right\} = \frac{1}{3} n(n+1)(n-1)
\end{align*}
$$
...
$$
\begin{align*}
\frac{f(n)}{n^3}&= \frac{S(0)}{n^3} + 2 \left[\left(2 + \frac{1}{n}\right)^2 - \frac{1}{3}\left(1 + \frac{1}{n}\right)\left(7 + \frac{2}{n}\right) - \frac{1}{3}\left(1 + \frac{1}{n}\right)\left(1 - \frac{1}{n}\right)\right]\\&\xrightarrow{n \to \infty} 0 + 2 \left[ 4 - \frac{7}{3} - \frac{1}{3}\right] = \frac{8}{3}\quad\left(\because\frac{S(0)}{n^3}\to 0 \right)
\end{align*}
$$

...
question: "6"
type: "solution"
title: "UTOKYO 1999 zenki Q6 (solution)"
---
...
$$
\begin{align*}
\int_0^\pi e^x \sin^2 x \, dx &= \int_0^\pi e^x \frac{1 - \cos 2x}{2}\, dx \\&= \frac{1}{2}[ e^x ]_0^\pi - \frac{1}{2}\cdot\frac{1}{1+4}[ e^x (\cos 2x + 2\sin 2x) ]_0^\pi\\&= \frac{1}{2}(e^\pi - 1) - \frac{1}{10}(e^\pi - 1) \\&= \frac{4}{10}(e^\pi - 1)
\end{align*}
$$
...
$$
\begin{align*}
e^\pi&> e^3(\pi - 3) + e^3 = e^3(\pi - 2) \\&> (2.71)^3 \cdot 1.14 \quad(\because\text{題意}) \\&= 22.68\dots > 21
\end{align*}
$$

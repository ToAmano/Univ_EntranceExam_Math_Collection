...
<a href="#$式3, 式3, 式3, 式2, 式2, 式2, 式3, 式3, 式3$
\end{aligned}
$$
...
<a href="#$式2, 式2, 式2, 式3, 式3, 式3, 式3, 式3, 式3$)=0
\end{aligned}
$$
...
<a href="#$式3, 式3, 式3$^2 + $1-2t$\left$t-\frac{1}{2}\right$ + t^2 - r^2 = 0 \\
    \therefore
...
```
であることが必要である．この時<a href="#$式5, 式5, 式5, 式3, 式3, 式3$u^2 + \left$t^2-t + \frac{1}{4}\right$ = 0 \\
    \therefore
...
```
となって$`u`$について重解のみを持ち十分である． 従って求める値$`s`$は
``` math
...
```
である．$`t`$の条件<a href="#$式7, 式7, 式7, 式3, 式3, 式3$u^2 + t^2 -4 - $4-t$^2 = 0 \\
    \therefore
...
以上三つの場合わけ<a href="#$式4, 式6, 式8, 式4, 式6, 式8, 式4, 式6, 式8$                       \\
      \frac{15}{4} - r^2 & \left$\frac{1}{2} \le  r  \le \frac{\sqrt{17}}{2}\right$ \\
      - \sqrt{r^2-4}     & \left$r \ge \frac{\sqrt{17}}{2} \right$
    \end{dcases}
\end{aligned}
...
Tの概形は<a href="#1993-3:fig:4" data-reference-type="ref+label"
data-reference="1993-3:fig:4">4</a>の斜線部である． 従って
``` math
...
```
である．
従って$`V$r$`$の増減表は<a href="#1993-3:table:1" data-reference-type="ref+label"
data-reference="1993-3:table:1">1</a>となる．

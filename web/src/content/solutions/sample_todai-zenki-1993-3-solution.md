...
$$
\begin{align}
& \sqrt{t-\frac{1}{2}}\le 2          \\\therefore& t - \frac{1}{2}\le 4               \\\therefore& t \le\frac{9}{2}\label{1993-3:eq:5}
\end{align}
$$
...
\begin{align}
s
     & = 4 - t                                                                                                           \\& = 4 - \left(r^2 + \frac{1}{4}\right)\\& = \frac{15}{4} - r^2                 & \left(\frac{1}{2}\le  r  \le\frac{\sqrt{17}}{2}\right)\label{1993-3:eq:6}
\end{align}
$$
...
\begin{align}
s
     & = 4 - t                                                                      \\& = - \sqrt{r^2-4}& \left(r \ge\frac{\sqrt{17}}{2}\right)\label{1993-3:eq:8}
\end{align}
$$

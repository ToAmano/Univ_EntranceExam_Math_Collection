...
(1993-3:eq:3\)に代入して \begin{align*}
    ...
    \therefore
     & t = r^2 + \frac{1}{4}
\end{align*}
であることが必要である．この時(1993-3:eq:5\)より \begin{align*}
...
逆にこの時，(1993-3:eq:3\)は \begin{align*}
...
この時(1993-3:eq:5\)より，円の中心の$y$座標が \begin{align}
    t \ge \frac{9}{2} 
...
\begin{align*}
    ...
    (4-t)^2 = r^2 -4
\end{align*}
である．$t$の条件(1993-3:eq:7\)から$r$の条件は \begin{align*}
    r^2 -4 \ge \frac{1}{4} \\
    r \ge \frac{\sqrt{17}}{2}
\end{align*} である．

この時円と放物線を連立した(1993-3:eq:3\)は \begin{align*}

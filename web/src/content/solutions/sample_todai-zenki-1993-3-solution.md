...
<figure id="1993-3:fig:1"\> <img
src="/Univ_EntranceExam_Math_Collection/images/tikz/sample_todai/zenki/1993/3/fig_1.svg"
alt="図 1" /> <figcaption>図 1: $1^{\circ}$の場合．</figcaption>
</figure>

<figure id="1993-3:fig:2"\> <img
src="/Univ_EntranceExam_Math_Collection/images/tikz/sample_todai/zenki/1993/3/fig_2.svg"
alt="図 2" /> <figcaption>図 2: $2^{\circ}$の場合．</figcaption>
</figure>

<figure id="1993-3:fig:3"\> <img
src="/Univ_EntranceExam_Math_Collection/images/tikz/sample_todai/zenki/1993/3/fig_3.svg"
alt="図 3" /> <figcaption>図 3: $3^{\circ}$の場合．</figcaption>
</figure>
...
$\eqref{1993-3:eq:3}$に代入して $$\begin{align*}
t^2-r^2 = 0
...
$\eqref{1993-3:eq:2}$から $$\begin{align*}
u =
\begin{dcases}
0 \\
\sqrt{t-\frac{1}{2}}
...
この時$\eqref{1993-3:eq:3}$は $$\begin{align*}
u^2(u^2+(1-2t))=0
\end{align*}$$
...
& t = r^2 + \frac{1}{4}
\end{align*}$$
であることが必要である．この時$\eqref{1993-3:eq:5}$より $$\begin{align*}
...
逆にこの時，$\eqref{1993-3:eq:3}$は $$\begin{align*}
...
この時$\eqref{1993-3:eq:5}$より，円の中心の$y$座標が $$\begin{align}
...
(4-t)^2 = r^2 -4
\end{align*}$$
である．$t$の条件$\eqref{1993-3:eq:7}$から$r$の条件は $$\begin{align*}
r^2 -4 \ge \frac{1}{4} \\
r \ge \frac{\sqrt{17}}{2}
\end{align*}$$ である．

この時円と放物線を連立した$\eqref{1993-3:eq:3}$は $$\begin{align*}
...
<figure id="1993-3:fig:4"\> <img
src="/Univ_EntranceExam_Math_Collection/images/tikz/sample_todai/zenki/1993/3/fig_4.svg"
alt="図 4" /> <figcaption>図 4: Tは斜線部．</figcaption>
</figure>

Tの概形は[図4](#1993-3:fig:4)の斜線部である． 従って $$\begin{align*}
V(r)
...
\end{dcases}
\end{align*}$$ である．
従って$V(r)$の増減表は[1](#1993-3:table:1)となる．

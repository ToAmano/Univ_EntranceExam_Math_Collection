...
question: "4"
type: "solution"
title: "UKYOTO 1984 zenki Q4 (solution)"
---
...
PはAP, BC上の点だから, k, l \in \mathbb{R}$として
$$

\begin{align*}
\vec{P}&= k \left(\frac{b}{b+c}\vec{b} + \frac{c}{b+c}\vec{c}\right)\\&= (1-l) \vec{R} + l \frac{c}{a+c}\vec{c}\quad\cdots\text{\textcircled{1}}
\end{align*}

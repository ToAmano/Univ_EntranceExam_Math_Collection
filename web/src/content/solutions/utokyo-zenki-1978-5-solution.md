...
question: "5"
type: "solution"
title: "UTOKYO 1978 zenki Q5 (solution)"
---
...
\lim_{n\to\infty}\frac{1}{n}\sum_{k=1}^n\mathrm{AP_k}^2&= 
     c^2+\int_0^1(a^2x^2-Ax)\, dx \\&=c^2+\teisekibun{\frac{a^2}{3}x^3-\frac{1}{2}Ax^2}{0}{1}\\&=c^2+\frac{a^2}{3}-\frac{1}{2}(a^2+c^2-b^2) \\&=\frac{1}{6}(-a^2+3b^2+3c^2)
\end{align*}
$$

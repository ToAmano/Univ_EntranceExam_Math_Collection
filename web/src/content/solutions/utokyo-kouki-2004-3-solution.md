...
question: "3"
type: "solution"
title: "UTOKYO 2004 kouki Q3 (solution)"
---
...
<figure id="2004-3:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/utokyo/kouki/2004/3/fig_1.svg" alt="図 1" />
...
<figure id="2004-3:fig:2">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/utokyo/kouki/2004/3/fig_2.svg" alt="図 2" />
...
<figure id="2004-3:fig:3">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/utokyo/kouki/2004/3/fig_3.svg" alt="図 3" />
...
<figure id="2004-3:fig:4">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/utokyo/kouki/2004/3/fig_4.svg" alt="図 4" />
...
1.  対称性から第1象限で考える。右図の部分のみかんがえれば良い。

2.  Pのキセキは[解]での考察から右下図のようになる。
          \begin{enumerate}

3.  ①の部分は正方形を、Aで接するようにした状態から平行移動して通過しうる。

4.  ②の部分も同様

5.  ③の部分は、右下図で P, P' ($x$座標が同じ)に対し、A,Bへ接線を引き S, S', T, T'を定めると、
...
6.  又、正方形の一辺が2であることとあわせて、[解]の部分が非通過領域である。
...
question: "2"
type: "solution"
title: "UTOKYO 1970 zenki Q2 (solution)"
---
...
2.  これを$4$回くりかえしたとき$x=0$，$x=\pm1$，$x=\pm2$，$x=\pm3$，$x=\pm4$
          の各点にいる確率をもとめよ．

3.  一般にこれを$n$回くりかえしたとき$x=n-2$にいる確率と$x=n-4$にいる確率とを求め
          よ．
...
2.  $4$回操作した時，$x=\pm1,\pm3$にある確率は明らかに$0$であることに注意する．
...
3.  $x=n-2$にいるのは表が$n-1$回出た時で$\dfrac{{}_nC_{n-1}}{2^n}=\dfrac{n}{2^n}$．
     $\cdots$(答)

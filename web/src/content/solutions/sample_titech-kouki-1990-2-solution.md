...
question: "2"
type: "solution"
title: "SAMPLE_TITECH 1990 kouki Q2 (solution)"
---
...
\begin{align*}
\sin(2k+4)\theta
    = & 2 (k+1) \sin(2\theta) P_{k+1}(\sin^2\theta) \cos 2\theta\\& - 2 k \sin(2\theta) P_k(\sin^2\theta)                       \\
    = & \left\{2(1-2\sin^2\theta)(k+1)P_{k+1}(\sin^2\theta) \right.\\& \left. - kP_k(\sin^2\theta)\right\}\sin(2\theta)            \\\cos(2k+4)\theta

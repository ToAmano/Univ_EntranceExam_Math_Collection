...
question: "2"
type: "solution"
title: "UTOKYO 1994 zenki Q2 (solution)"
---
...
2.  $a+b$および$ab$は有理数である．

3.  任意の自然数$n$に対し$(a^{-n}+b^{-n})(a+b)^n$は整数である．
...
$$
\begin{align*}
&3\theta=2n\pi-2\theta\\\therefore&\cos3\theta=\cos2\theta
\end{align*}
$$
...
$$
\begin{align*}
4t^3-3t=2t^2-1 \\(t-1)(4t^2+2t-1)=0  \\
...
3.  $a_n=(a^{-n}+b^{-n})(a+b)^n$，$b_n=a^{-n}+b^{-n}$とおくと，
...
$$
\begin{align*}
a_{n+2}&=b_{n+2}(a+b)^{n+2}\\&=\{(\frac{1}{a}+\frac{1}{b})b_{n+1}-\frac{1}{ab}b_n\}(a+b)^n \\&=\frac{(a+b)^2}{ab}(a_{n+1}-a_n) \\&=5(a_{n+1}-a_n) \tag{\because[2](#2)}
\end{align*}
$$

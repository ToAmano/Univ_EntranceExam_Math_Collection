...
question: "1"
type: "solution"
title: "TITECH 1990 kouki Q1 (solution)"
---
...
$$
\begin{align*}
& p(-3) = 198 & p(-1) = 62  \\& p(31) = 62  & p(33) = 198
\end{align*}
$$

 だから，[(式2)](#1990-1:eq:2)を満たすような$t \in \mathbb{Z}$は $t=-2, 32$ である．したがって求めるべき$x=t/5$は$x = \frac{32}{5}, -\frac{2}{5}$ である． $\cdots$(答)

 

<figure id="1990-1:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/titech/kouki/1990/1/fig_1.svg" alt="図 1" />

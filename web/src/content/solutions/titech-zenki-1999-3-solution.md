...
question: "3"
type: "solution"
title: "TITECH 1999 zenki Q3 (solution)"
---
...
**$2^\circ$ $P,Q$が辺$AB,BC$上にある場合**（$AC,BC$上の場合も対称性から同じ結論になる）
...
1.  $\dfrac12\le a<2$の時：$x=y=\sqrt{a/2}$が制約内にあり，$\min(x^2+y^2)=a$．

2.  $0<a<\dfrac12$の時：$\sqrt{a/2}>a$となり$y=\sqrt{a/2}$は$y\le a$に反するので，境界$y=a$（このもとで④から$x=1/2$）で最小となり，$\min(x^2+y^2)=\dfrac14+a^2$．
...
**比較** $1^\circ$の$a^2/2$と$2^\circ$を比較する．$0<a\le1/2$では$2^\circ=a^2/2+1/4>a^2/2=1^\circ$．$1/2\le a<2$では

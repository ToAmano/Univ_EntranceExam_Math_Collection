...
question: "3"
type: "solution"
title: "UKYOTO 1987 zenki Q3 (solution)"
---
...
$$
\begin{align*}
&f(1) < 0 \land f(-1) < 0 \\\iff& a+b-1 < 0 \land a-b-1 < 0
\end{align*}
$$
...
$$
\begin{align*}
&\text{\textcircled{ア}}\ -1 \le -\frac{b}{4a}\le 1 \text{の時}\quad f(-\frac{b}{4a}) < 0 \iff\frac{(a+\frac{1}{2})^2}{1/4} + \frac{b^2}{1} < 1 \quad\cdots\text{A}\\&\text{\textcircled{イ}}\ -\frac{b}{4a}\le -1 \text{の時}\quad f(-1) < 0 \\&\text{\textcircled{ウ}}\ -\frac{b}{4a}\ge 1 \text{の時}\quad f(1) < 0
\end{align*}
$$

以上まとめて

1.  $a \ge 0 \land a-1 < b < a+1$

2.  $4a \le b \le -4a \land a < 0 \land \frac{(a+\frac{1}{2})^2}{1/4} + \frac{b^2}{2} < 1$

3.  $4a \ge b \land a < 0 \land a-1 < b$

4.  $-4a \le b \land a < 0 \land b < -a+1$

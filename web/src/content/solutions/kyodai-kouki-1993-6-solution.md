...
question: "6"
type: "solution"
title: "KYODAI 1993 kouki Q6 (solution)"
---
...
$$
  ...
  まず，$a_1-a_2=0$の時は$f(x)$は一次式となり，$\eqref{1993-6:eq:1}$が成り立たない$x$が必ず存在するから，
...
$$
  ...
  であることが必要．
  この元で，$\eqref{1993-6:eq:1}$は分母分子ともに二次式であり，さらに分母が$x=-c_1,-c_2$を根をもつ．
  よって$\eqref{1993-6:eq:1}$が$x\neq -c_1,-c_2$の全ての実数$x$で成り立つには，
...
$$
  ...
  となる．
  $\eqref{1993-6:eq:2}$を$c_1 = c_2$ か否かで場合分けすると，
...
$$
  ...
  以上から，題意が成立する条件は$\eqref{1993-6:eq:3}$と合わせて，

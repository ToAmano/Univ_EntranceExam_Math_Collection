...
question: "3"
type: "solution"
title: "UTOKYO 2003 kouki Q3 (solution)"
---
...
$$
  ...
  だから，[(式1)](#2003-3:eq:1)の初期条件のもとで$k_3,k_4,\cdots$が一意に定まる．
...
$$
  ...
  そこで$n=t$での成立を仮定して$n=t+1$の時を考えると，漸化式[(式2)](#2003-3:eq:2)より
...
$$
  ...
  である．両辺を$k_m>0$で割って，$x_1=1/k_m$および[(式1)](#2003-3:eq:1)より
...
$$
  ...
  (2)
  (1)との違いは，漸化式の$x_n$の係数が異なる部分のみである．
...
$$
  ...
  だから，[(式3)](#2003-3:eq:3)の初期条件のもとで$k_3,k_4,\cdots$が一意に定まる．
...
$$
  ...
  $n=1$の時は$k_1=1,k_2=a_1\ge 2$より$k_2>k_1$が成立する．
  そこで$n=t$での成立を仮定して$n=t+1$の時を考えると，漸化式[(式4)](#2003-3:eq:4)より
...
$$
  ...
  である．両辺を$k_m>0$で割って，$y_1=1/k_m$および[(式3)](#2003-3:eq:3)より
...
$$
  ...
  従って，[(式5)](#2003-3:eq:5)が使える．
  漸化式[(式2)](#2003-3:eq:2)から，
  

$$
\begin{align}
k_{n+2}& = a_{n+1} k_{n+1} - k_n                                          \\& > (a_{n+1}-1) k_{n+1}\quad(\because\text{[(式5)](#2003-3:eq:5)}) \\& > (c-1) k_{n+1}\quad(\because a_n \ge c) \label{2003-3:eq:6}
\end{align}
$$
...
$$
  ...
  不等式[(式6)](#2003-3:eq:6)を繰り返し用いて，$n=1,2,\cdots,m-1$に対して

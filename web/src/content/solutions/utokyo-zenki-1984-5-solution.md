...
question: "5"
type: "solution"
title: "UTOKYO 1984 zenki Q5 (solution)"
---
...
$$
\begin{align*}
P_n(2) &= \sum_{m=1}^n P_{m-1}(1) (1-p) p^{2n-2m}\\&= \sum_{m=1}^n p^{m-1}(1-p) p^{2n-2m}\\&= (1-p) p^{2n-1}\sum_{m=1}^n \left(\frac{1}{p}\right)^m \\&= \frac{1}{p}\frac{1-(1/p)^n}{1-1/p}(1-p) p^{2n-1}\\&= (1-p^n) p^{n-1}
\end{align*}
$$
...
$$
\begin{align*}
P_n(3) &= 2(1-p) p^{3n-1}\left[\frac{1-(1/p^2)^{n-1}}{(p^2-1)p^2} - \frac{1-(1/p)^{n-1}}{(p-1)p^2}\right]\\&= 2 p^{3n-3}\left[ 1 - (1/p)^{n-1} - \frac{1-(1/p^2)^{n-1}}{1+p}\right]\\&= 2 \left[ p^{3n-3} - p^{2n-2} - \frac{p^{3n-3}-p^{n-1}}{1+p}\right]\\&= \frac{2}{1+p}\left[ p^{3n-2} - (1+p) p^{2n-2} + p^{n-1}\right]\quad\dots\text{②}
\end{align*}
$$

...
question: "2"
type: "solution"
title: "UTOKYO 1976 zenki Q2 (solution)"
---
...
2.  $t=0$におけるPの速度を表すベクトルの成分は$(1,\sqrt{3})$である．

3.  $0<t<1$において，Pは何回か($1$回以上有限回)直角に左折するが，そのときを除けばPは
...
## 【解】
 ...
 $\beku{a}=(1,\sqrt{3})$とおく．まず，$t=0$におけるPの速度を表すベクトルが$\beku{b}=(1,0)$だとして考える．$x$軸正方向の移動量を$x$，$y$軸正方向の移動量を$y$とすると，題意の条件から

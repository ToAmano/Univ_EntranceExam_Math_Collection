...
question: "2"
type: "solution"
title: "UKYOTO 1966 zenki Q2 (solution)"
---
...
1.  3点 $P, Q, R$ が辺上にないとき、そのうちの1点をのばして、四角形の辺との交点に新たに点をとれば、より面積の大きい三角形ができるから、$P, Q, R$ は辺上にある。
...
2.  $P, Q, R$ のうち、2点が同一辺上にある時は、その2点を頂点にした時が面積最大である $\dots$ ①

...
question: "2"
type: "solution"
title: "UTOKYO 1997 kouki Q2 (solution)"
---
...
<figure id="1997-2:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/utokyo/kouki/1997/2/fig_1.svg" alt="図 1" />
...
$$
  ...
  だから，$T_1$の増減表は[表1](#1997-2:table:1)となる．

  

<figure id="1997-2:table:1" class="table-wrapper">
...
| $T_1$  |                 | $\searrow$ |        | $\nearrow$ |                |     |
  ...
  <figcaption>表 1: $T_1$の増減表</figcaption>
</figure>
...
$$
  ...
  である．$a\ge 0$より$a^2+10a+1>0$だから，$f(x)$の増減表は[表2](#1997-2:table:2)となる．
  

<figure id="1997-2:table:2" class="table-wrapper">
...
| $f$  |      $(0)$      | $\nearrow$ | $2$  | $\searrow$ |     $(0)$     |
  ...
  <figcaption>表 2: $f(x)$の増減表</figcaption>
</figure>

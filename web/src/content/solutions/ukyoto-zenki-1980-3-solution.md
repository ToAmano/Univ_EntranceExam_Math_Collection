...
question: "3"
type: "solution"
title: "UKYOTO 1980 zenki Q3 (solution)"
---
...
$$
\begin{align*}
OA &= OB = OC = \sqrt{l^2+m^2+n^2}\\&= \sqrt{(l+m+n)^2 - 2(mn+nl+lm)}\\&= 1 \quad(\because\text{④⑤})
\end{align*}
$$
...
$$
\begin{align*}
V &= \frac{1}{6}\left| lnm + mln + nml - l^3 - n^3 - m^3 \right|\\&= \frac{1}{6}(l^2+m^2+n^2) = \frac{1}{6}((l+m+n)^2-2\cdot 0) = \frac{1}{6}
\end{align*}
$$

...
question: "1"
type: "solution"
title: "KYODAI 1992 kouki Q1 (solution)"
---
...
$$
  ...
  だから，$\eqref{1992-1:eq:2}$に$\eqref{1992-1:eq:3,1992-1:eq:4}$を代入して
...
$$
  ...
  $\eqref{1992-1:eq:5,1992-1:eq:6}$から$\alpha,\beta$を消去して
...
$$
  ...
  この時$\eqref{1992-1:eq:8}$に代入して求める$f(x)$は
...
### (1)
については，最初から$F(x)+G(x)=a$を用いて式変形をして行っても求まる．

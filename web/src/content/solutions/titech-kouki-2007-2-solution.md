...
$$
  ...
  [(式2)](#2007-2:eq:1,2007-2:eq:2)より，$0<x<\pi/2$で$f(x)$は上に凸で単調減少する．
  また，極限値は
...
$$
  ...
  である．[(式1)](#2007-2:eq:1)および$0<f(x)<1$より，
...
$$
  ...
  であり，[(式2)](#2007-2:eq:1,2007-2:eq:2)および$0<f(x)<1$から
...
$$
  ...
  それを$x=\alpha$とおくと，
  $h(x)$の増減表は[表1](#2007-2:table:1)となる．

  

<figure id="2007-2:table:1" class="table-wrapper">

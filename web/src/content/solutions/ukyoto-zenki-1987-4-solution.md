...
question: "4"
type: "solution"
title: "UKYOTO 1987 zenki Q4 (solution)"
---
...
$$
\begin{align*}
& a = -2\alpha - q_1 = -2\beta - q_2 \\& \text{（a = -\frac{3}{2}(\alpha+\beta) だから辺々たして代入）}\\& -3(\alpha+\beta) = -2(\alpha+\beta) - (q_1+q_2) \\& \alpha+\beta = q_1+q_2 \\& \therefore |\alpha-q_1| = |q_2-\beta|
\end{align*}
$$
...
$$
\begin{align*}
q &= \frac{1}{2}(x_1^3+x_2^3) + \frac{a}{2}(x_1^2+x_2^2) + \frac{b}{2}(x_1+x_2) + c \\&= \frac{2}{27}a^3 - \frac{ab}{3} + c \\

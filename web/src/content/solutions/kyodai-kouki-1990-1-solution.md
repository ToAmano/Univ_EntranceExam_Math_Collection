...
question: "1"
type: "solution"
title: "KYODAI 1990 kouki Q1 (solution)"
---
...
<figure id="1990-1:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/kyodai/kouki/1990/1/fig_1.svg" alt="図 1" />
...
$$
  ...
  だから，$\eqref{1990-1:eq:2}$と合わせて図示すると[図2](#1990-1:fig:2)斜線部（$b=-9$, 境界は除く）が求める条件である．$\cdots$(答)

  

<figure id="1990-1:fig:2">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/kyodai/kouki/1990/1/fig_2.svg" alt="図 2" />

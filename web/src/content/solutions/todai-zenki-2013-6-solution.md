...
question: "6"
type: "solution"
title: "TODAI 2013 zenki Q6 (solution)"
---
...
### (1)
$0\le t<1$を満たす実数$t$に対し，平面$x=t$による$V_1$の切り口を表す式を求め図示せよ．\\

### (2)
 $V_1$,$V_2$の共通部分の体積を求めよ．
\end{oframed}

     

1.  座標軸を,$z$軸を回転軸として$\frac{\pi}{4}$回転して得られる新しい座標系を$XYz$空間とする．この変換によって， 

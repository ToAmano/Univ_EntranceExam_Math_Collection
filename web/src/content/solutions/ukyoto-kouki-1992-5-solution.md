...
question: "5"
type: "solution"
title: "UKYOTO 1992 kouki Q5 (solution)"
---
...
$$
  ...
  (1)と同様に考えると，$X\le m$となるのは，
  

\begin{itemize}
\item $n$回の試行全てで$m$以下の玉だけを引く \\
    \item $n$回の試行中に一回だけ$m+1$以上の玉を引く
\end{itemize}
...
$$
  ...
  となる．
  これは[(式1)](#1992-5:eq:1)で$m=2$としたものに一致するから，
  $m\ge 2$の全ての場合で[(式1)](#1992-5:eq:1)の表現でよく，
  求める確率は

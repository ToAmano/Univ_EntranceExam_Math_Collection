...
$$
  ...
  であり，$\eqref{2008-1:eq:1}$より$a_1>0$だから両辺$a_1$で割って
...
$$
  ...
  である．さらに，$\eqref{2008-1:eq:1}$より$0<a_1\le a_2$だから，右側の不等式はさらに上から評価すると
...
$$
  ...
  ただし，$\eqref{2008-1:eq:4}$より$y_1-x_1\ge 0$であることを用いた．以上$\eqref{2008-1:eq:5,2008-1:eq:6}$から
...
$$
  ...
  であり，これは$\eqref{2008-1:eq:3}$であるから$n=2$のとき$\eqref{2008-1:eq:3}$は成り立つ．
  ((1)の証明)  $\cdots$(答)

  
  \underline{\textbf{$n\le k (k \in \mathbb{N} \ge 2)$での成立を仮定}}

  $\eqref{2008-1:eq:1,2008-1:eq:2}$を仮定する．
...
$$
  ...
  と定めると，$a_i$が$\eqref{2008-1:eq:1}$を満たすから$a'_{i}$は
...
$$
  ...
  である．以上$\eqref{2008-1:eq:8,2008-1:eq:9}$から，数列$\{a'_i\}, \{X_i\}, \{Y_i\}$は$\eqref{2008-1:eq:1,2008-1:eq:2}$を満たしている．
  これと帰納法の仮定より，$\{X_i\}, \{Y_i\}$に対して$\eqref{2008-1:eq:3}$が成り立つ．
...
$$
  ...
  ここに$\eqref{2008-1:eq:10}$を代入して元の$x_i,y_i$の式に戻すと
...
$$
  ...
  となり，数列$\{x_i\}, \{x_i\}$は$n=k+1$に対して$\eqref{2008-1:eq:3}$を満たす．
  よって，$n=k+1$でも題意は成立する．
...
$$
  ...
  証明において核心となる$\eqref{2008-1:eq:11}$はアーベルの部分和分法（級数変形法）と呼ばれ，しばしば現れる古くから知られた手法である．

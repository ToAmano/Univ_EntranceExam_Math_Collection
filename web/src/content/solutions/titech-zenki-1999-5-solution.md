...
question: "5"
type: "solution"
title: "TITECH 1999 zenki Q5 (solution)"
---
...
**(1)** $P_0=0,\ P_1=1+i$．$\overrightarrow{P_{n-1}P_n}$を表す複素数を$d_n$とすると，題意から
...
**(2)** $Q_0=0,\ Q_1=z$．(1)と同様に，$\overrightarrow{Q_{n-1}Q_n}$を表す複素数を$\beta_n$とすると$\beta_1=z$，

...
question: "1"
type: "solution"
title: "TODAI 1999 kouki Q1 (solution)"
---
...
$$
    ...
    両辺を $[- \pi/2, \pi/2]$ で積分して，$\eqref{1999-1:eq:2}$より
...
$$
    ...
    次に，$n=k$での$\eqref{1999-1:eq:1}$の成立を仮定する．
    加法定理より
...
$$
    ...
    である．従って$\eqref{1999-1:eq:1}$は$n=k+1$でも成立する．

...
question: "1"
type: "solution"
title: "TITECH 2010 zenki Q1 (solution)"
---
...
**(1)** $f'(x)=S-S-xC=-xC$．$0<x<\dfrac\pi2$で$C>0$より$f'(x)<0$，$x=\dfrac\pi2$で$f'=0$，$\dfrac\pi2<x<\pi$で$C<0$より$f'(x)>0$．よって$f$は$[0,\pi/2]$で減少，$[\pi/2,\pi]$で増加．
...
**(2)** (1)より$0\le x\le\alpha$で$f(x)\le0$，$\alpha\le x\le\pi$で$f(x)\ge0$だから
...
**(3)** $K=\dfrac{J-\sqrt2}{\sqrt2}$とおく．(2)の結果より

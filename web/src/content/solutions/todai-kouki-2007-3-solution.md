...
question: "3"
type: "solution"
title: "TODAI 2007 kouki Q3 (solution)"
---
...
$$
  ...
  $n=1$の時は$\eqref{2007-1:eq:1}$から成立するので，
  ...
  まず，$p_n,q_n$については$\eqref{2007-1:eq:3,2007-1:eq:4}$から
...
$$
  ...
  が成立する．
  ついで$k_n$については$\eqref{2007-1:eq:2}$から
...
$$
  ...
  となり，$n=m+1$でも$\eqref{2007-1:eq:5}$が成立する．

  
  \textbf{2° $m\in \text{odd}$の時}

  まず$k_n$について$\eqref{2007-1:eq:2}$より
...
$$
  ...
  ついで$p_n,q_n$について$\eqref{2007-1:eq:3,2007-1:eq:4}$より
...
$$
  ...
  従って数学的帰納法により，$\eqref{2007-1:eq:5}$が任意の自然数で成立する．
...
### (2)
  ...
  この時$\eqref{2007-1:eq:2}$より$k_n = k_{n-1}$だから
...
$$
  ...
  だから，これは$x=p_{n}$で最小値をとり，$\eqref{2007-3:eq:6}$の第一項目は
...
$$
  ...
  とおくと第二項目にも同じ議論が適用できて正だから，全体として$\eqref{2007-3:eq:6}$は正，すなわち
...
$$
  ...
  漸化式$\eqref{2007-1:eq:3,2007-1:eq:4}$より$p_{n}=p_{n-1}, q_{n}=q_{n-1}$だから
...
$$
  ...
  又(2)から $p_{n-1}<q_{n-1}$ だから，$\eqref{2007-1:eq:6}$の右辺はいずれの場合も$0$以上である．
  従って
...
### (2)
で得られた不等式$J_{n-1} \ge J_{n}$で$n=1,2,\cdots$として
...
$$
  ...
  従って，$\eqref{2007-1:eq:7}$を満たすにはある$m \in \mathbb{N}$があって，
...
$$
  ...
  漸化式$\eqref{2007-1:eq:2}$から$k_n=k_{n-1}$である．
...
$$
  ...
  である．$n-2$は奇数だから，再び漸化式$\eqref{2007-1:eq:3,2007-1:eq:4}$から

...
question: "1"
type: "solution"
title: "UTOKYO 1992 kouki Q1 (solution)"
---
...
$$
    ...
    (2)
    (1)から，$y=f_{a_0}(x)$は常に$y=x$の下側にあって，グラフの概形は[図1](#1992-1:fig:1)のようになる．

    

<figure id="1992-1:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/utokyo/kouki/1992/1/fig_1.svg" alt="図 1" />
...
$$
    ...
    である．
    [(式3)](#1992-1:eq:2,1992-1:eq:3)を[(式1)](#1992-1:eq:1)に代入して，求める体積は

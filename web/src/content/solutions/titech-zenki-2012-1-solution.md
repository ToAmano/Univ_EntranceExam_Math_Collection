...
question: "1"
type: "solution"
title: "TITECH 2012 zenki Q1 (solution)"
---
...
**(1)** $O$を原点とし，$\vec a=\overrightarrow{OA}$，$\vec b=\overrightarrow{OB}$，$\vec c=\overrightarrow{OC}$（$|\vec a|=|\vec b|=|\vec c|=1$，$\vec a\cdot\vec b=\vec b\cdot\vec c=\vec c\cdot\vec a=\dfrac12$）とおく．$D$は$AB$の中点，$E$は$OC$の中点だから
...
**(2)** 目の積が10の倍数（$2$の倍数かつ$5$の倍数）にならない事象を考える．$B$:「3回とも偶数の目が出ない（目が$1,3,5$のみ）」，$C$:「3回とも$5$が出ない（目が$1,2,3,4,6$のみ）」，$A=B\cap C$:「3回とも目が$1,3$のみ」とすると，求める事象の余事象は$B\cup C$である．

...
question: "2"
type: "solution"
title: "UTOKYO 1990 zenki Q2 (solution)"
---
...
3.  3次関数 $f(x) = ax^3 + bx^2 + cx + d$ が $(-1, 1)$ で $-1 < f(x) < 1$ をみたす時, $|x| > 1$ なる任意の $x$ で $|f(x)| < |h(x)|$ であることを示せ.
...
2.  $-1 \le x \le 1$ で $|f(x)| < 1$ なら OK

3.  例えば $f(1) = -1$ なら, 下のようなことがある.

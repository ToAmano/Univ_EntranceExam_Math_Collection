...
question: "2"
type: "problem"
title: "KYODAI 1994 kouki Q2 (problem)"
---
...
1.  $n\ge 0$について，$c_{n+2}-(a+d)c_{n+1}+(ad-bc)c_n=0$を示せ．

2.  $p$を素数とし，$a+d$は$p$で割り切れないものとする．ある自然数$k$について，$c_k$と$c_{k+1}$が$p$で割り切れるならば，すべての$n$について$c_n$は$p$で割り切れることを示せ．
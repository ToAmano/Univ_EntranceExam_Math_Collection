...
question: "1"
type: "solution"
title: "UTOKYO 1978 zenki Q1 (solution)"
---
...
1.  扇形 $OA_1A_3$: $\frac{1}{2} \cdot \frac{2}{3}\pi = \frac{\pi}{3}$

2.  半円領域 $D$: $\frac{1}{2}\pi r^2$

3.  扇形 $Q C A_3$: $\frac{1}{2} \cdot \frac{2}{3}\pi (1-r)^2 = \frac{1}{3}\pi (1-r)^2$

4.  平行四辺形 $OPCQ$ から扇形を除いた部分:
...
$$
\begin{align*}
S &= \frac{\pi}{3} + \frac{1}{2}\pi r^2 - \frac{1}{3}(1-r)^2\pi - \left\{\frac{\sqrt{3}}{2}(r-r^2) - \frac{1}{6}\pi r^2 \right\}\\&= \pi\left\{\frac{1}{3} + \frac{1}{2}r^2 - \frac{1}{3}(1-r)^2 + \frac{1}{6}r^2 \right\} - \frac{\sqrt{3}}{2}(r-r^2) \\&= \frac{\pi}{6}\left[ 2r^2 + 4r \right] - \frac{\sqrt{3}}{2} r (1-r)
\end{align*}
$$
...
$$
\begin{align*}
S &= \frac{\pi}{3}\left\{(21 - 12\sqrt{3}) + 2(-3 + 2\sqrt{3}) \right\} - \frac{\sqrt{3}}{2}\left\{(-3 + 2\sqrt{3}) - (21 - 12\sqrt{3}) \right\}\\&= \frac{\pi}{3}\left[ 15 - 8\sqrt{3}\right] - \frac{\sqrt{3}}{2}\left( -24 + 14\sqrt{3}\right)\\&= (15 - 8\sqrt{3})\frac{\pi}{3} - 21 + 12\sqrt{3}\\&= (5\pi - 21) + \left( 12 - \frac{8}{3}\pi\right)\sqrt{3}
\end{align*}
$$
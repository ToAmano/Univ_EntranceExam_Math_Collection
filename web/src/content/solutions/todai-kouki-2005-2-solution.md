...
question: "2"
type: "solution"
title: "TODAI 2005 kouki Q2 (solution)"
---
...
$$
    ...
    \begin{itemize}
      \item[$A$] $p$ラウンドが実施される確率
      \item[$B$] $n$以外を引いてゲームが終了する時の1ターンの期待値
    \end{itemize}
    を用いて
...
$$
  ...
  である．ただし$E(1)$は$\eqref{2005-2:eq:2}$で与えられていることを用いた．
...
$$
  ...
  よって
  \begin{itemize}
    \item[戦略] 第一ラウンドで $f_6(x)$, 第二ラウンドで $f_5(x)$ \\
    \item[期待値] $E = \frac{149}{20}$
  \end{itemize}
  である．$\cdots$(答)

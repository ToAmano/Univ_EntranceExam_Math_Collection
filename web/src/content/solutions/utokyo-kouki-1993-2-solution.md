...
question: "2"
type: "solution"
title: "UTOKYO 1993 kouki Q2 (solution)"
---
...
<figure id="1993-2:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/utokyo/kouki/1993/2/fig_1.svg" alt="図 1" />
...
$$
  ...
  [(式2)](#1993-2:eq:2)が３つの$\theta$で最小値をとる時，
...
$$
  ...
  一定で十分である。[(式3)](#1993-2:eq:3)に値を代入して
...
$$
  ...
  $y_2=0$の時[(式1)](#1993-2:eq:1)から$y_3=0$となり$\triangle ABC$ が三角形とならず不適である．

  よって$x_2=-\frac{1}{2}$ である．この時第一式から$y_2=\pm\frac{\sqrt{3}}{2}$ である．
  [(式1)](#1993-2:eq:1)から$x_3 =-\frac{1}{2}, y_3=\mp\frac{\sqrt{3}}{2}$である．

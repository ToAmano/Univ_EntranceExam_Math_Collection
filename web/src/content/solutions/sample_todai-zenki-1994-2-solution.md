...
<img
src="/Math-Solutions/images/tikz/sample_todai-zenki-1994-2_tikz_2.svg" />
<figcaption>一辺の長さ<span
...
\end{align}$$ である．
[\[1994-2:eq:3,1994-2:eq:4\]](#1994-2:eq:3,1994-2:eq:4){reference-type="ref+label"
reference="1994-2:eq:3,1994-2:eq:4"}を代入して $$\begin{align*}
    L
...
$L$の$p$による一階微分は和積公式を用いて $$\begin{align*}
    ...
    = & \begin{dcases}
        ...
        \end{dcases} \\
\end{align*}$$
と計算できるから，$L$の増減表は[1](#1994-2:table:1){reference-type="ref+label"
reference="1994-2:table:1"}となる．
...
<img
src="/Math-Solutions/images/tikz/sample_todai-zenki-1994-2_tikz_3.svg" />
...
とx軸の囲む面積でグラフは[3](#1994-2:fig:3){reference-type="ref+label"
reference="1994-2:fig:3"}だから
...
以上[\[1994-2:eq:6,1994-2:eq:7\]](#1994-2:eq:6,1994-2:eq:7){reference-type="ref+label"
reference="1994-2:eq:6,1994-2:eq:7"}及び$L$は連続して値をとることから，求める長さの範囲は
$$\begin{align*}

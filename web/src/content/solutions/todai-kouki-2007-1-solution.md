...
question: "1"
type: "solution"
title: "TODAI 2007 kouki Q1 (solution)"
---
...
<figure id="2007-1:fig:1">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/todai/kouki/2007/1/fig_1.svg" alt="図 1" />
...
$$
    ...
    $\eqref{2007-1:eq:1}$と同様の議論によって$P_2(x_2,y_2)$の$x$座標は
...
$$
    ...
    以上$\eqref{2007-1:eq:2,2007-1:eq:3,2007-1:eq:4,2007-1:eq:5}$より求める座標は
...
<figure id="2007-1:fig:2">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/todai/kouki/2007/1/fig_2.svg" alt="図 2" />
...
<figure id="2007-1:fig:3">
  <img src="/Univ_EntranceExam_Math_Collection/images/tikz/todai/kouki/2007/1/fig_3.svg" alt="図 3" />
...
$$
    ...
    であるから，
    $\eqref{2007-1:eq:6,2007-1:eq:8}$を$\eqref{2007-1:eq:7}$に代入して
...
### (1)
より$l_0$ の傾きは $-\frac{y^3_0}{8}$, $l_1$ の傾きは $-\frac{y^3_{1}}{8}$ だから，
...
$$
    ...
    ここに$\eqref{2007-1:eq:3}$を代入して題意より$y_0>0$に注意すると
...
### (3)
の条件が満たされるとき，つまり$\angle P_0 P_1 P_2 = \frac{\pi}{2}$ の時，
